                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                            ...
                                                            <input readonly type="text"
                                                                class="form-control requiredField" placeholder=""
                                                                name="po_no" id="po_no" value="<?php echo e($po_no); ?>" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                            ...
                                                            <select class="form-control requiredField ClsAll"
                                                                ...
                                                                <option value="<?php echo e($row->id); ?>"
                                                                    ...
                                                                    <?php echo e(ucwords($row->name)); ?></option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input type="text" class="form-control requiredField"
                                                                ...
                                                                id="invoice_no" value="<?php echo e($supplier_invoice_no); ?>" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input type="text" class="form-control requiredField"
                                                                ...
                                                                id="del_chal_no" value="<?php echo e($delivery_challan_no); ?>" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input type="text" class="form-control requiredField"
                                                                ...
                                                                value="<?php echo e($delivery_detail); ?>" />
                                                        </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <textarea name="main_description" id="main_description" rows="4"
                                                            ...
                                                            class="form-control"><?php echo e($main_description); ?></textarea>
                                                    </div>
                                                </div>
                                                         ...
                                                         //   if($qty_cond !=0 ){
                                                            ...
                                                            ?>
                                                                <input type="hidden"
                                                                    ...
                                                                    value="<?php echo e($row->po_data_id); ?>" />

                                                                <?php $sub_ic_detail=CommonHelper::get_subitem_detail($row->sub_item_id);
                                                            $sub_ic_detail= explode(',',$sub_ic_detail)
                                                            ?>
                                                                <input type="hidden" id="previous<?php echo e($row->id); ?>"
                                                                    value="<?php echo e($purchase_recived_qty); ?>" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <input readonly class="form-control"
                                                                        ...
                                                                        name="des<?php echo e($row->id); ?>"
                                                                        value="<?php echo e($row->description); ?>" />

                                                                    <td class="ShowHideDesc hide"><input readonly
                                                                            class="form-control" type="text"
                                                                            name="batch_code<?php echo e($row->id); ?>"
                                                                            value="<?php echo $row->batch_code?>" />
                                                                    </td>


                                                                    <td> <input type="date"
                                                                            id="expiry_datees<?php echo e($row->id); ?>"
                                                                            class="form-control"
                                                                            name="expiry_date<?php echo e($row->id); ?>"
                                                                            value="<?php echo e($row->expiry_date); ?>" /> </td>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <?php echo e(number_format($purchase_approve_qty,2)); ?>

                                                                        <input value="<?php echo e($purchase_approve_qty); ?>"
                                                                            type="hidden"
                                                                    ...
                                                                    <td><?php echo e($purchase_recived_qty); ?></td>
                                                                    <!--Quantity Received-->
                                                                    <td><input
                                                                  ...
                                                                  requiredFieldrequiredField rec_qty_<?php echo $counter ?>" type="text"
                                                                            value="<?php echo e($row->purchase_recived_qty); ?>" />
                                                                    </td>
                                                                    ...
                                                                    <td class="hide">
                                                                        <select class="form-control requiredField"
                                                                            ...
                                                                            <option value="">Select</option>
                                                                            <?php $__currentLoopData = CommonHelper::get_all_warehouse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowW): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($rowW->id); ?>"
                                                                                <?php if($row->warehouse_id == $rowW->id): echo "selected"; endif;?>>
                                                                                <?php echo e(ucwords($rowW->name)); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </td>
