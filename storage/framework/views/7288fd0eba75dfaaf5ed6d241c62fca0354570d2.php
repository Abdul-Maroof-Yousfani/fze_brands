...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
            ...
            <?php if($row->jv_status==1): ?>
                ...
                <button onclick="approve_voucher('new_jvs','new_jv_data','jv_status','jv_date','jv_no','1','<?php echo e($row->jv_no); ?>')" type="button" class="btn btn-primary btn-xs">Approve</button>
                <?php endif;?>
            <?php endif; ?>
