                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li onclick="showMasterEditModal('editPremisesForm','{{ $value->id }}','Edit Premises Form','')">
                                <a class="edit-modal">Edit</a>
                            </li>
                            <li onclick="deleteTableRecord('{{ $value->id }}','assets_project_premises')">
