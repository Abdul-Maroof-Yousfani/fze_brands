                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="panel">
                        <div class="panel-body">
                             <form method="POST" action="{{ route('updateSaleReturn',$sale_orders->id)}}">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="margin-bottom: 0;">SO Date</label>
                                                         <input name="sale_order_date" value="{{date('Y-m-d')}}"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="tabel-responsive">
                                        <table class="userlittab table table-bordered sf-table-list" id="more_details">
                                            ...
                                            <tbody>
                                                 <input type="hidden" id="warehouse_from" value="{{ $item->warehouse_from }}" />
                                                ...
                                                <tr class="main">
                                                    ...
                                                    <td>
                                                        <select style="width: 150px;" onChange="item_change(this)"
                                                                name="product_id[]" class="form-control itemsclass"
                                                                id="product_id{{ $key }}">
...
function AddMoreDetails() {
    ...
    $("#warehouse" + Counter).val(warehouse_from).trigger("change");
    $('#product_id' + Counter).select2();
