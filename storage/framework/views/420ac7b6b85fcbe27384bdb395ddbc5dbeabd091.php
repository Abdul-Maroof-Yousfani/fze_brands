                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table table-bordered sf-table-list" id="TableExportToCsv">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><?php echo e(CommonHelper::get_credit_amount('new_rv_data', $row1->id)); ?></td>
                                                                    ...
                                                                    <td id="Append<?php echo e($row1->id); ?>" class="text-center status<?php echo $row1->rv_no?>">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li>
                                                                                    ...
                                                                                    <?php endif;?>
                                                                                            ...
                                                                                            <?php if($delete==true): ?>
                                                                                                <input style=" width:100%;text-align:left;" class="btn btn-xs btn-danger BtnHide<?php echo $row1->rv_no?>" type="button" onclick="DeleteRvActivity('<?php echo $row1->id;?>','<?php echo $row1->rv_no?>','<?php echo $row1->rv_date?>','<?php echo CommonHelper::GetAmount('new_rv_data',$row1->id)?>')" value="Delete" />
                                                                                            <?php endif; ?>
