                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input  readonly type="text" class="form-control requiredField" placeholder="Slip No"
                                                name="" id="" value="<?php echo e(strtoupper($pv_no)); ?>" />
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <span style="font-size:17px !important; color:#F5F5F5 !important;"><strong>*</strong></span>
                                        <input   type="text" readonly class="form-control" placeholder="Slip No" name="slip_no_1" id="slip_no_1" value="<?php echo e($ref_no); ?>" />
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <span style="font-size:17px !important; color:#F5F5F5 !important;"><strong>*</strong></span>
                                        <input  type="date" class="form-control requiredField"  name="cheque_date_1" id="cheque_date_1" value="<?php echo e(date('Y-m-d')); ?>" />
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="table-responsive">
                                            <table id="buildyourform" class="userlittab table table-bordered sf-table-list">
                                                ...
                                                <tr class="AutoNo">
                                                    <td class="">
                                                        <textarea class="form-control" name="desc[]" id="desc_1_<?php echo e($j); ?>"></textarea>
                                                    </td>
                                                    <td class="hide">
                                                        <select class="form-control select2 sub_department_id" name="sub_department_id[]" id="">
                                                            <option value="">Select Department</option>
                                                            <?php $__currentLoopData = $companydepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <td>
                                                            <select  style="width: 100%"  class="form-control requiredField select2" onchange="Datavalidate(this)" name="account_id[]" id="account_id<?php echo e($j); ?>">
                                                                ...
                                                                <?php $__currentLoopData = CommonHelper::get_all_account_operat(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($y->id.',0'.','.$y->code); ?>"><?php echo e($y->code .' ---- '. $y->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <td>
                                                        <input onfocus="mainDisable('c_amount_1_<?php echo $j ?>','d_amount_1_<?php echo $j ?>');" placeholder="Debit" class="form-control d_amount_1 requiredField" maxlength="15" min="0" type="text" name="d_amount[]" id="d_amount_1_<?php echo e($j); ?>" onkeyup="sum('1')" value="" required="required"/>
                                                    </td>
                                                    <td>
                                                        <input onfocus="mainDisable('d_amount_1_<?php echo $j ?>','c_amount_1_<?php echo $j ?>');" placeholder="Credit" class="form-control c_amount_1 requiredField" maxlength="15" min="0" type="text" name="c_amount[]" id="c_amount_1_<?php echo e($j); ?>" onkeyup="sum('1')" value="" required="required"/>
                                                    </td>
