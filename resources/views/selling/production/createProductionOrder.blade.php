                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel">
                           ...
                           <h2 class="subHeadingLabelClass">Create Production Order</h2>
                                ...
                                <form action="{{route('storeProductionOrder')}}" method="post">
                                            ...
                                            <div class="col-md-12 padt">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        ...
                                                        <select onchange="work_change(this)" name="sales_order_id" id="sales_order_id" class="form-control">
                                                            ...
                                                            @foreach (CommonHelper::get_all_sale_order() as $work)
                                                                <option value="{{$work->id}}" >{{$work->so_no}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input  readonly type="text" name="so_no" class="form-control" id="so_number">
                                                    </div>
                                                    <div class="col-md-4">
