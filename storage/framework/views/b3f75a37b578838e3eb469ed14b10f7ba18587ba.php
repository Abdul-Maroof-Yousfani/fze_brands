...
<table class="userlittab table table-bordered sf-table-list">
    ...
    <tbody id="data">
        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <div class="row d-flex" id="paginationLinks">
     <div class="col-md-6">
         <p> Showing <?php echo e($customers->firstItem()); ?> to <?php echo e($customers->lastItem()); ?> of <?php echo e($customers->total()); ?>
