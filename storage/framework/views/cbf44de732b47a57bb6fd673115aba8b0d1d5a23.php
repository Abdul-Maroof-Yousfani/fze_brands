...
<?php $__currentLoopData = $credit_note; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
    <tr title="<?php echo e($row->id); ?>" id="<?php echo e($row->id); ?>">
        <td class="text-center"><?php echo e($counter++); ?></td>
        <td class="text-center"><?php echo strtoupper($SoNo)?></td>
        <td class="text-center"><?php if($row->type==1): ?> DN <?php else: ?> SI <?php endif; ?></td>
        ...
        <td class="text-center">
            ...
            <?php endif;?>
            <?php if($edit == true):?>
            <a href="<?php echo e(URL::asset('sales/editSalesReturn/'.$row->id.'?m='.$m)); ?>" class="btn btn-primary btn-xs">Edit </a>
