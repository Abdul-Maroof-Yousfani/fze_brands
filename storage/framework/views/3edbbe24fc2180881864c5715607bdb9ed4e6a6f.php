            ...
            <div class="well_N">
                <div class="row mb-3">
                    ...
                    <div class="col-lg-6 text-right">
                        <div class="import">
                            <a href="<?php echo e(route('special-prices.import.form')); ?>" class="btn btn-primary">Import Data</a>
                ...
                <!-- Filter Form -->
              <form method="GET" action="<?php echo e(url('sales/assignDicountList')); ?>">
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <select name="territory_id[]" class="form-control select2" multiple>
                <option value="all" <?php echo e(in_array('all', request()->input('territory_id', [])) ? 'selected' : ''); ?>>All Territories</option>
                <?php $__currentLoopData = $territories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $territory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($territory->id); ?>" 
                        <?php echo e(in_array($territory->id, request()->input('territory_id', [])) ? 'selected' : ''); ?>>
...
<div class="col-lg-3">
    ...
    <select name="store_id[]" class="form-control select2" multiple>
        <option value="all" <?php echo e(in_array('all', request()->input('store_id', [])) ? 'selected' : ''); ?>>All Stores</option>
        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($store->id); ?>"
                <?php echo e(in_array($store->id, request()->input('store_id', [])) ? 'selected' : ''); ?>>
        ...
        <div class="col-lg-3">
            ...
            <select name="brand_id[]" class="form-control select2" multiple>
                <option value="all" <?php echo e(in_array('all', request()->input('brand_id', [])) ? 'selected' : ''); ?>>All Brands</option>
                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($brand->id); ?>" 
                        <?php echo e(in_array($brand->id, request()->input('brand_id', [])) ? 'selected' : ''); ?>>
    ...
    <a href="<?php echo e(url('sales/assignDicountList')); ?>" class="btn btn-primary" style="margin-top: 35px;margin-left: 5px;">Reset Filters</a>
</div>
                ...
                <!-- Report Table -->
              <?php if(request()->has('territory_id') || request()->has('store_id') || request()->has('brand_id')): ?>
    <?php if($specialPrices->isNotEmpty()): ?>
        <div class="panel">
            <div class="panel-body">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td><?php echo e($matrix[$store->id][$brand->id] ?? 0); ?></td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
...
$(document).ready(function() {
  ...
  $('select[name="territory_id[]"]').on('change', function() {
    ...
    $.ajax({
        url: "<?php echo e(route('getStoresByTerritory')); ?>",
        type: "GET",
