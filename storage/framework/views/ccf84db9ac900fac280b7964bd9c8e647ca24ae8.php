        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well_N">
                <div class="dp_sdw">
                    ...
                    <!--        <input type="Date" name="from" id="from" value="<?php echo e(date('Y-m-01')); ?>" class="form-control" />-->
                    <!--    </div>-->
                    <!--    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">-->
                    <!--        <label>To Date</label>-->
                    <!--        <input type="Date" name="to" id="to" max="<?php ?>" value="<?php echo e(date('Y-m-t')); ?>" class="form-control" />-->
                    <!--    </div>-->
