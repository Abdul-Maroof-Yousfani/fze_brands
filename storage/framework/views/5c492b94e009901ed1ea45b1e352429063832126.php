                    ...
                    <div class="table-responsive">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                            ...
                            <tr>
                                ...
                                <td title="item_name=<?php echo e(CommonHelper::get_product_name($row1->sub_item_id)); ?>">
                            ...
                            <tr>
                                ...
                                <td style="background-color: darkgray" class="text-center"><?php echo e($approved_qty_sum); ?></td>
                                <td style="background-color: darkgray" class="text-right"  ><?php echo e(number_format($actual_amount,2)); ?> (<?php echo e($currency); ?>)</td>
                                <td  style="background-color: darkgray" class="text-right"  colspan="4"><?php echo e(number_format($total,2)); ?></td>
                                <td  style="background-color: darkgray;display: none" class="text-right showw"  colspan="1"><?php echo e(number_format($total_exchange,2)); ?></td>
                            </tr>
                            </tbody>

                            <tr>
                                <td class="text-center" colspan="6"><?php echo e('Sales Tax :'. $row->sales_tax.' %'); ?></td>
                                <td class="text-right" colspan="6"><?php echo e(number_format($row->sales_tax_amount,2)); ?></td>
                            </tr>

                            <tr>

                                <td style="background-color: darkgray" class="text-center" colspan="6">Grand Total</td>
                                <td style="background-color: darkgray"  class="text-right" colspan="5"><?php echo e(number_format($total+$row->sales_tax_amount,2)); ?>

                                    <?php if ($currency==''):echo 'PKR';else:echo $currency;endif; ?></td>
                                <td style="background-color: darkgray;display: none"  class="text-right showw" colspan="6"><?php echo e(number_format($total_exchange+$row->sales_tax_amount,2)); ?>
