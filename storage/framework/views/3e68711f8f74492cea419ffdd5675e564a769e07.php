 ...
 <div class="table-responsive" id="printReport">
     <table class="userlittab table table-bordered sf-table-list" id="data-table">
        <thead>
         ...
         <tbody id="data">
             <?php if(count($sale_orders) != 0): ?>

            <?php $counter = 1; ?>
                 <?php $__currentLoopData = $sale_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                         <td style="width:50px !important; text-align:center;" class="text-center"><?php echo e($counter++); ?></td>
                         <td class="text-center"><?php echo e($sale_order->so_no); ?></td>
                         <td><strong><?php echo e($sale_order->name); ?></strong></td>
                         <!-- <td class="text-center"><?php echo e(\Carbon\Carbon::parse($sale_order->so_date)->format('d-M-Y')); ?>

                         </td> -->
                        <!-- <td class="text-center">
                                <?php echo e(\Carbon\Carbon::parse($sale_order->timestamp)->format('d-M-Y H:i:s')); ?>
                        ...
                        <td class="nowrap">
                            <?php echo e(\Carbon\Carbon::parse($sale_order->timestamp)->format('d-M-Y')); ?><br>
                            <?php echo e(\Carbon\Carbon::parse($sale_order->timestamp)->format('h:i:s A')); ?>
                        ...
                        <td class="text-left-amount">
                            <?php echo e(number_format($sale_order->sale_taxes_amount_total, 0)); ?>

                        </td>
    
                         <!-- <td class="text-right"><?php echo e(number_format($sale_order->total_amount_after_sale_tax, 0)); ?></td> -->
                         <td>
                             <?php if($sale_order->status == 1): ?>
                                 Approved
                             <?php else: ?>
                                 Not Approved
                             <?php endif; ?>
                         ...
                         <!-- <td>
                             <?php if($sale_order->delivery_note_status == 1 && $sale_order->dn_approve == 1): ?>
                                 Delivery Note Approved
                             <?php elseif($sale_order->delivery_note_status == 1): ?>
                                 Delivery Note Created
                             <?php else: ?>
                                 New Sale Order
                             <?php endif; ?>
                         </td> -->
                         <td><?php echo e($sale_order->remark); ?></td>
                         <td class="text-center">
                                  <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                    ...
                                                    <a class="btn btn-xs btn-success" onclick="showDetailModelOneParamerter('selling/viewSaleOrderPrint/<?php echo e($sale_order->id); ?>',<?php echo e($sale_order->id); ?>,'View Sale Order ')" target="_blank">
                                                        <i class="fa fa-eye" aria-hidden="true"></i> View
                                                    </a>
                                                    
                                                    <a href="<?php echo e(route('editSaleOrder', $sale_order->id)); ?>" class="btn btn-xs btn-warning "
                                                        target="_blank"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
                        
                                                    <!-- <a href="<?php echo e(route('deleteSaleOrder', $sale_order->id)); ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"
                                                            aria-hidden="true"></i> Delete</a> -->
                        
                                                    <a href="<?php echo e(route('deleteSaleOrder', $sale_order->id)); ?>" class="btn btn-xs btn-danger"
