                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            <?php $__currentLoopData = $credit_note; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <tr <?php if($row->type==3): ?> style="background-color: lavenderblush" <?php endif; ?> title="" id="<?php echo e($row->id); ?>">
                                                    ...
                                                    <td class="text-center"><?php if($row->type==1): ?> DN <?php elseif($row->type==2): ?> SI <?php else: ?> POS <?php endif; ?></td>
                                                    <td title="<?php echo e($row->id); ?>" class="text-center"><?php echo e(strtoupper($row->cr_no)); ?></td>
                                                    ...
                                                    <td class="text-center">
                                                            <?php if($view == true):?>
                                                                ...
                                                                <a href="<?php echo e(route('sales.salereturn.edit', ['id'=> $row->id])); ?>" type="button" class="btn btn-warning btn-xs">Edit</a>
                                                            <?php endif;?>
                                                            <?php if($edit == true):?>
                                                           
                                                                <button onclick="delete_sales_return('<?php echo e($row->id); ?>','<?php echo e($row->cr_no); ?>')" type="button" class="btn btn-danger btn-xs">Delete</button>
                                                            <?php endif;?>
