                ...
                <form id="submitadv" action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="employee" class="form-label">BA Selection</label>
                            ...
                            @foreach($roles as $role)
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="role_{{ $role->id }}" name="roles"
                                            value="{{ $role->id }}">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-12">
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="shop_location" id="shop_location" onclick="shopLocation()"
                                    value="1">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row get_location" style="display: none;">
                        <div class="col-md-12" id="locations_wrapper">
                            ...
                            <div class="mb-2 ">
                                <button type="button"
                                    class="btn btn-success btn-sm add_more d-flex justify-content-center">+ Add
                                    More</button>
                            </div>

                            {{-- First Location Section --}}
                            <div class="location_section border p-2 mb-3 rounded">
                                <input type="text" name="map[]" class="form-control mb-2 search-input"
                                ...
                                <table class="table mt-2">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type="text" class="form-control" name="location_name[]"
                                                    placeholder="Location Title" /></td>
                                            <td><input type="number" step="any" readonly class="form-control lat"
                                                    name="latitude[]" placeholder="Latitude" /></td>
                                            <td><input type="number" step="any" readonly class="form-control lon"
                                                    name="longitude[]" placeholder="Longitude" /></td>
                                            <td><input type="number" step="any" class="form-control" name="radius[]"
                                                    placeholder="Radius (KM)" /></td>
                                            <td><button type="button"
                                                    class="btn btn-danger btn-sm remove_section">X</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
@section('script')
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAMa0w8q-4TiAhsApOkj2Xi2YWiQcOW9Kk&libraries=places&callback=initMaps"></script>
