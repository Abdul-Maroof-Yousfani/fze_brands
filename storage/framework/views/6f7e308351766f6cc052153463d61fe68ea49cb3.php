    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dp_sdw">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <label for="email">  <?php if($type==1): ?> From <?php else: ?> To Date <?php endif; ?></label>
                <input
                    id="from_date"
                    name="from_date"
                    required
                    min="<?php echo e($financial_year[0]); ?>"
                    max="<?php echo e($financial_year[1]); ?>"
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <label for="email">  <?php if($type==1): ?> To <?php else: ?> To Date <?php endif; ?></label>
                <input
                    id="to_date"
                    name="to_date"
                    required
        ...
        <input type="hidden" id="accyearfrom" value="<?php echo e($financial_year[0]); ?>"/>
        </div>
