            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="col-lg-12 priorMainBox">
                        <a href="#" onclick="getDashboardSaleSummary(1,'<?php echo e(date('Y-m-d')); ?>','<?php echo e(date('Y-m-d')); ?>');">
                            <div class="mainDashBox">
                                ...
                                <h4>
                                    <?php echo e(number_format(CommonHelper::getSaleSummaryAmount(date('Y-m-d'),date('Y-m-d')),0)); ?>
                        ...
                        <a href="#" onclick="getDashboardSaleSummary(2,'<?php echo e($monthStartDate); ?>','<?php echo e($monthEndDate); ?>');">
                            <div class="mainDashBox">
                                ...
                                <img src="assets/img/miniBar.svg" alt="">
                                <h4>
                                    <?php echo e(number_format(CommonHelper::getSaleSummaryAmount($monthStartDate,$monthEndDate),0)); ?>
                                            ...
                                            <div id="ShowHide">
                                                <div class="table-responsive dashTable mhe">
                                                    <div class="dashTableHeading printListBtn">
                                                        <h6>Sales Orders</h6>
                                                        <a class="btn btn-primary" target="_blank" id="myBtn" href="<?php echo e(url('/selling/listSaleOrder?pageType=view&&parentCode=89&&m=1#Rototec')); ?>">View All Sales Orders</a>
                                                    </div>
