                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input readonly id="vendor_code" type="text" class="form-control requiredField" value="<?php echo e($supplier->vendor_code); ?>">
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Name :</label>
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input name="name" id="name" value="<?php echo e($supplier->name); ?>" type="text" class="form-control requiredField">
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input autofocus type="text"  name="company_name" id="company_name" value="<?php echo e($supplier->company_name); ?>" class="form-control requiredField" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input  type="text" name="contact_person[]" id="contact_person1" value="<?php echo e(($supplier_info)?$supplier_info->contact_person : ''); ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="AppendHtml">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <span class="rflabelsteric"></span>
                                                            <input  type="text" name="contact_no[]" id="contact_no1" value="<?php echo e(($supplier_info)?$supplier_info->contact_no : ''); ?>" class="form-control" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Address :</label>
                                                            <span class="rflabelsteric"></span>
                                                            <input  type="text" name="address[]" id="address1" value="<?php echo e(($supplier_info)? $supplier_info->address : ''); ?>" class="form-control" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <span class="rflabelsteric"></span>
                                                            <input  type="text" name="print_check_as" id="print_check_as" value="<?php echo e($supplier->print_check_as); ?>" class="form-control" />
                                                        </div>

                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Email :</label>
                                                            <input  type="email" name="email" id="email" value="<?php echo e($supplier->email); ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <select   name="vendor_type" id="vendor_type"  class="form-control requiredField">
                                                                ...
                                                                <option value=""><?php echo e(strtoupper('outside services/professional fees')); ?></option>


                                                                <option value="1"><?php echo e(strtoupper('advertising/marketing/promotion')); ?></option>
                                                                <option value="2"><?php echo e(strtoupper('rent and occupancy related')); ?></option>
                                                                <option value="3"><?php echo e(strtoupper('supplies')); ?></option>
                                                                <option value="4"><?php echo e(strtoupper('taxes and licenses')); ?></option>
                                                                <option value="5"><?php echo e(strtoupper('employee fringe benefits')); ?></option>
                                                                <option value="6"><?php echo e(strtoupper('utilities')); ?></option>
                                                                <option value="7"><?php echo e(strtoupper('travel and entertainment')); ?></option>
                                                                <option value="8"><?php echo e(strtoupper('insurance')); ?></option>
                                                                <option value="9"><?php echo e(strtoupper('security')); ?></option>
                                                                <option value="10"><?php echo e(strtoupper('auto')); ?></option>
...
<!-->
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input  type="text" name="credit_limit" id="credit_limit" value="<?php echo e($supplier->credit_limit); ?>" class="form-control" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <label>NTN :</label>
                                                            <input style="" placeholder="NTN" type="text" value="<?php echo e($supplier->ntn); ?>" name="ntn" class="form-control" id="ntn"/>

                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">

                                                            <label>STRN :</label>
                                                            <input style="" placeholder="STRN" type="text" value="<?php echo e($supplier->strn); ?>" name="strn" class="form-control" id="strn"/>

                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Credit Days :</label>
                                                            <span class="rflabelsteric"></span>
                                                            <input type="text" name="credit_days" id="credit_days" value="<?php echo e($supplier->credit_days); ?>" class="form-control" />
                                                        </div>
    ...
    <select name="to_type" id="to_type" class="form-control">
        ...
        <?php $__currentLoopData = CommonHelper::get_all_to_types(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($item->id); ?>" 
                <?php if(isset($supplier) && $supplier->to_type_id == $item->id): ?> selected <?php endif; ?>>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <?php $__currentLoopData = $category_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $con++; ?>
                                                    <div class="category-container" id="cat<?php echo e($con); ?>">
                                                    <?php if($key!=0): ?>
                                                    <button type="button" class="remove-category btn btn-danger btn-sm" onclick="removeCategory(<?php echo e($con); ?>)">-</button>    
                                                    <?php endif; ?>
                                                    <select name="category[]" id="category"class="form-control">
                                                        <option>Select Option</option>
                                                        <?php $__currentLoopData = DB::connection('mysql2')->table('category')->where('status',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php if($val->id==$category_id[$key]): ?> selected <?php endif; ?> value="<?php echo e($val->id); ?>"><?php echo e($val->main_ic); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <?php $__currentLoopData = $category_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $con++; ?>
                                                    <div class="discount-container" id="dis<?php echo e($con); ?>"> 
                                                    <input style="margin-top:<?php if($key!=0): ?> 42px <?php endif; ?>;" type="text" name="discount_percent[]" id="discount_percent" value="<?php echo e($discount[$key]); ?>" class="form-control" />
                                                    </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                                </span>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <select name="category[]" id="category"class="form-control">
                                                        <option>Select Option</option>
                                                        <?php $__currentLoopData = DB::connection('mysql2')->table('category')->where('status',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($val->id); ?>"><?php echo e($val->main_ic); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                ...
                                                <?php endif; ?>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input type="number" name="o_blnc" maxlength="15" value="<?php echo e($transactions->amount); ?>"  min="0" id="o_blnc" placeholder="Opening Balance" class="form-control requiredField" value="0" autocomplete="off"/>
                                                        </div>

                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label for="o_blnc" >Opening Type :</label>
                                                            <select class="form-control" name="nature">
                                                                <option <?php if($transactions->debit_credit==0): ?> selected <?php endif; ?> value="0">Credit</option>
                                                                <option <?php if($transactions->debit_credit==1): ?> selected <?php endif; ?> value="1">Debit</option>
                                                            </select>
                                                        </div>
