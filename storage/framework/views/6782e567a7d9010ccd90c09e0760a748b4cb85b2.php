...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <div class="table-responsive">
                                            <table id="buildyourform" class="table table-bordered">
                                                ...
                                                <tr id="tr<?php echo $j?>" class="AutoNo">
                                                    <td class="">
                                                        <textarea name="desc[]" id="desc<?php echo e($j); ?>" class="form-control"><?php echo $val->description?></textarea>
                                                    </td>
                                                    <td>
                                                        <select style="width: 100%" class="form-control requiredField select2" name="account_id[]" id="account_id<?php echo e($j); ?>">
                                                            ...
                                                            <?php $__currentLoopData = CommonHelper::get_all_account_operat(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($y->id.',0'); ?>" <?php if($y->id==$val->acc_id): ?> <?php echo e("selected"); ?> <?php endif; ?> ><?php echo e($y->code .' ---- '. $y->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <textarea  name="description_1" id="desc1000" style="resize:none;" class="form-control requiredField"><?= $NewPv->description ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#desc1").on("keyup", function() {
                $("#desc1000").val($(this).val());
            })
