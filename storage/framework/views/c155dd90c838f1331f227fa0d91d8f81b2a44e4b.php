                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            ...
                                            <input readonly type="text" class="form-control requiredField"
                                                ...
                                                value="<?php echo e(strtoupper($pv_no)); ?>" />
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hide">
                                            ...
                                            <select onchange="get_address()" name="warehouse_id" id="warehouse_id"
                                                ...
                                                <?php $__currentLoopData = CommonHelper::get_all_warehouse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hide">
                                            ...
                                            <select class="form-control select2" name="sub_department_id"
                                                ...
                                                <?php $__currentLoopData = CommonHelper::get_accounts_by_parent_code('1-6'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr title="1" class="AutoNo">
                                                    <td>
                                                        <select name="item_id[]" id="sub_1" onchange="itemChange(1)" class="form-control select2" style=" width:200px !important;">                                                  <option value="">Select</option>
                                                            <?php $__currentLoopData = CommonHelper::get_all_subitem(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>"
                                                                data-uom="<?php echo e(CommonHelper::get_uom($item->uom)); ?>">
                                                                <?php echo e($item->product_name != '' ? $item->product_name : $item->sub_ic); ?>
                                                ...
                                                <td>
                                                    <select onchange="sales_tax(this.id)" class="form-control select2"
                                                        ...
                                                        <option value="<?php echo e($row->percent.'@'.$row->acc_id); ?>"
                                                            <?php echo e(($row->percent == "17.000")? 'selected' : ''); ?>>
                                                            <?php echo e($row->percent); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </td>
...
function AddMoreDetails() {
    ...
    $('#AppnedHtml').append('<tr id="RemoveRows' + Counter + '" class="AutoNo">' +
        ...
        '<option value="">Select</option>' +
        '<?php $__currentLoopData = CommonHelper::get_all_subitem(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>' +
        '<option value="<?php echo e($item->id); ?>" data-uom="<?php echo e(CommonHelper::get_uom($item->uom)); ?>">' +
        '<?php echo e($item->product_name != "" ? $item->product_name : $item->sub_ic); ?>' +
        '</option>' +
        '<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>' +
        '</select>' +
...
$('form').submit(function(event) {
    ...
    $.ajax({
        url: "<?php echo e(url('pdc/getDupicate')); ?>",
        data: {
