...
<!--                                                             
                                                    ...
                                                    <tbody id="data">
                                                        ...
                                                        <?php $total_foc = 0; $total_qty_get =0; $purchase_amount_total = 0; $profit_amount_total = 0; ?>
                                                        ...
                                                        <tr>
                                                           <td style="text-align: center !important;">
                                                            ...
                                                            <td  style="text-align: center !important;" class="wsale2">
                                                                <p><?php echo e(number_format($sale_order_item->sale_order_rate, 2)); ?></p>
                                                            </td>
                                                               ...
                                                               <td style="text-align: center !important;">
                                                                <?php echo e(number_format($sale_order_item->purchase_price, 2)); ?></td>
                                                                <?php
                                                                    $purchase_amount = $sale_order_item->purchase_price * $sale_order_item->qty;
                                                                    $purchase_amount_total += $purchase_amount;
                                                                ?>
                                                                    <td style="text-align: center !important;">
                                                                <?php echo e(number_format($purchase_amount)); ?></td>
                                                                ...
                                                                ?>
                                                                      <td style="text-align: center !important;">
                                                                <?php echo e(number_format( $profit )); ?></td>
                                                        ...
                                                        <th style="background: transparent; border-bottom: 1px solid #000 !important;  padding:0px 5px !important; margin:0 !important; text-align: center !important;"><p id="total_purchase_amount"><?php echo e(number_format(round($purchase_amount_total, 0))); ?></p></th>
                                                            <th style="background: transparent; border-bottom: 1px solid #000 !important;  padding:0px 5px !important; margin:0 !important; text-align: center !important;"><p  style="text-align: center !important;" id="total_profit_amount"><?php echo e(number_format(round($profit_amount_total, 0))); ?></p></th>
                                                            <th style="background: transparent; border-bottom: 1px solid #000 !important;  padding:0px 5px !important; margin:0 !important;"><p style="text-align: center !important;" id="profit_percentage"><?php echo e(number_format(($profit_amount_total / $purchase_amount_total) * 100, 2)); ?></p></th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
