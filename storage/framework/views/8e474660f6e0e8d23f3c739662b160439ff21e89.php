...
<?php echo $__env->make('select2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        ...
                                        <form id="importForm" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-footer row">
                                                <div class="col-md-6 text-left">
                                                    <a target="_blank" href="<?php echo e(asset('/public/chart_of_account.csv')); ?>" class="btn btn-dark">Download Sample File</a>
                                                </div>
                                                <div class="col-md-12">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<form id="filterForm">
												<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
													<input type="hidden" name="get_m" value="<?php echo e($m); ?>">
													<label>Search</label>
   ...
   <script>
		$(document).ready(function() {
			$('.select2').select2();
			filterationCommonGlobal('<?php echo e(route('getviewChartofAccountList')); ?>');
		});
	</script>
	<script>
		// function myFunction() {
