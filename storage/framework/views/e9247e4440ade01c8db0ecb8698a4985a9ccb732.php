...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        ...
        <?php if($row->rv_status==1): ?>
            ...
            <button onclick="approve_voucher('new_rvs','new_rv_data','rv_status','rv_date','rv_no','3','<?php echo e($row->rv_no); ?>', 'Bank Receipt Voucher')" type="button" class="btn btn-primary btn-xs">Approve</button>
            <?php endif;?>
        <?php endif; ?>
                            ...
                            <div class="table-responsive">
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <td class="text-center hide"><?php echo e(CommonHelper::get_paid_to_name($row2->paid_to_id,$row2->paid_to_type).$Type); ?></td>
