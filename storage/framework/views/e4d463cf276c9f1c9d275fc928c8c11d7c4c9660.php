                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input readonly type="text" class="form-control requiredField" placeholder=""
                                            name="po_no" id="po_no" value="<?php echo e(strtoupper($purchaseRequestNo)); ?>" />
                                    </div>
                                    ...
                                    <input type="hidden" name="vendor_id" class="vendor_id" value="<?php echo e($data[0]->vendor_id); ?>" />
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hide">
                                        ...
                                        <input type="text" name="sub_department_name" id="sub_department_name"
                                            ...
                                            value="<?php echo e(CommonHelper::get_sub_dept_name($dept_id)); ?>">
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <select onchange="get_po(this.id); po_type_change(this);" name="po_type"
                                            ...
                                            <?php $__currentLoopData = CommonHelper::get_local_to_types(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hide">
                                        ...
                                        <input readonly style="text-transform: capitalize;" type="text" class="form-control"
                                            placeholder="" name="quotation" id="quotation" value="<?php echo e($implodedVoucherNos); ?>" />
                                    </div>

                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label">Comparative number</label>
                                        <input readonly style="text-transform: capitalize;" type="text" class="form-control"
                                             value="<?php echo e($implodedComparatives); ?>" />
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <select onkeypress="claculation(1);get_rate()" name="curren" id="curren"
                                            ...
                                            <option value="<?php echo e($row->id.','.$row->rate); ?>"><?php echo e($row->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>; -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label class="sf-label">Purchase Type <span
                                                class="rflabelsteric"><strong>*</strong></span></label>
                                        <input readonly type="text" class="form-control requiredField" placeholder=""
                                            value="<?php echo e(NotificationHelper::get_type_name( $p_type)); ?>" name="p_type"
                                            id="p_type" readonly />
                                    </div>
                                        ...
                                        <tbody id="filterDemandVoucherList">
                                            <tr id="removeSelectedPurchaseRequestRow_<?php echo $counter1;?>"
                                                ...
                                                <input type="hidden" name="demand_data_id<?php echo $counter1;?>"
                                                    id="demand_data_id<?php echo $counter1;?>" value="<?php echo e($row->id); ?>">
                                            ...
                                            ?>
                                                ...
                                                <td colspan="1">
                                                    ...
                                                    <a href="<?php echo url('/') ?>/store/item_detaild_supplier_wise?&sub_item_id=<?php echo $row->sub_item_id ?>"
                                                        target="_blank"><?php echo e(($product_name != '' ? $product_name  : $sub_item_id)); ?></a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <input readonly onkeyup="claculation('<?php echo $counter1 ?>')" type="text"
                                                        ...
                                                        id="rate_<?php echo $counter1?>"
                                                        class="form-control requiredField ApproveRate" step="0.001"
                                                        value="<?php echo e(($row->tax_percent)); ?>" />
                                                </td>
                                                <td class="text-center">
                                                    ...
                                                    <input readonly type="text"
                                                        ...
                                                        class="form-control requiredField ApproveRate" step="0.001"
                                                        value="<?php echo e(($row->tax_per_item_amount)); ?>" />
                                                </td>
                                                <!--
...
<!--><?php $total=$row->amount;?>
                                                <td class="text-center">
                                                    ...
                                                    <input readonly style="text-align: right" type="text"
                                                        ...
                                                        value="<?php echo e($total); ?>" step="0.01" />
                                                </td>
                                                <!--
                                        ...
                                        <tr class="hide">
                                            <td>
                                                <select onchange="sales_tax(this.id);open_sales_tax(this.id);"
                                                    ...
                                                    <option <?php if($sales_tax==$row->rate): ?> selected <?php endif; ?>
                                                        value="<?php echo e($row->rate); ?>"><?php echo e($row->rate); ?> %</option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="background-color: darkgray" colspan="2" class="text-right">
                                                <input
                                                    ...
                                                    id="d_t_amount_1" value="<?php echo e($all_total); ?>" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    //     if (selectedValue) {
    //         $.ajax({
    //             url: '<?php echo e(url('/pdc/get_currency_vendor_by_to_type')); ?>',
    //             type: 'Get',
    //             data: {
    //                 id: selectedValue,
    //                 vendor_id: vendor_id
