                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <span class="subHeadingLabelClass">Edit Warehouse</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <div class="row">
                                                <?php echo Form::open(array('url' => 'pad/updateWarehouseDetail/' . $warehouse->id . '?m='.$m.'','id'=>'addCategoryForm'));?>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <input autofocus type="text" name="warehouse" value="<?php echo e($warehouse->name); ?>" id="warehouse"
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <select name="territory_id" id="territory_id" class="form-control select2">
                                                        <?php $__currentLoopData = App\Helpers\CommonHelper::get_all_territories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $territory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($territory->id); ?>" <?php echo e($warehouse->territory_id == $territory->id ? 'selected' : ''); ?>><?php echo e($territory->name); ?></option>
