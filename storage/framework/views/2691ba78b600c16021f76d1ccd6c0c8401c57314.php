                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <input readonly type="text" class="form-control requiredField"
                                                ...
                                                value="<?php echo e(strtoupper($purchaseRequestNo)); ?>" />
                                        </div>
...
$(document).ready(function(){
    ...
    function po_type_change(selectedElement) {
        ...
        if (selectedValue) {
            $.ajax({
                url: '<?php echo e(url('/pdc/get_currency_vendor_by_to_type_direct')); ?>',
                type: 'Get',
                data: {
                    id: selectedValue
                },
...
<script>
    ...
    //     $.ajax({
    //         url: '<?php echo e(url("/getSubItemByBrandWithDetail")); ?>',
    //         type: 'Get',
    //         data: {
    //             id: value
    //         },
