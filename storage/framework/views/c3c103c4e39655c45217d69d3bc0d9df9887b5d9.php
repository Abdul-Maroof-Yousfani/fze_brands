...
<?php echo $__env->make('bundles_data', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	                           ...
	                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                              <div class="row">
	                                 <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
	                                    ...
	                                    <input readonly type="text" class="form-control" placeholder="" name="so_no" id="so_no" value="<?php echo e(strtoupper($so_no)); ?>" />
	                                 </div>
	                                 <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
	                                    <label class="sf-label">Sale Order Date <span class="rflabelsteric"><strong>*</strong></span></label>
	                                    <input autofocus type="date" class="form-control" placeholder="" name="so_date" id="so_date" value="<?php echo e(date('Y-m-d')); ?>" />
	                                 </div>
									...
									<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hide">
	                                 ...
	                                 <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
	                                    ...
	                                    <input  type="date" class="form-control" placeholder="" name="order_date" id="order_date" value="<?php echo e(date('Y-m-d')); ?>" />
	                                 </div>
	                              </div>
	                              <div class="row">
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
