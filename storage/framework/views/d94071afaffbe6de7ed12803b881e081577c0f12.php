                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div style="width:40%; float:right;">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                            ...
                            <tr>
                                <td>Attachment</td>
                                <td width=""><a target="_blank" href="<?php echo e(asset($row->file_path)); ?>"><?php echo e($row->file_path == '' ? '-' : $row->file_path); ?></a></td>
                            </tr>
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                           ...
                           $item_name=  CommonHelper::get_product_name($row1->sub_item_id);
                            ?>
                            <tr>
                                <td title="<?php echo e($item_name); ?>"  class="text-center">
                    ...
                    <div class="table-responsive">
                        ...
                        $item_name= CommonHelper::getCompanyDatabaseTableValueById($m,'subitem','product_name',$row1->sub_item_id);
                            ...
                            <tr>
                                ...
                                <td><?php echo e(\App\Helpers\CommonHelper::get_item_sku_code($row1->sub_item_id)); ?></td>
                                <td title="<?php echo e($item_name); ?>" class="text-center">
                                ...
                                <td><?php echo e(\App\Helpers\CommonHelper::product_barcode($row1->sub_item_id)); ?></td>
