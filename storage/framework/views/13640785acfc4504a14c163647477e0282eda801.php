                        ...
                        <div class="table-responsive">
                            <table  class="table table-bordered table-striped table-condensed tableMargin" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td  style="background-color: darkgray" class="text-right" ><?php echo e(number_format($TotalAmount,2)); ?></td>
                                    <td style="background-color: darkgray" class="text-center" colspan="3"></td>
                                    <td  style="background-color: darkgray" class="text-right" ><?php echo e(number_format($TotalDisAmount,2)); ?></td>
                                    <td  style="background-color: darkgray" class="text-right" ><?php echo e(number_format($TotalNetAmount,2)); ?></td>
                                </tr>



                                <?php if($creit_note->sales_tax >0): ?>
                                    <?php  $TotalNetAmount+=$creit_note->sales_tax; ?>
                                    <tr>
                                        <td class="text-center" colspan="7" id="SalesTaxSpan">Sales Tax 17%</td>
                                        <td class="text-right" colspan="1"><?php echo e(number_format($creit_note->sales_tax,2)); ?></td>
                                    </tr>
                                <?php endif; ?>


                                <?php if($creit_note->sales_tax_further >0): ?>
                                    <?php $TotalNetAmount+=$creit_note->sales_tax_further; ?>
                                    <tr>
                                        <td class="text-center" colspan="7" id="FurtherTaxSpan">Sales Tax Further 3%</td>
                                        <td class="text-right" colspan="1"><?php echo e(number_format($creit_note->sales_tax_further,2)); ?></td>
                                    </tr>
                                <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: darkgray"  class="text-right" colspan="1"><?php echo e(number_format($TotalNetAmount,2)); ?></td>
