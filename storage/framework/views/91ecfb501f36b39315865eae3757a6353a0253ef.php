                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <input readonly type="text" class="form-control" placeholder="" name="gi_no" id="gi_no" value="<?php echo e(strtoupper($gi_no)); ?>" />
                                            </div>

                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="sf-label">Invoice Date<span class="rflabelsteric"><strong>*</strong></span></label>
                                                <input  value="<?php echo e(date('Y-m-d')); ?>" autofocus type="date" onkeyup="calculate_due_date()" class="form-control requiredField" placeholder="" name="gi_date" id="gi_date" value="" />
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select style="width: 100%"  name="buyers_id" id="ntn" onchange="get_ntn()" class="form-control select2 requiredField">
                                                    ...
                                                    <?php $__currentLoopData = SalesHelper::get_all_customer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($row->id.'*'.$row->cnic_ntn.'*'.$row->strn); ?>"><?php echo e($row->name); ?></option>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
                                                ...
                                                <select class="form-control" id="acc_id" name="acc_id" >
                                                    ...
                                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php if($row->id==16): ?> selected <?php endif; ?>  value="<?php echo e($row->id); ?>"><?php echo e($row->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select onchange="" name="curren" id="curren" class="form-control select2 requiredField">
                                                    ...
                                                    <?php $__currentLoopData = CommonHelper::get_all_currency(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($row->id); ?>"><?php echo e($row->curreny); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;
	                              ...
	                              <div class="table-responsive" >
	                                 <table class="table table-bordered">
	                                    ...
	                                    <tr class="cnt" title="1">
											<td>
												<select onchange="get_uom('<?php echo e(1); ?>')" name="sub_ic_des[]" id="sub_ic_des<?php echo e(1); ?>" class="form-control select2">
													<option value="">Select</option>
														<?php $__currentLoopData = CommonHelper::get_all_subitem(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<?php $uom =  CommonHelper::get_uom($row->id); ?>
														<option value="<?php echo e($row->id.','.$uom); ?>" ><?php echo e($row->sub_ic); ?></option>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>
											</td>
	                                	<td>
	                                     ...
	                                     <td class="hide" style="width: 110px">
	                                           <select onchange="tax_percent(this.id)"  class="form-control" name="tax[]" id="tax_percent1">
												<option value="0,0">Select</option>
													<?php $__currentLoopData = ReuseableCode::invoice_tax(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value='<?php echo e($row->acc_id.','.$row->tax_rate); ?>'><?php echo e($row->tax_rate); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											   </select>
	                                    </td>
	                                    <td class="hide">
