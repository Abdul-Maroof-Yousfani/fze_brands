													...
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="table-responsive">
															...
															<table class="userlittab table table-bordered sf-table-list" id="TableExportToCsv1">
																...
																foreach ($pvs as $row1) {
																?>
																<tr <?php if($row1->type==2): ?> style="background-color: darkgray" <?php endif; ?> class="tr<?php echo $row1->id ?>" id="tr<?php echo $row1->id ?>" title="<?php echo $row1->id ?>" id="1row<?php echo $counter ?>" <?php if($row1->pv_status == 1):?>  onclick="checkUncheck('1chk<?php echo $counter ?>','1row<?php echo $counter ?>')"<?php endif;?>>
																	...
																	<td class="text-center"><?php echo e(CommonHelper::get_branch_by_id($row1->warehouse_id)); ?></td>
																	<td class="text-center"><?php echo e($row1->description); ?></td>
																	<td class="text-center"><?php echo e(CommonHelper::get_credit_amount('new_pv_data', $row1->id)); ?></td>
																	...
																	<td class="text-center status<?php echo e($row1->pv_no); ?>"><?php if($row1->pv_status == 2){echo "<span style='color:green;'>Approved</span>";} else{echo "<span style='color:red;'>Pending</span>";}?></td>
