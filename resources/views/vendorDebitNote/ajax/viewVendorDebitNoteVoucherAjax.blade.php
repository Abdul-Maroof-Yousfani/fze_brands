...
$row = DB::table('vendor_debits')->where('id', $Checking)->orWhere('rv_no', $Checking)->first();
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        ...
        @endif
        <button class="btn btn-xs btn-info" onclick="printView('viewVendorDebitNote','','1')">
            <span class="glyphicon glyphicon-print"> Print</span>
        </button>
    </div>
    <div style="line-height:5px;">&nbsp;</div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="well" id="viewVendorDebitNote">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <h3 style="text-align: center;">Vendor Debit Note</h3>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-condensed tableMargin">
                                    ...
                                    <tbody>
                                        ...
                                        $rvsDetail = collect([
                                            (object)[
                                                'acc_id' => $row->debit, // Vendor Account
                                                'amount' => $row->amount,
