...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
            <?php if($row->rv_status==1): ?>
                <button onclick="approve_debit_note('credits_data','credits_item_data','rv_status','rv_date','rv_no','3','<?php echo e($row->rv_no); ?>')" type="button" class="btn btn-primary btn-xs">Approve</button>
            <?php endif; ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                       ...
                                       ?>
                                        ...
                                        <?php $freight=SalesHelper::get_freight($row3->si_id); ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo e(number_format($invoice_amount - $row3->net_amount, 2)); ?></td>
                            ...
                            Descriptions : <?php echo e($row->description); ?>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">
                                            ...
                                            <b>   <p><?php echo e(Auth::user()->username); ?></p></b>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">
