                ...
                <div class="dp_sdw">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="headquid">
                           <h2 class="subHeadingLabelClass">Recipe List</h2>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="userlittab table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            <thead>
                                                ...
                                                <th class="text-center col-sm-2">Finish Goods</th>
                                                ...
                                                <tr id="remove<?php echo $Fil['id'] ?>">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <li>
                                                                <a onclick="showDetailModelOneParamerter('recipe/viewRecipeInfo','{{$Fil->id}}','View Recipe Detail')" type="button" class="btn btn-sm btn-success" >
                                                                     View</a>
                                                                    <a class="btn btn-sm btn-warning " href="recipeEdit?id=<?php echo $Fil['id'] ?>&&m=<?php echo $this->m?>">  Edit</a>
                                                         

                                                                <a class='btn btn-danger delete'onclick="delete_cate('<?php echo $Fil['id'] ?>')" value='"+row.id+"' >Delete</a>
                                                                <a class="btn btn-primary" href="recipeDuplicate/<?php echo $Fil['id'] ?>">     Duplicate</a>
                                                                </li>
                                                            </ul>
                                                        </div>
