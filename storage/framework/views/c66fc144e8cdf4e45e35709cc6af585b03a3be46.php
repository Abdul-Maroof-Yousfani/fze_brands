...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row well_N">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="display: none;">
            <?php echo $__env->make('Store.'.$accType.'storeMenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input readonly type="text" class="form-control requiredField" placeholder="" name="po_no" id="po_no" value="<?php echo e(strtoupper($purchase_order->purchase_request_no)); ?>" />
                                    </div>
                                            ...
                                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <optgroup label="<?php echo e($y->department_name); ?>" value="<?php echo e($y->id); ?>">
                                                    ...
                                                    <?php $__currentLoopData = $subdepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $y2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($y2->id); ?>" <?php if($purchase_order->sub_department_id == $y2->id):echo "selected"; endif;?>><?php echo e($y2->sub_department_name); ?></option>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <select onchange="claculation(1);get_rate()" name="curren" id="curren" class="form-control select2 requiredField">
                                            <?php $__currentLoopData = CommonHelper::get_all_currency(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($row->id.','.$row->rate); ?>" <?php if($purchase_order->currency_id == $row->id):echo "selected"; endif;?>><?php echo e($row->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive" >
                                    <table class="table table-bordered">
                                        ...
                                        $Counter++;
                                        ?>
                                        <tr title="1" id="RemoveRows<?php echo e($Counter); ?>" class="AutoNo">
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" onkeyup="claculation('<?php echo e($count); ?>')" onblur="claculation('<?php echo e($count); ?>')" class="form-control requiredField ActualQty" name="actual_qty[]" id="actual_qty<?php echo $Counter?>" placeholder="ACTUAL QTY" min="1" value="<?php echo $Fil->purchase_approve_qty;?>">
                                            </td>
                                            <td>
                                                <input type="text" onkeyup="claculation('<?php echo e($count); ?>')" onblur="claculation('<?php echo e($count); ?>')" class="form-control requiredField ActualRate" name="rate[]" id="rate<?php echo $Counter?>" placeholder="RATE" min="1" value="<?php echo $Fil->rate?>">
                                            </td>
                                            <td>
                                            ...
                                            <td style="background-color: #ccc"><input onclick="view_history(<?php echo $Counter?>)" type="checkbox" id="view_history<?php echo $Counter?>"> &nbsp;&nbsp; <?php if($Counter>1): ?> <button type="button" class="btn btn-sm btn-danger" id="BtnRemove<?php echo e($Counter); ?>" onclick="RemoveSection('<?php echo e($Counter); ?>')"> - </button> <?php endif; ?></td>
                                        </tr>
                                     ...
                                     $count++;   endforeach;?>
                                        ...
                                        <tr  style="font-size:large;font-weight: bold">
                                            ...
                                            <td id="" class="text-right" colspan="1"><input readonly value="<?php echo e($total_amount); ?>" class="form-control" type="text" id="net"/> </td>
                                            <td></td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="float: right;">
                                <table class="table table-bordered sf-table-list">
                                        ...
                                        <td>
                                            <select onchange="sales_tax(this.id);open_sales_tax(this.id)" class="form-control select2" id="sales_taxx" name="sales_taxx">
                                                ...
                                                <?php $__currentLoopData = FinanceHelper::get_accounts(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <option value="<?php echo e($row->id); ?>" <?php if($purchase_order->sales_tax == $row->id):echo "selected"; endif;?>><?php echo e($code[0].'--'.ucwords($row->name)); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </td>
                                    ...
                                    <tr  style="font-size:large;font-weight: bold">
                                        ...
                                        <td id="" class="text-right"  colspan="3"><input readonly class="form-control" value="<?php echo e($total_amount+$purchase_order->sales_tax_amount); ?>" type="text" id="net_after_tax"/> </td>
                                        <td></td>
                                    </tr>
                                    </tbody>
                                </table>
