      ...
      //  $open_qty=$open_data[0];
       ...
       // $in_qty=$in_data[0];
        ...
        <tr class="text-center" title="<?php echo e($row->sub_item_id); ?>">
            ...
            <td title="opening amount"><small><?php echo e(number_format($open_amount,2)); ?></small></td>
            <td title="purchase amount"><small><?php echo e(number_format($purchase_amount,2)); ?></small></td>
            <td title="purchase return"><small><?php echo e(number_format($return_data,2)); ?></small></td>
            <td title="purchase amount from work order"><small><?php echo e(number_format($purchase_amount_on_work_order,2)); ?></small></td>
            <td title="sales return on dn"><small><?php echo e(number_format($sales_return_amount_on_dn,2)); ?></small></td>
            <td title="sales return on  si"><small><?php echo e(number_format($sales_return_amount_on_si,2)); ?></small></td>
            <td title="sales return on work order"><small><?php echo e(number_format($sales_return_amount_on_work_order,2)); ?></small></td>
            <td title="stoc transfer"><small><?php echo e(number_format($stock_transfer_amount,2)); ?></small></td>
            <td><small><?php echo e(number_format(
            $open_amount+
            $purchase_amount+
