                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="m" value="<?php echo e($m); ?>">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                ...
                                                <input type="text" id="tr_no" name="tr_no" value="<?php echo e(strtoupper($uniq)); ?>" class="form-control requiredField" readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <select onchange="updateAllWarehouseFrom()" name="main_warehouse_from" id="main_warehouse_from" class="form-control requiredField select2">
                                                    <option value="">Select Warehouse</option>
                                                        <?php foreach(CommonHelper::get_all_warehouse() as $Fil):?> <option <?php echo e($Fil->id == $Master->location_from ? 'selected' : ''); ?> value="<?php echo $Fil->id?>"><?php echo $Fil->name?></option> <?php endforeach;?>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <option value="">Select Warehouse</option>
                                                    <?php foreach(CommonHelper::get_all_warehouse() as $Fil):?> <option <?php echo e($Fil->id == $Master->location_to ? 'selected' : ''); ?> value="<?php echo $Fil->id?>"><?php echo $Fil->name?></option> <?php endforeach;?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <option value="">Select Brands</option>
                                                    <?php foreach(CommonHelper::get_all_brand() as $brand):?> <option <?php echo e($brand->id == $Master->brand_id ? 'selected' : ''); ?> value="<?php echo $brand->id ?>"><?php echo $brand->name?></option> <?php endforeach;?>
                                                </select>
                                            </div>
                                        </div>
                                        <br>                                          
                                                            ...
                                                            <tr class="text-center AutoNo" id="RemoveRow<?php echo $Couter?>">
                                                                <td>
                                                                    ...
                                                                    <select name="item_id[]" class="form-control select2 items" onchange="selectElement(this)" id="sub_<?php echo $Couter?>">
                                                                        ...
                                                                        <?php $__currentLoopData = CommonHelper::get_all_subitem_get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option <?php if($Fil->item_id == $item->id): ?> selected <?php endif; ?> value="<?php echo e($item->id); ?>"><?php echo e($item->sku_code.' - '. $item->product_name); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input readonly type="text" name="barcodes[]" id="barcodes" value="<?php echo e(App\Helpers\CommonHelper::product_barcode($item->id)); ?>" style="width: 100%; text-align: center;" class="form-control requiredField barCodes" step="any" min>
                                                                </td>
                                                                <td class="hide">
                                                                ...
                                                                <td>
                                                                    <input onkeyup="check_qty(this.id,1)" type="text" name="qty[]" value="<?php echo e($Fil->qty); ?>" id="qty1" class="form-control requiredField SendQty" step="any" min>
                                                                </td>
...
<!-- <script>
    var Counter = 1;
        let allItems = <?php echo json_encode(CommonHelper::get_all_subitem_get(), 15, 512) ?>;
    ...
    //         '<option value="0">Select item</option>' +
    //         '<?php $__currentLoopData = CommonHelper::get_all_subitem_get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>' +
    //         '<option value="<?php echo e($item->id); ?>"><?php echo e($item->sku_code." - ".$item->product_name); ?></option>' +
    //         '<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>' +
    //         '</select>' +
    //         '</td>' +
    //         '<td class="hide">' +
    ...
    //    let territory_id = "<?php echo e(Auth::user()->territory_id); ?>";
    ...
    function getWarehousesByTerritoryOnLoad(territory_id) {
        $.ajax({
            url: '<?php echo e(route("ajax.get.warehouses.stocktarasfer")); ?>',
            type: 'GET',
    ...
    function getWarehousesByTerritoryOnLoadother(territory_id) {
        $.ajax({
            url: '<?php echo e(route("ajax.get.warehouses.other.stocktarasfer")); ?>',
            type: 'GET',
            data: { territory_id: territory_id },
            success: function (data) {
                // let $from = $('#main_warehouse_from');
...
<script>
    var Counter = 1;
    let allItems = <?php echo json_encode(CommonHelper::get_all_subitem_get(), 15, 512) ?>;
    let allStocks = <?php echo json_encode(CommonHelper::get_all_stocks(), 15, 512) ?>;
...
$("#brands").trigger("change");
    ...
    function get_stock(warehouse, number) {
        ...
        $.ajax({
            url: '<?php echo e(url("/pdc/get_stock_location_wise")); ?>',
            type: "GET",
            data: { warehouse: warehouseValue, item: item },
            success: function (data) {
                if (!data) return;
    ...
    function get_stock_qty(id, number) {
        ...
        $.ajax({
            url: '<?php echo e(url("/pdc/get_stock_location_wise")); ?>?batch_code=' + batch_code,
            type: "GET",
            data: { warehouse: warehouseValue, item: item },
            success: function (data) {
                let parts = data.split('/');
