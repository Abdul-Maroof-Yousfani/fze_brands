                        ...
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <input  checked  type="hidden" value="<?php echo e($id); ?>" name="id"  />
                                    <input  checked  type="hidden" value="<?php echo e($NewPv->pv_no); ?>" name="pv_no" />
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input  readonly type="text" class="form-control requiredField" placeholder="Slip No"
                                                name="" id="" value="<?php echo e(strtoupper($NewPv->pv_no)); ?>" />
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <select name="warehouse_id" id="warehouse_id" class="form-control requiredField select2">
                                            ...
                                            <?php $__currentLoopData = CommonHelper::get_all_branch(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($branch->id); ?>" <?php echo e($branch->id == $NewPv->warehouse_id ? "selected" : ""); ?>><?php echo e($branch->branch_name); ?></option>
                                        ...
                                        <div class="table-responsive">
                                            <table id="buildyourform" class="table table-bordered">
                                                ...
                                                <tr class="AutoNo" id="tr<?php echo $j?>">
                                                    <td class="">
                                                        <textarea class="form-control" name="desc[]" id="desc_1_<?php echo e($j); ?>"/><?php echo $val->description;?></textarea>
                                                    </td>
                                                    <td class="hide">
                                                        <select class="form-control select2 sub_department_id" name="sub_department_id[]" id="">
                                                            ...
                                                            <optgroup label="<?php echo e($y->department_name); ?>" value="<?php echo e($y->id); ?>">
                                                                <?php
                                                                    ...
                                                                    <option <?php echo e($y2->id == optional($val)->sub_department_id ? 'selected' : ''); ?> value="<?php echo e($y2->id); ?>"><?php echo e($y2->sub_department_name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </optgroup>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                        ...
                                                        <td>
                                                            <select style="width: 100%" class="form-control requiredField select2" onchange="Datavalidate(this)" name="account_id[]" id="account_id<?php echo e($j); ?>">
                                                                <option value="">Select Account</option>
                                                                <?php $__currentLoopData = CommonHelper::get_all_account_operat(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($y->id.',0'.','.$y->code); ?>" <?php if($y->id==$val->acc_id): ?> <?php echo e("selected"); ?> <?php endif; ?> ><?php echo e($y->code .' ---- '. $y->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </td>
                                                    <td>
                                                        <input onfocus="mainDisable('c_amount_1_<?php echo $j ?>','d_amount_1_<?php echo $j ?>');" placeholder="Debit" class="form-control d_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="d_amount[]" id="d_amount_1_<?php echo e($j); ?>" onkeyup="sum('1')" value="<?php echo e($val->debit_credit==1? $val->amount:'0'); ?>" required="required"/>
                                                    </td>
                                                    <td>
                                                        <input onfocus="mainDisable('d_amount_1_<?php echo $j ?>','c_amount_1_<?php echo $j ?>');" placeholder="Credit" class="form-control c_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="c_amount[]" id="c_amount_1_<?php echo e($j); ?>" onkeyup="sum('1')" value="<?php echo e($val->debit_credit==0? $val->amount:'0'); ?>" required="required"/>
                                                    </td>
                                                    <?php if($j > 2):?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:150px;">
                                                        <input
                                                                ...
                                                                name="c_t_amount_1"
                                                                class="form-control requiredField text-right number_format"
                                                                value="<?php echo e($credit); ?>"/>
                                                    </td>
                                                    <td class="diff" style="width:150px;font-size: 20px;">
                                                        <input readonly style="color: blue;font-weight: 600" class="form-control" type="text" id="diff" value="<?php echo e($debit-$credit); ?>"/>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
