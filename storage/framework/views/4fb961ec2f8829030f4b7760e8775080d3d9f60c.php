...
<div class="row" id="printReport">
    <?php if($scannedqrcodeqty != $grnqty): ?>
        <div class="alert alert-danger text-left fw-bold">
            All QR codes must be scanned first. Scanned Barcodes: <?php echo e($scannedqrcodeqty); ?>, Required Barcodes: <?php echo e($grnqty); ?>.`
        </div>
    <?php endif; ?>
...
<?php echo e(Form::submit('Approve', [
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="contr">
                            ...
                            <p style="margin-top:-12px;">
                                <strong><?php echo e($buyers_detail->name); ?></strong>
                                <?php echo e($buyers_detail->address); ?><br>
                                <?php echo e(CommonHelper::get_all_country_by_id($buyers_detail->country)->name ?? ''); ?><br>
                                <?php echo e($buyers_detail->phone_1); ?><br>
                                N.T.N #:
                                <?php echo e(isset($buyers_detail->cnic_ntn) ? $buyers_detail->cnic_ntn : "-"); ?><br>
                                S.T #: <?php echo e(isset($buyers_detail->strn) ? $buyers_detail->strn : "-"); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6  text-right">
                        <div class="contr2">
                            ...
                            <br>
                            <p>Document # <?php echo e($delivery_note->so_no); ?></p>
                            <p style="margin-bottom: -23px !important;">Date: <?php echo e(\Carbon\Carbon::parse($delivery_note->so_date)->format("d-M-Y")); ?></p>
                            <br>
                           <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: right; border:1px solid #000 !important;border-left:none !important;padding: 5px 8px !important;">
                                                <?php echo e(number_format(round($so_detail->credit_limit),0)); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right; border:1px solid #000 !important;border-left:none !important;padding: 5px 8px !important;">
                                                <?php echo e(number_format(round($so_detail->balance_amount),0)); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right; border:1px solid #000 !important;border-left:none !important;padding: 5px 8px !important;">
                                                <?php echo e(number_format(round($total_amount_after_tax), 0)); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <div class="term">
                                        <p>SO Date: <?php echo e(\Carbon\Carbon::parse($delivery_note->so_date)->format("d-M-Y")); ?></p>
                                        <p>Warehouse: <?php echo e($buyers_warehouse_name); ?></p>
                                  ...
                                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="term">
                                        <p>SO #: <?php echo e($delivery_note->so_no); ?></p>
                                        <p>GDN #: <?php echo strtoupper($delivery_note->gd_no);?></p>
                                        <p>Branch: <?php echo e($delivery_note->branch); ?></p>
                                        <p>Salesperson: <?php echo e($buyers_detail->SaleRep); ?></p>
                                        <p><strong></strong></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table class="table sale_older_tab userlittab table table-bordered sf-table-list sale-list">
                                ...
                                <tbody id="data">
                                    <?php $__currentLoopData = $delivery_note_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sale_order_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $saleOrderDetail = CommonHelper::get_item_detials($sale_order_item->so_data_id);
                                    ...
                                    <tr>
                                        ...
                                        <td  style="text-align: center !important;" class="wsale2"><p><?php echo e(number_format($sale_order_item->qty)); ?></p></td>
                                        <!-- <td style="text-align: center !important;"><?php echo e(number_format($sale_order_item->foc)); ?></td> -->
                                        <!-- <td style="text-align: center !important;"><?php echo e(number_format($sale_order_item->mrp_price)); ?></td>
                                        <td style="text-align: center !important;"><?php echo e(number_format($sale_order_item->rate)); ?></td>
                                        <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->sub_total,2)); ?></td>
                                        <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->discount_percent_1,2)); ?>%</td>
                                        <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->discount_amount_1,2)); ?></td>
                                        <td  style="text-align: center !important;"><?php echo e(number_format($sale_order_item->tax)); ?>%</td>
                                        <td  style="text-align: center !important;"><?php echo e(number_format($sale_order_item->tax_amount,2)); ?></td>
                                        <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->amount,2)); ?></td> -->
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p id="total_qty"><?php echo e(number_format($total_qty)); ?></p></th>
                                        <!-- <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p id="total_qty"><?php echo e(number_format($total_foc)); ?></p></th> -->
                                        <!-- <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"></th>
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"></th>
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format($total_gross_amount, 2)); ?></p></th>
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"></th>
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format($total_discount_amount, 2)); ?></p></th>
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"></th>
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format($total_tax_amount, 2)); ?></p></th>
                                        <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format($total_amount_after_tax, 2)); ?></p></th> -->
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                 <div class="totlass">
                                    ...
                                    <p><strong><?php echo e($so_detail->remark ?? 'N/A'); ?></strong></p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                        <div class="row">
                            <!-- <div class="col-lg-4 col-md-4 col-sm4 col-xs-4">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm4 col-xs-4">
                                 <p><strong>Prepared By</strong> </p>
                                <p><strong><?php echo e($delivery_note->username); ?></strong> </p>
                            </div>
                             <div class="col-lg-4 col-md-4 col-sm4 col-xs-4">
                                <p><strong></strong> </p>
                        ...
                        <table id="tablee" class="table " style="border: solid 1px black;">
                            ...
                            <tbody>
                                <?php
                                 ...
                                 $total_after_tax=0;
                                ?>
                                <?php $__currentLoopData = $delivery_note_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="border:1px solid black;">
                                        <?php echo e(CommonHelper::get_item_name($row->item_id)); ?></td>
                                    <td style="border:1px solid black;"><?php echo e(CommonHelper::get_uom($row->item_id)); ?></td>
                                    <td class="text-right" style="border:1px solid black;"><?php echo e($row->qty); ?></td>
                                    <td class="text-right hide" style="border:1px solid black;">
                                        <?php echo e(number_format($row->rate,2)); ?></td>
                                    <td class="text-right hide" style="border:1px solid black;">
                                        <?php echo e(number_format($row->qty * $row->rate,2)); ?></td>
                                    <td class="text-right hide" style="border:1px solid black;"><?php echo e($row->tax); ?></td>
                                    <td class="text-right hide" style="border:1px solid black;">
                                        <?php echo e(number_format($row->tax_amount,2)); ?></td>
                                    <td class="text-right hide" style="border:1px solid black;">
                                        <?php echo e(number_format($row->amount,2)); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hide" style="font-size: large;font-weight: bold">
                                    ...
                                    <td class="text-right" colspan="1" style="border:1px solid black;">
                                        <?php echo e(number_format($total_before_tax,2)); ?> </td>
                                    <td></td>
                                    <td class="text-right" colspan="1" style="border:1px solid black;">
                                        <?php echo e(number_format($total_tax,2)); ?> </td>
                                    <td class="text-right" colspan="1" style="border:1px solid black;">
                                        <?php echo e(number_format($total_after_tax,2)); ?> </td>
                                </tr>
                           ...
                           $data=  DB::Connection('mysql2')->table('transactions')->where('status',1)->where('voucher_no',$delivery_note->gd_no)->orderBy('id','DESC')->get();
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="debit_amount text-right"><?php if($row1->debit_credit ==
                                        1): ?><?php echo e(number_format($row1->amount,2)); ?> <?php $total_debit+=$row1->amount ?>
                                        <?php endif; ?> </td>
                                    <td class="debit_amount text-right"><?php if($row1->debit_credit ==
                                        0): ?><?php echo e(number_format($row1->amount,2)); ?> <?php $total_credit+=$row1->amount ?>
                                        <?php endif; ?> </td>
    ...
    <div class="vomp">
        <p><strong style="margin-left: 50px;">Creation Time :<?php echo e(\Carbon\Carbon::parse($delivery_note->timestamp)->format('d-M-Y h:i A')); ?></strong></p>
    </div>
</div>
