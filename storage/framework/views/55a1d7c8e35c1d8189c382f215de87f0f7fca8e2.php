                                                                                ...
                                                                                <li>
                                                                                        ...
                                                                                        <?php if($delete==true): ?>
                                                                                            <input  style="width:100%; text-align:left;" class="btn btn-xs btn-danger BtnHide<?php echo $row1->rv_no?>" type="button"
                                                                                                ...
                                                                                                value="Delete" />
                                                                                        <?php endif; ?>
                                                                                        <a onclick="change_colour('<?php echo e($row1->id); ?>')" target="_blank" href="<?php echo url('fdc/viewBankRvDetailNewPrint?id='.$row1->id.'&&m='.$m)?>" class="btn btn-xs btn-success">Print</a>
