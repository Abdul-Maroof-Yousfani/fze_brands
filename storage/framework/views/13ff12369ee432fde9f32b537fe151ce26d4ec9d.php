						...
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="panel">
									<div class="panel-body">
										<div class="row">
											<?php echo e(Form::open(array('url' => 'uad/addSubMenuDetail','id'=>'addSubMenuForm'))); ?>
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													<select class="form-control" name="main_navigation_name" id="main_navigation_name">
														...
														<?php $__currentLoopData = $MainMenuTitles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo $y->id.'_'.$y->title_id?>"><?php echo e($y->title); ?></option>
