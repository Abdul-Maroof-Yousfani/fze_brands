...
<head>
 ...
 <![endif]-->
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/colors.css')); ?>"> -->
     <link href="<?php echo e(URL::asset('assets/css/colors.css')); ?>" rel="stylesheet" />
...
<body>
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        Swal.fire({
                            icon: 'error',
                            title: 'Stock Error',
                            html: `<?php echo nl2br(session('stockerror')); ?>`,
    ...
    <script>
        ...
        function approve_voucher(table, table_data, voucher_status, voucher_date, voucher_no_txt, type, voucher_no,
            ...
            $.ajax({
                // url: '<?php echo e(url(' / approve_voucher ')); ?>',
                 url: '<?php echo e(route("approve_voucher")); ?>',
                type: 'GET',
                data: {
                    table: table,
        ...
        function approve_debit_note(table, table_data, voucher_status, voucher_date, voucher_no_txt, type, voucher_no,
            ...
            $.ajax({
                // url: '<?php echo e(url(' / approve_voucher ')); ?>',
                 url: '<?php echo e(route("approve_debit_note")); ?>',
                type: 'GET',
                data: {
                    table: table,
                    table_data: table_data,
        ...
        function verify_voucher(table, table_data, voucher_status, voucher_date, voucher_no_txt, type, voucher_no) {
            ...
            $.ajax({
        url: '<?php echo e(route("verify_voucher")); ?>',
                type: 'GET',
                data: {
                    table: table,
                    table_data: table_data,
