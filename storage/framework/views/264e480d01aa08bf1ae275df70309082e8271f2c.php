...
<div class="well_N">
    ...
    <div class="row align-items-center ">
        <div class="col-md-8">
            <form id="submitadv" action="<?php echo e(route('users.store')); ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="role_<?php echo e($role->id); ?>" name="roles" value="<?php echo e($role->id); ?>">
