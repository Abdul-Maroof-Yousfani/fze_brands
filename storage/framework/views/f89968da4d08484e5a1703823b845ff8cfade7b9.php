...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title> <?php echo e(env('APP_NAME')); ?> || ERP </title>
...
<nav class="navbar navbar-login">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>"> (Pvt) Ltd</a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="<?php echo e(url('visitor/careers')); ?>" class="<?php echo e(Request::is('visitor/careers')? 'triangle-isosceles': ''); ?> ">CAREERS</a></li>
              <li><a href="<?php echo e(url('/login')); ?>" class="<?php echo e(Request::is('login')? 'triangle-isosceles': ''); ?>">LOGIN</a></li>
            </ul>
