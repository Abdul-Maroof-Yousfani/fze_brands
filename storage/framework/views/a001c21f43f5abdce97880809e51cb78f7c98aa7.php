            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="submitadv" action="<?php echo e(route('baFormation.store')); ?>" method="POST">
        ...
        <div id="filteredData">
            <div class="text-center spinnerparent">
                <div class="spinner-border" role="status">
                    <img style="width: 100px" src="<?php echo e(asset('/public/loading-gif.gif')); ?>" alt="">
                </div>
            </div>
        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function () {
            filterationCommonGlobal('<?php echo e(route('list.baFormation')); ?>');
        });
        ...
        $(document).ready(function () {
            $('#SubmitForm').submit(function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('baFormation.store')); ?>", // Ensure this route is defined in web.php
                    method: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
   ...
   <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    ...
    <script>
        ...
        function syncEmployee() {
            ...
            $.ajax({
                url: "<?php echo e(route('syncEmployee')); ?>",
                type: 'POST',
                headers: {
