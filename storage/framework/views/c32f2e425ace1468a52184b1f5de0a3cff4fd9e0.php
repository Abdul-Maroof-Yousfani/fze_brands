                                        ...
                                        <select name="store" onchange="getData()" id="ClientId"
                                            ...
                                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($customer->id); ?>"
                                                    <?php echo e(old('store') == $customer->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="delivery_man" id="delivery_man"
                                            value="<?php echo e(old('delivery_man')); ?>" placeholder="-">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="date_and_time" name="date_and_time"
                                            value="<?php echo e(old('date_and_time')); ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="debit" id="debit">
                                            ...
                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('debit') == $y->id ? 'selected' : ''); ?>
    ...
    <script>
        ...
        function receiptData() {
            ...
            let checkedValues = $('.AllCheckbox[type="checkbox"]:checked')
                ...
                .get();
            $.ajax({
                url: '<?php echo e(url('/creditNote/customer/showReceipt')); ?>',
                type: 'Get',
                data: {
                    checkbox: temp
                },
