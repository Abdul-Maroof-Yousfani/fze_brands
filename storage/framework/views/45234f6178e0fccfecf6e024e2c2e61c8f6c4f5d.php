<?php $__env->startSection('content'); ?>
    ...
    <div class="row well_N align-items-center">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 text-right">
            <!-- <ul class="cus-ul2">
                <li>
                    <a href="<?php echo e(url()->previous()); ?>" class="btn-a">Back</a>
                </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="panel">
                        <div class="panel-body">
                             <form method="POST" action="<?php echo e(route('updateSaleOrder',$sale_orders->id)); ?>">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                     ...
                                                     <input readonly name="sale_order_no" class="form-control"
                                                               value="<?php echo e($sale_orders->so_no); ?>" type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="margin-bottom: 0;">SO Date</label>
                                                         <input name="sale_order_date" value="<?php echo e(date('Y-m-d', strtotime($sale_orders->so_date))); ?>"
                                                    ...
                                                    <select onchange="getCustomer(this)" name="customer_name"
                                                        ...
                                                        <?php $__currentLoopData = CommonHelper::get_customer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>"
                                                                    <?php echo e($sale_orders->buyers_id == $item->id ? 'selected' : ''); ?>
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="phone_no" id="phone_no" class="form-control"  value="<?php echo e($sale_orders->phone_no); ?>"
                                                               type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="address" id="address"  value="<?php echo e($sale_orders->address); ?>" class="form-control" type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="margin-bottom: 0;">Branch</label>
                                                          <input name="branch" id="branch" class="form-control" type="text" value="<?php echo e($sale_orders->branch); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                       ...
                                                       <input name="saleperson" id="saleperson" class="form-control"   value="<?php echo e($sale_orders->sales_person); ?>"
                                                               type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="margin-bottom: 0;">Remark</label>
                                                                                                              <textarea name="remark" id="remark" class="form-control" rows="3"><?php echo e($sale_orders->remark); ?></textarea>
                                                ...
                                                ?>
                                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <select style="width: 100%;" id="warehouse_from"
                                                        ...
                                                        <?php $__currentLoopData = CommonHelper::get_all_warehouse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php echo e($item->id == ($sale_orders->warehouse_from ? $sale_orders->warehouse_from : $buyer_detail->warehouse_from) ? 'selected' : ''); ?> value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <select style="wiidth: 100%;" id="principal_group"
                                                    ...
                                                    <?php $__currentLoopData = CommonHelper::get_all_principal_groups(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($group->id); ?>" <?php echo e($sale_orders->principal_group_id == $group->id ? 'selected' : ''); ?>><?php echo e($group->products_principal_group); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="tabel-responsive">
                                        <table class="userlittab table table-bordered sf-table-list" id="more_details">
                                            ...
                                            <tbody>
                                                 <?php $__currentLoopData = $sales_order_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="main">
                                                    ...
                                                    <td>
                                                        <select style="width: 150px;" onChange="item_change(this); getCustomerAssignedWarehouse(this)"
                                                                ...
                                                                id="product_id<?php echo e($key); ?>">
                                                            <?php echo CommonHelper::getSubItemByBrand($item->brand_id,$item->item_id); ?>
                                                    ...
                                                    <td>
                                                       <input style="width: 70px;" readonly name="c_stock[]" class="form-control c_stock"  value="<?php echo e(CommonHelper::getCustomerAssignedWarehouse($sale_orders->buyers_id, $item->item_id)); ?>"  type="text" id="c_stock" tabindex="-1">
                                                    </td>
                                                    <td>
                                                       <input style="width: 70px;" readonly name="r_stock[]" class="form-control r_stock" value="<?php echo e(App\Helpers\ReuseableCode::get_reserved_so($item->item_id, $sale_orders->buyers_id)); ?>" type="text" id="r_stock" tabindex="-1">
                                                    </td>
                                                    ...
                                                    <td>
                                                         <input style="width: 70px;"  onkeyup="calculation_amount(); checkQtyStock(this); totalQty();" name="qty[]" class="form-control qty next-total" value="<?php echo e($item->qty); ?>" type="text" id="qty" tabindex="0">
                                                   

                                                        
                                                    <td>
                                                        <input style="width: 65px;" onkeyup="calculation_amount()" name="foc[]" class="form-control" <?php echo e($item->foc); ?> type="text" id="foc" tabindex="-1">
                                                    </td>
                                                      <td>
                                                        <input style="width: 80px;" name="rate[]" onkeyup="calculation_amount()" class="form-control"  value="<?php echo e($item->rate); ?>" type="text" id="sale_price" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 80px;" readonly name="mrp_price[]" class="form-control"  value="<?php echo e($item->mrp_price); ?>" type="text" id="mrp_price" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input style="width: 110px;" readonly name="is_tax_apply[]" class="form-control" value="<?php echo e(optional(CommonHelper::get_product_by_id($item->item_id))->is_tax_apply ?? ''); ?>" type="text" id="is_tax_apply" tabindex="-1">
                                                    </td>
                                                    
                                                    <td class="hide">
                                                        <input style="width: 100px;" readonly name="tax_type_id[]" class="form-control" value="<?php echo e(optional(CommonHelper::get_product_by_id($item->item_id))->tax_type_id ?? ''); ?>" type="text" id="tax_type_id" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input style="width: 100px;" readonly name="tax_applied_on[]" class="form-control" value="<?php echo e(optional(CommonHelper::get_product_by_id($item->item_id))->tax_applied_on ?? ''); ?>" type="text" id="tax_applied_on" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input style="width: 62px;" readonly name="tax_policy[]" class="form-control" value="<?php echo e(optional(CommonHelper::get_product_by_id($item->item_id))->tax_policy ?? ''); ?>" type="text" id="tax_policy" tabindex="-1">
                                                    </td>
                                                  
                                                    <td>
                                                        <input style="width: 110px;" name="gross_amount[]" class="form-control gross_amount" value="<?php echo e($item->sub_total); ?>" type="text" id="gross_amount" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 100px;" readonly onkeyup="calculation_amount(); get_discount();" name="discount1[]" class="form-control dicountget" value="<?php echo e($item->discount_percent_1); ?>"type="text" id="discount1" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 100px;" readonly name="discount_amount1[]" class="form-control discount_amount" value="<?php echo e($item->discount_amount_1); ?>" type="text" id="discount_amount1" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input readonly style="width: 100px;" onkeyup="calculation_amount(); get_discount();" name="discount2[]" class="form-control" value="<?php echo e($item->discount_percent_2); ?>" type="text" id="discount2" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input readonly style="width: 100px;" name="discount_amount2[]" class="form-control" value="<?php echo e($item->discount_amount_2); ?>" type="text" id="discount_amount2" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 62px;" onkeyup="calculation_amount()" name="tax[]" class="form-control sale_tax_rate " value="<?php echo e($item->tax); ?>" type="number" id="sale_tax_rate" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 90px;" readonly name="total_tax[]" class="form-control total_tax" value="<?php echo e($item->tax_amount); ?>" type="text" id="total_tax"  tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 111px;" readonly name="total_amount[]" class="form-control total" value="<?php echo e($item->amount); ?>" type="text" id="total"  tabindex="-1">
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="col-md-3">
                                        <div class="padt">
                                                ...
                                                <li class="text-left">
                                                    <input name="total_qty"  style="background: white !important;"
                                                           class="form-control form-control2" id="total_qty"
                                                            value="<?php echo e($sale_orders->total_qty); ?>"  type="text"  readonly>
                                                </li>
                                                <li>Total Item</li>
                                                <li class="text-left">
                                            ...
                                            <!-- <select name="sale_taxes_id" class="form-control" onchange="applySaleTax(this)">
                                                <option value="">Select</option>
                                                <?php $__currentLoopData = CommonHelper::get_table_data('sale_taxes'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?> - <?php echo e($item->discount_percentage); ?>%</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select> -->
                                                    <?php
                                                    ...
                                                    <select name="sale_taxes_id" class="form-control" onchange="applySaleTax(this)">
                                                       ...
                                                       <?php $__currentLoopData = CommonHelper::get_table_data('sale_taxes'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>" 
                                                            <?php echo e($sale_orders->sale_taxes_id == $item->id ? 'selected' : ''); ?>>
                                                        <?php echo e($item->name); ?> - <?php echo e($item->discount_percentage); ?>%
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                        ...
                                        <div class="padt">
                                            <ul class="sale-l sale-l2">
                                                ...
                                                <li class="text-left"><input name="total_gross_amount"
                                                                             ...
                                                                             class="form-control form-control2"  value="<?php echo e($sale_orders->total_amount); ?>"
                                            ...
                                            <ul class="sale-l sale-l2">
                                                ...
                                                <li class="text-left"><input name="total_sales_tax"
                                                                             ...
                                                                             class="form-control form-control2"  value="<?php echo e($sale_orders->sales_tax_rate); ?>"
                                                                             type="text"  readonly></li>
                                            </ul>
                                             ...
                                             <ul class="sale-l sale-l2">
                                                ...
                                                <li class="text-left"><input
                                                            ...
                                                            class="form-control form-control2"  value="<?php echo e($sale_orders->total_amount_after_sale_tax); ?>"
                                                            type="text" readonly></li>
                                            </ul>
                                            <ul class="sale-l sale-l2">
                                                ...
                                                <li class="text-left"><input
                                                            ...
                                                            class="form-control form-control2" value="<?php echo e($sale_orders->total_amount_after_sale_tax + $sale_orders->sale_taxes_amount_rate); ?>"
                                                            type="text" readonly></li>
                                            </ul> 
                                                <ul class="hide sale-l sale-l2">
                                         
                                                <li> sale Tax Amount</li>
                                                <input type="text" class="form-control" name="sale_taxes_amount_rate" value="<?php echo e($sale_orders->sale_taxes_amount_rate); ?>" id="tax_amount_calculated" readonly>
                                            </ul>
                                          </div>
                                    </div>
                                </div>
...
let brands = <?php echo json_encode($data, 15, 512) ?>;
function AddMoreDetails() {
    var Counter = $('.main').length + 1;
    var previousBrandId = $('#brand_id' + (Counter - 1)).val();
...
function get_brand_by_principal_group(element) {
    ...
    $.ajax({
        // url: '/purchase/get_brand_by_principal_group',
         url: "<?php echo e(route('get_brand_by_principal_group')); ?>",
        type: 'Get',
    ...
    //                     // window.location.href = '<?php echo e(url("selling/listSaleOrder")); ?>';
    //                 });
    //             } else {
    //                 Swal.fire({
    //                     icon: 'error',
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                Swal.fire({
                    ...
                    window.location.href = '<?php echo e(route("listSaleOrder")); ?>';
                });
...
$(document).on('keydown', '.next-total', function (event) {
    ...
    function get_sub_item_by_id(instance) {
        ...
        $.ajax({
            url: '<?php echo e(url("/getSubItemByCategory")); ?>',
            type: 'Get',
            data: {
                category: category
            },
    ...
    //         // $.ajax({
    //         //     url: '<?php echo e(url("stad/getCustomerDiscounts")); ?>',
    //         //     type: 'GET',
    //         //     data: {
    //         //         item_id: item_id,
    //         //         customer_id: customer_id
    ...
    function getCustomer(element) {
        ...
        $.ajax({
            url: '<?php echo e(url("stad/getCustomerById")); ?>',
            type: 'GET',
            data: {
                id: id,
            },
...
function load_all_products() {
    $.ajax({
        url: '<?php echo e(route("getAllSubItem")); ?>',
        type: 'GET',
        success: function(data) {
            products = data;
...
function get_product_by_brand(element, number) {
    ...
    //     $.ajax({
    //         url: '<?php echo e(url("/getDiscountByCustomerAndBrand")); ?>',
    //         type: 'Get',
    //         data: {
    //             id: value,
    //             cusId : customerId
    ...
    function getCustomerAssignedWarehouse(element) {
        ...
        $.ajax({
            url: '<?php echo e(url("/getCustomerAssignedWarehouseByWarehouse")); ?>',
            type: 'GET',
            data: {
