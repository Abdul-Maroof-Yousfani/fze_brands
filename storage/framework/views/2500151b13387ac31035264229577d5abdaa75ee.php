            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="v_date" name="v_date">
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidee">
                        ...
                        <input value="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="cheque_date" type="date">
                    </div>
               ...
               <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Advance Payment (Use Only)</h5>
                      ...
                      <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hidee">
                        ...
                        <select style="width: 100%" class="form-control" name="use_advance" id="use_advance"
                            ...
                            <?php $__currentLoopData = CommonHelper::get_customer_advance($buyers_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val_C): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val_C->id); ?>" data-amount="<?php echo e($val_C->balance); ?>">
                                    <?php echo e($val_C->payment_no . ' -- ' . number_format($val_C->balance, 2)); ?>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidee">
                        ...
                        <select style="width: 100%" class="form-control select2" name="cheque_list[]" id="cheque"
                            ...
                            <?php $__currentLoopData = $chequed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_C => $val_C): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val_C->id); ?>" data-amount="<?php echo e($val_C->amount); ?>">
                                    <?php echo e($val_C->cheque_no . '--' . $val_C->amount); ?>
                    ...
                    <!-- <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidee">
                        ...
                        <select name="bank" class="form-control">
                            <?php $__currentLoopData = $bank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($row->id); ?>"><?php echo e($row->bank_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr title="<?php echo e('sales_invoice_id=' . $row); ?>">
                        ...
                        <td><input class="form-control receive_amount"data-invoice-amount="<?php echo e($invoice_amount); ?>"
                                data-received-amount="<?php echo e($received_amount); ?>" data-return-amount="<?php echo e($return_amount); ?>"
                                ...
                                value="<?php echo e($invoice_amount - $received_amount - $return_amount); ?>"></td>
                        ...
                        <td><input
                                ...
                                id="tax_amount<?php echo e($counter); ?>"></td>

                        <td><input
                                onkeyup="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)"
                                onblur="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)"
                                class="form-control discount" type="text" value="" name="discount[]"
                                id="discount_amount<?php echo e($counter); ?>"></td>
