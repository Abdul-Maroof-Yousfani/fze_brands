...
<div class="row well_N align-items-center">
    ...
    <div class="col-md-8 text-right">
        <a href="<?php echo e(route('listProductsPrincipalGroup')); ?>" class="btn btn-secondary">Back to List</a>
    </div>
</div>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="headquid">
                  ...
                  <form action="<?php echo e(route('storeProductsPrincipalGroup')); ?>" method="POST">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 text-right">
                            ...
                            <a href="<?php echo e(route('listProductsPrincipalGroup')); ?>" class="btn btn-secondary btn-lg px-4">Cancel</a>
                        </div>
                    </div>
