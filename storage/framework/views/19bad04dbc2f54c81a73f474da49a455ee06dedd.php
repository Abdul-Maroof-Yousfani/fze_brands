...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        <?php if($Type !='audit_trial'): ?>
        <?php if($row->pv_status==1): ?>
            <?php if($approved == true):?>
                <button onclick="approve_voucher('new_pv','new_pv_data','pv_status','pv_date','pv_no','<?php echo e($row->type); ?>','<?php echo e($row->pv_no); ?>')" type="button" class="btn btn-primary btn-xs">Approve</button>
            <?php endif;?>
        <?php endif; ?>
        <?php endif; ?>
        <?php // FinanceHelper::displayApproveDeleteRepostButton($m,$row->pv_status,$row->status,$row->pv_no,'pv_no','pv_status','status');?>
        <a class="btn btn-primary prinn" target="new" href="<?php echo e(route('PaymentVoucherCheque',$id)); ?>"> Print Cheque </a>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="well" id="printBankPaymentVoucherDetail">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h3 style="text-align: center;"><?php if($row->payment_type==1): ?> Bank Payment Voucher <?php else: ?> Cash Payment Voucher <?php endif; ?></h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div style="width:40%; float:left;">
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    <tbody>
                                    <tr>
                                        <td style="width:40%;">     <?php if($row->payment_type==1): ?>BPV No. <?php else: ?> CPV No. <?php endif; ?></td>
                                    ...
                                    <tr>
                                        <td><?php if($row->payment_type==1): ?>BPV Date. <?php else: ?> CPV Date. <?php endif; ?></td>
                            ...
                            <div class="table-responsive">
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            <td class="text-center"><?php echo e(CommonHelper::get_paid_to_name($row2->paid_to_id,$row2->paid_to_type).$Type); ?></td>
                                        ...
                                        <td   class="debit_amount text-right">
                                            ...
                                            <a onclick="amount(<?php echo e($row2->amount); ?>)" style="cursor: pointer"> <?php echo  number_format($row2->amount,2); ?></a>
                                                <?php
                                                }else{}
                                            ?>
                                        </td>
                        ...
                        <?php echo $__env->make('Finance.AjaxPages.view_costing_for_vouchers', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
                    <img src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')->size(200)->generate('View Bank Payment Voucher Detail')); ?> ">
                </div>
                  <!-->
            </div>
        </div>
