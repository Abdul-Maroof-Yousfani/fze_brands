...
<select style="margin-top: 30px;" class="form-control select2" onchange="if(this.value) window.location.href='<?php echo e(url('set_user_db_id')); ?>?company=' + this.value">
    <option value="">Select Company</option>
    <?php $__currentLoopData = App\Helpers\CommonHelper::get_companies(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <ul class="profile-admin d-flex">
         ...
         <li>
            <div class="pro-user d-flex">
              ...
              <span class="avatar">
               <img class="round" src="<?php echo e(App\Helpers\CommonHelper::get_profile_pic()); ?>" alt="avatar" height="40" width="40">
              </span>
         ...
         <li class="dropdown user-name-drop">
            ...
            <div class="account-information dropdown-menu">
               <div class="account-inner d-flex">
                  <div class="davtar">
                  <span class="avatar">
               <img style="width: 100px;" class="round" src="<?php echo e(App\Helpers\CommonHelper::get_profile_pic()); ?>" alt="avatar" >
