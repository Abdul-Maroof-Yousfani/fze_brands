<form id="submit2" action="{{ route('edit-manufacturer') }}" method="post">
    <div class="mt">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <input type="text" class="form-control" name="manufacturer_name" id="manufacturer_name" value="{{ $data->manufacturer_name }}" required />
            </div>
        </div>
    </div>
    <div class="row">&nbsp;</div>
