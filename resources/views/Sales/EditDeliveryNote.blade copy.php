                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            ...
                                            <input readonly type="text" class="form-control requiredField"
                                                placeholder="" name="gd_no" id="gd_no"
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            ...
                                            <input autofocus type="date" class="form-control requiredField"
                                                placeholder="" name="gd_date" id="gd_date"
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <label class="sf-label">Supplier's Ref <span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <input readonly type="text" class="form-control requiredField"
                                                placeholder="" name="so_no" id="so_no"
                                                value="{{$delivery_note->so_no}}" />
                                        </div>

                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <label class="sf-label">Supplier's Ref Date <span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <input readonly type="date" class="form-control requiredField"
                                                placeholder="" name="so_date" id="so_date"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hide">
                                            <label class="sf-label">Buyer's Order No<span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <input readonly type="text" class="form-control requiredField"
                                                placeholder="" name="order_no" id="order_no"
                                                value="{{$delivery_note->order_no}}" />
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hide">
                                            ...
                                            <input readonly type="date" class="form-control requiredField"
                                                ...
                                                value="{{$delivery_note->order_date}}" />
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <label class="sf-label">Despatched through<span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <input readonly type="text" class="form-control requiredField"
                                                placeholder="" name="despacth_through" id="despacth_through"
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <label class="sf-label">Destination<span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <input readonly type="text" class="form-control requiredField"
                                                placeholder="" name="destination" id="destination"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hide">
                                            <label class="sf-label">Terms Of Delivery<span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <input readonly type="text" class="form-control requiredField"
                                                placeholder="" name="terms_of_delivery" id="terms_of_delivery"
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            <label class="sf-label">Buyer's Name <span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <select disabled name="" id="ntn" onchange="get_ntn()"
                                                class="form-control select2">
                                                <option>Select</option>
                                                @foreach(SalesHelper::get_all_customer() as $row)
                                                <option @if($delivery_note->buyers_id==$row->id) selected @endif
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hide">
                                            <label class="sf-label">Due Date <span
                                                    class="rflabelsteric"><strong>*</strong></span></label>
                                            <input readonly type="date" class="form-control requiredField"
                                                placeholder="" name="due_date" id="due_date"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-condensed tableMargin">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">WareHouse. <span
                                                            class="rflabelsteric"><strong>*</strong></span></th>
                                                            @if($delivery_note->virtual_warehouse_check == 1)
                                                    <th class="text-center">WareHouse To <span
                                                            class="rflabelsteric"><strong>*</strong></span></th>
                                                    @endif
                                                    ...
                                                    <th class="text-center hidee">MRP</th>
                                            ...
                                            <tbody>
                                                ...
                                                $id_count++;     ?>
                                                {{--hidden data--}}
                                                <input type="hidden" name="data_id{{$id_count}}" id="data_id"
                                                    value="{{$row1->so_data_id}}" />
                                                <input type="hidden" name="groupby{{$id_count}}" id="groupby"
                                                    value="{{$row1->groupby}}" />
                                                <input type="hidden" name="item_id{{$working_counter}}"
                                                    id="item_id{{$working_counter}}" value="{{$row1->item_id}}" />
                                                <input type="hidden" name="rate{{$working_counter}}"
                                                    id="rate{{$working_counter}}" value="{{$row1->rate}}" />
                                                ...
                                                <input type="hidden" name="amount{{$working_counter}}"
                                                    id="amount{{$working_counter}}" value="{{$row1->amount}}" />
                                                ...
                                                <tr>
                                                    <td class="text-center" class="text-center"><?php echo $counter;?>
                                                    </td>
                                                    ...
                                                    ?>
                                                    <td class="text-left">
                                                        <?php echo CommonHelper::get_uom_name($sub_ic_detail[0]);?></td>
                                                    ...
                                                    <td class="text-right">
                                                        <input onkeyup="calc('{{$id_count}}')"
                                                            onblur="calc('{{$id_count}}')" class="form-control qty"
                                                            type="text" name="send_qty{{$id_count}}"
                                                            id="send_qty{{$id_count}}" value="{{$row1->qty}}" />
                                                        <?php
                                                        ...
                                                        <input type="hidden" id="aterCalcQty<?php echo $id_count?>"
                                                    ...
                                                    <td><select
                                                            ...
                                                            name="warehouse{{$id_count}}" id="warehouse{{$id_count}}">
                                                    ...
                                                    <td>
                                                        <select onchange=""
                                                            ...
                                                            <option value="{{$row->id}}" {{ $row1->warehouse_to_id == $row->id ? "selected" :"" }}>{{$row->name}}</option>
                                                            @endforeach
                                                    ...
                                                    <td>
                                                        ...
                                                        <select onchange="get_stock_qty(this.id,'{{$id_count}}')"
                                                            class="form-control requiredField"
                                                            name="batch_code{{$id_count}}" id="batch_code{{$id_count}}">
                                                            <option value="">
                                                                Select&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            </option>
                                                            <?php foreach($Batch as $bfil):?>
                                                            <option value="<?php echo $bfil->batch_code?>"
                                                                <?php if($row1->batch_code == $bfil->batch_code):echo "selected"; endif;?>>
                                                                <?php echo $bfil->batch_code?></option>
                                                            <?php endforeach;?>
                                                        </select>
                                                    </td>
                                                    ...
                                                    <td class="text-right hidee">
                                                        <input readonly class="form-control" type="text"
                                                            name="send_rate{{$id_count}}" id="send_rate{{$id_count}}"
                                                            value="{{$row1->rate}}" />

                                                    </td>
                                                    <td class="text-right hidee">
                                                        <input readonly class="form-control" type="text"
                                                            name="mrp_price{{$id_count}}" id="mrp_price{{$id_count}}"
                                                    ...
                                                    <td class="text-right hidee">
                                                        <input readonly class="form-control" type="text"
                                                            ...
                                                            id="send_discount{{$id_count}}" value="{{$row1->tax}}" />
                                                    ...
                                                    <td class="text-right hidee">
                                                        <input readonly class="form-control amount comma_seprated"
                                                            ...
                                                            id="send_amount{{$id_count}}" value="{{$row1->amount}}" />
                                                    </td>
                                                    <td class="hide"><input type="checkbox" class=""
                                                            id="check{{$id_count}}"
                                                ...
                                                <tr
                                                    ...
                                                    <td class="text-right"> <?php echo number_format($row1->bqty,3)?>
                                                    </td>
                                                    <td></td>
                                                    <td class="text-right hidee">
                                                        <?php echo number_format($row1->bundle_rate,2);?></td>
                                                    <td class="text-right hidee">
                                                        <?php echo number_format($row1->amount,2);?></td>
                                                    <td class="text-right hidee">
                                                        <?php echo number_format($row1->b_percent,2);?></td>
                                                    <td class="text-right hidee">
                                                        <?php echo number_format($row1->b_dis_amount,2);?></td>
                                                    <td class="text-right hidee">
                                                        <?php echo number_format($row1->b_net,2);?></td>
                                                ...
                                                id="qty{{$working_counter}}" value="{{$bundle_data->qty}}"/>--}}
                                                <input type="hidden" name="bundles_id{{$working_counter}}"
                                                ...
                                                <tr style="background-color: lightyellow">
                                                    ...
                                                    <td class="text-right"> <input onkeyup="calc('{{$id_count}}')"
                                                            onblur="calc('{{$id_count}}')" class="form-control qty"
                                                            type="text" name="send_qty{{$id_count}}"
                                                            id="send_qty{{$id_count}}" value="{{$bundle_data->qty}}" />
                                                        <?php
                                                    ...
                                                    <td>
                                                        ...
                                                        <select onchange="get_stock_qty(this.id,'{{$working_counter}}')"
                                                            class="form-control requiredField"
                                                            name="batch_code{{$id_count}}" id="batch_code{{$id_count}}">
                                                            <option value="">
                                                                Select&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <option value="<?php echo $fil->batch_code?>"
                                                                <?php if($bundle_data->batch_code == $fil->batch_code):echo "selected"; endif;?>>
                                                                <?php echo $fil->batch_code?></option>
                                                            <?php endforeach;?>
                                                    ...
                                                    <td><input type="checkbox" class="" id="check{{$id_count}}"
                                            ...
                                            <tr>
                                                ...
                                                <td id="total_" style="background-color: darkgray" class="text-center"
                                                    colspan="6">Total</td>
                                                ...
                                                <td style="background-color: darkgray" class="text-right hidee nett"
                                                    colspan="7"><input style="font-weight: bolder"
                                                        ...
                                                        type="text" id="total_amount" value="{{$FinalTot}}" /></td>
                                            ...
                                            <tr class="hidee">
                                                <td class="text-center" colspan="9"></td>
                                                <td class="text-right" colspan="2"> <b>(Sales Tax Further 3%)</b>
                                            ...
                                            <tr class="hidee">
                                                ...
                                                <td colspan="1"> <input style="font-weight: bolder"
                                                        ...
                                                        value="{{$delivery_note->sales_tax_amount}}" /></td>
