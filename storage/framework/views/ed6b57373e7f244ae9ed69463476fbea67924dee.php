    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp; Create Group</h3>
                </li>
            </ul>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel">
                            ...
                            <div class="headquid">
                           <h2 class="subHeadingLabelClass">Create Group</h2>
                        </div>
                                <form action="<?php echo e(route('companyGroupStore')); ?>" method="POST">
