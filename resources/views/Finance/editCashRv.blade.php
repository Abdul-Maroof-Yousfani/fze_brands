                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <select name="warehouse_id" id="warehouse_id" class="form-control requiredField select2">
                                                ...
                                                @foreach (CommonHelper::get_all_branch() as $branch)
                                                    <option value="{{ $branch->id }}" {{ $branch->id == $NewRvs->warehouse_id ? 'selected' : '' }}>{{ $branch->branch_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <textarea  name="description_1" id="desc_1_1000" style="resize:none;" class="form-control"><?= $NewRvs->description ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
