...
<div class="well_N">
    ...
    <div class="row align-items-center ">
        <div class="col-md-8">
    <h3>Edit User</h3>
    <form id="editUserForm" action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
        ...
        <div class="row">
                ...
                <select class="form-select select2" id="employee" name="employee" style="width: 100%;">
                    ...
                    <?php $__currentLoopData = App\Helpers\SalesHelper::get_all_employees(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row->id); ?>" data-email="<?php echo e($row->email); ?>" data-name="<?php echo e($row->name); ?>"
                            <?php echo e($row->name == $user->name ? 'selected' : ''); ?>>
                            <?php echo e($row->name); ?>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" id="name" name="name" value="<?php echo e(old('name', $user->name)); ?>" class="form-control" readonly>
            </div>

            <!-- Email -->
            <div class="col-md-6 mb-3">
                <label for="email" class="form-label">Username</label>
                <input type="text" id="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-control">
            </div>
      <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                <input class="form-check-input"
                                       ...
                                       <?php echo e($role->id == $user->ba_role_id ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="checkbox"  
                                ...
                                value="1" 
                                <?php echo e($user->locations->count() > 0 ? 'checked' : ''); ?>>
                        </div>
                    </div>
                </div>
            
                <div class="row get_location" style="<?php echo e($user->locations->count() > 0 ? '' : 'display:none;'); ?>">
                    <div class="col-md-12">
                        ...
                        <div id="locations_wrapper">
                            ...
                            <?php if($user->locations->count()): ?>
                                <?php $__currentLoopData = $user->locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="location_section border p-2 mb-3 rounded">
                                        ...
                                        <table class="table mt-2">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" class="form-control" name="location_name[]" value="<?php echo e($location->location_name); ?>" placeholder="Location Title"/></td>
                                                    <td><input type="number" step="any" readonly class="form-control lat" name="latitude[]" value="<?php echo e($location->latitude); ?>" placeholder="Latitude"/></td>
                                                    <td><input type="number" step="any" readonly class="form-control lon" name="longitude[]" value="<?php echo e($location->longitude); ?>" placeholder="Longitude"/></td>
                                                    <td><input type="number" step="any" class="form-control" name="radius[]" value="<?php echo e($location->radius); ?>" placeholder="Radius (KM)"/></td>
...
<script>
    ...
    var latitude = parseFloat(<?php echo e(isset($tso->latitude)?$tso->latitude:24.8607343); ?>); // Example latitude
    var longitude = parseFloat(<?php echo e(isset($tso->longitude)?$tso->longitude:67.0011364); ?>); // Example longitude
...
<!-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google_maps.key')); ?>&libraries=places&callback=initMaps"></script> -->
