                            ...
                            <table class="table table-bordered sf-table-list">
                                ...
                                <?php $__currentLoopData = CommonHelper::get_all_cost_center(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr id="<?php echo e($row->id); ?>">
                                        ...
                                        <td <?php if($row->first_level==1): ?> style="font-weight: bold" <?php endif; ?>>
                                            <?php if($level == 1): ?>
                                            ...
                                            <div class="switch_box box_4">
                                                <div class="input_wrapper">
                                                    <input  type="checkbox" class="switch_4 <?php if($row->first_level != 1):?> End_Dis_1 <?php endif;?> <?php if($row->first_level == 1):?> MainCheckBox1 <?php endif;?>" id="OnOffId<?php echo $row->id?>" onchange="setOnOffText('<?php echo $row->id?>','1');<?php if($row->first_level == 1):?> EnabledDisabled('1') <?php endif;?>"
                                                            ...
                                                            <?php if(in_array($row->main_menu_id,$data[0])): ?> checked <?php endif; ?>
                                                            name="main[]"
                                            ...
                                            <?php if($level != 2): ?>
                                                <?php if($row->menu_type==1): ?>
                                                    <?php if(in_array($row->main_menu_id,$data[0])): ?>
                                                        <i class="fa fa-check text-success" aria-hidden="true" style="font-size: 25px;"></i> <?php else: ?> <i class="fa fa-ban text-danger" aria-hidden="true" style="font-size: 25px;"></i>
                                                    <?php endif; ?>
