...
<div id="" class="well_N">
    ...
    <?php $__currentLoopData = $data1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <table class="table table-bordered sf-table-th sf-table-list" id="export_table_to_excel_<?php echo $LedgerCount; ?>">
            ...
            <tr>
                <td colspan="7" style="background-color:#ffffff; color:black;">
                    <h3 style="text-align: center"><?php echo e($row1->code.' '.$row1->name); ?></h3>
                </td>
            </tr>
        ...
        $category='';
            ...
            <tr title="<?php echo $trow->voucher_type ?>"  class="hov" style="">
                ...
                <td><?php echo e($page_typ); ?><br><?php echo e($category); ?></td>
    ...
    <p>Total Debit = <?php echo e(number_format($all_debit,2)); ?></p>
    <p>Total Credit = <?php echo e(number_format($all_credit,2)); ?></p>
    <?php if($level==2 || $level==3 || $level==4): ?>
        ...
        ?>
        <p>Diffrence = <?php echo e($total); ?></p>
    <?php else: ?>
    ...
    Total Sales Tax Invoice <?php echo e(number_format($total_sales_invoice,2)); ?><br>
    Total Debit Note  <?php echo e(number_format($total_debit_note,2)); ?><br>
    Total Purchase Invoice  <?php echo e(number_format($total_purchase_invoice,2)); ?><br>
    Total Cr Note <?php echo e(number_format($total_cr_note,2)); ?>
