                                        ...
                                        <div class="row qout-h">
                                            ...
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                      <input type="text" class="form-control" value="{{ $credit->store }}" name="store" placeholder="Office Staff()">                                                    
                                                    </div>
                                                    </div>  
                                                </div>
                                            </div>
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                      <input type="text" class="form-control" name="delivery_man" value="{{ $credit->delivery_man }}" placeholder="Jahangir Ahmed">                                                    
                                                    </div>
                                                    </div>  
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                      <input type="date" class="form-control" value="{{ $credit->date }}" name="date_and_time">                                                    
                                                    </div>
                                                    </div>  
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                      <input type="number" class="form-control" value="{{ $credit->amount }}" name="amount">                                                    
                                                    </div>
                                                    </div>  
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                        <textarea class="form-control" name="details">{{ $credit->details }}</textarea>
                                                    </div>
                                                    </div>  
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="display: flex;">
                                                        ...
                                                        <div class="" style="padding-left: 0px;">
                                                            <input type="checkbox" {{ $credit->on_record ? "checked" : "" }} name="on_record"/>
                                                        </div>
                                                    </div>  
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                        <select class="form-control select2" name="voucher_type">
                                                            ...
                                                            @foreach($vouchers as $voucher)
                                                                <option value="{{ $voucher->id }}" {{ $credit->voucher_type == $voucher->id ? 'selected' : '' }}>{{ $voucher->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    </div>  
