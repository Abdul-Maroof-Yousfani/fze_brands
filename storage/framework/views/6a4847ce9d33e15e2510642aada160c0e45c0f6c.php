                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                        ...
                                        <input  readonly type="text" class="form-control requiredField" placeholder="Slip No"
                                                name="" id="" value="<?php echo e(strtoupper($crv_no)); ?>" />
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <table id="buildyourform" class="table table-bordered">
                                                ...
                                                <tr class="AutoNo">
                                                    ...
                                                    <td>
                                                        <select class="form-control requiredField select2" name="account_id[]" id="account_id<?php echo e($j); ?>" onchange="AppendBrand('<?php echo $j?>')">
                                                            ...
                                                            <?php $__currentLoopData = CommonHelper::get_all_account_operat(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($y->id.','.$y->type); ?>"><?php echo e($y->code .' ---- '. $y->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                                    <td>
