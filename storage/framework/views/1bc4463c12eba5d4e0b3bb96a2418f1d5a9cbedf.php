        ...
        <tbody>
            ...
            <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             ...
             $gi_no[]=$invoice_detail->gi_no;
              ?>
              <input type="hidden" name="si_id[]" value="<?php echo e($row); ?>"/>
              <input type="hidden" name="so_id[]" value="<?php echo e($invoice_detail->so_id); ?>"/>

            <tr title="<?php echo e('sales_invoice_id='.$row); ?>">
            <td class="text-center"><?php echo e(strtoupper($invoice_detail->gi_no)); ?></td>
            <td class="text-center"><?php if($invoice_detail->so_type==1): ?><?php echo e($invoice_detail->description); ?><?php else: ?> <?php echo e(strtoupper($invoice_detail->so_no)); ?><?php endif; ?></td>
                <td><?php echo e($invoice_detail->sc_no); ?></td>
            ...
            <td><input class="form-control receive_amount" onkeyup="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)"
             onblur="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)" type="text" name="receive_amount[]" id="receive_amount<?php echo e($counter); ?>"
                      value="<?php echo e($invoice_amount-$received_amount-$return_amount); ?>"
                        ></td>

            <td><select  onchange="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',0)" id="percent<?php echo e($counter); ?>" class="form-control tex_p" name="percent[]">
                    <option value="0">Select</option>
                    <?php $__currentLoopData = App\Helpers\ReuseableCode::get_invoice_tax(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row1->name); ?>"><?php echo e($row1->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </td>


            <td><input onkeyup="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)"
                       onblur="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)" class="form-control tax" type="text"  value="" name="tax_amount[]" id="tax_amount<?php echo e($counter); ?>"></td>

            <td><input onkeyup="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)"
            onblur="calc('<?php echo e($invoice_amount); ?>','<?php echo e($received_amount); ?>','<?php echo e($counter); ?>','<?php echo e($return_amount); ?>',1)"
            class="form-control discount" type="text"  value="" name="discount[]" id="discount_amount<?php echo e($counter); ?>"></td>

            <td><input class="form-control net_amount comma_seprated" type="text"  value="<?php echo e($invoice_amount-$received_amount-$return_amount); ?>" name="net_amount[]" id="net_amount<?php echo e($counter); ?>"></td>
         ...
         <?php $counter++; $gi=implode(',',$gi_no);?>  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
