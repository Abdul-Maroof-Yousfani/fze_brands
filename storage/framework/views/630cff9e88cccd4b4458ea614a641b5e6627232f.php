                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="form-control select2" id="subitem_id">
                                ...
                                <?php $__currentLoopData = \App\Helpers\CommonHelper::get_subitems(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subitem->id); ?>"><?php echo e($subitem->product_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
