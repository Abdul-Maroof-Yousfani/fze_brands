                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="<?php echo e(route('salesorder.store')); ?>" method="post" id="create-sale-order-form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <select onchange="getCustomer(this); "
                                                        ...
                                                        <?php $__currentLoopData = CommonHelper::get_customer_territory(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option data-type="<?php echo e($item->CustomerType); ?>" value="<?php echo e($item->id); ?>" id="tax<?php echo e($item->id); ?>">
                                                ...
                                                <tr class="main">
                                                    <td>
                                                        <select style="width: 150px;" onChange="checkCustomerSelected(this);get_product_by_brand(this,1);getBrandCustomerDiscount(this,1);" name="brand_id[]" class="form-control brands" id="brand_id1" >
                                                            ...
                                                            <?php $__currentLoopData = CommonHelper::get_all_brand_territory(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                        ...
                                        <div class="padt">
                                            ...
                                            <!-- <select name="sale_taxes_id" class="form-control" onchange="applySaleTax(this)">
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <select name="sale_taxes_id" class="form-control" onchange="applySaleTax(this)">
                                                        <option value="">Select</option>
                                                        <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>" <?php echo e($index == 0 ? 'selected' : ''); ?>>
