                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select class="form-control select2 requiredField" name="customer_id"
                                                    ...
                                                    <?php $__currentLoopData = CommonHelper::get_customer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidee">
                                                ...
                                                <input value="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="cheque_date"
                                                    type="date">
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hideee">
                                                ...
                                                <select class="form-control requiredField select2" name="account_recieve_id"
                                                    ...
                                                    <?php $__currentLoopData = CommonHelper::get_all_account_operat(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php echo e($y->id == 1235 ? 'selected' : ''); ?> value="<?php echo e($y->id); ?>">
                                                            <?php echo e($y->code . ' ---- ' . $y->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
