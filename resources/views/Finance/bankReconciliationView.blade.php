                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            ...
                                                            <input type="Date" onchange="validateToDateUsingFromDate(event)"  name="fromDate" id="fromDate" min="<?php echo $AccYearFrom?>" max="<?php echo $AccYearTo;?>" value="<?php echo $currentMonthStartDate;?>" class="form-control"/>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding: 36px 30px;">
                                                            <a class="btn btn-sm btn-primary"  id="search" onclick="viewRangeWiseDataFilter();" style="margin-top: 32px;" >Search</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
//            ActFilter = ActFilter[0]+'-'+ActFilter[1];
        ...
        function loadFilterLedgerReport() {
            ...
            $.ajax({
                url: '<?php echo url('/');?>/finance/bankReconciliationView',
                method:'GET',
