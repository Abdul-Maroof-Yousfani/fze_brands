...
@section('content')
    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp; Qc Packing List</h3>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="row hide" style="margin-top:10px">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" style="margin: 5px 0px 0px px;" onclick="viewPacking();">Submit</button>
                                    </div>
                                </div>
                            </div>
                        <div class="panel">
                            <div class="panel-body">
                            <div class="headquid">
                           <h2 class="subHeadingLabelClass">View Qc Packing List </h2>
                        </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="">
    ...
    $(document).ready(function(){
         ...
         function viewPacking()
        {
            ...
            $.ajax({
                url: '<?php echo url('/')?>/Production/QaPacking/',
                type: 'Get',
                data: {
                        rate_date:rate_date,
                        to_date:to_date
