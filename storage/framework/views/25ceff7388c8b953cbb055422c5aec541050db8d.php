...
<table class="table table-bordered ApnaBorder  AutoCounter table<?php echo e($BuyerCounter); ?>"
...
?>
            ...
            ?>
            <tr title="<?php echo e($count++); ?>" class="text-center ApnaBorder yes">
...
endforeach;?>
    ...
    <tr class="text-center ApnaBorder">
        ...
        <td class="ApnaBorder" style="font-weight: bold;"><?php echo e(number_format($total_not_yet_due, 2)); ?> <?php $total_not_yet_due_end += $total_not_yet_due; ?>
        </td>
        ...
        <td class="ApnaBorder <?php if ($TotOverAll==0): ?>  hidee<?php echo e($BuyerCounter); ?><?php endif ?>"
            style="font-weight: bold;"><?php echo number_format($TotOverAll, 2);
            $TotOverAllEnd += $TotOverAll; ?></td>
        <input type="hidden" value="<?php echo e($TotOverAll); ?>" class="val" id="<?php echo e($BuyerCounter); ?>" />
    </tr>
    </tbody>
...
<table class="table table-bordered ApnaBorder table<?php echo e($BuyerCounter); ?> GrandTotal"
    id="export_table_to_excel_<?php echo $BuyerCounter; ?>">
    <tr class="text-center ApnaBorder">
    ...
    <tr class="text-center ApnaBorder">
        ...
        <td class="ApnaBorder" style="font-weight: bold;"><?php echo e(number_format($total_not_yet_due_end, 2)); ?></td>
