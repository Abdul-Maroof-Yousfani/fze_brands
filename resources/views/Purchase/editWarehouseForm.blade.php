                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <input autofocus type="text" name="warehouse" value="{{ $warehouse->name }}" id="warehouse"
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <select name="territory_id" id="territory_id" class="form-control select2">
                                                        @foreach(App\Helpers\CommonHelper::get_all_territories() as $territory)
                                                            <option value="{{ $territory->id }}" {{ $warehouse->territory_id == $territory->id ? 'selected' : '' }}>{{ $territory->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
