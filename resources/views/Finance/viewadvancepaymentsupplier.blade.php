...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="headquid">
                                            <span class="subHeadingLabelClass">View Advance Payment Supplier List</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function filter_advance_list()
        {
            ...
            $.ajax({
                url: '<?php echo url('/')?>/finance/viewadvancepaymentsupplier',
                type: 'Get',
                data: {supplier_id:supplier_id,amount_issued_status:amount_issued_status},
