...
<div class="row headquid">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        ...
        <?php if($row->jv_status==1): ?>
            <?php if($approved == true):?>
            <button onclick="approve_voucher('new_jvs','new_jv_data','jv_status','jv_date','jv_no','1','<?php echo e($row->jv_no); ?>', 'Journal Voucher')" type="button" class="btn btn-primary btn-xs">Approve</button>
            <?php endif;?>
        <?php endif; ?>
        <?php endif; ?>
                                ...
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:60%;"><?php echo e(strtoupper($customerDetails->name)); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Address</td>
                                            <td><?php echo e($customerDetails->address ?? '-'); ?></td>
                                        </tr>
                                        <tr>
                                            <td>NTN</td>
                                            <td><?php echo e($customerDetails->NTNNumber ?? '-'); ?></td>
                                        </tr>
                                        <tr>
                                            <td>STN</td>
                                            <td><?php echo e($customerDetails->strn ?? '-'); ?></td>
                                        </tr>
                                        <?php else: ?>
                                        <tr>
                                            <td colspan="2">No customer details found for <?php echo e($row->username); ?></td>
                                        </tr>
                                        <?php endif; ?>
                                ...
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    ...
                                    <tr>
                                      ...
                                      <td class=""><?php  echo $row2->description;?></td>
                                        <td class="hide"><?php echo e(CommonHelper::get_sub_dept_name($row2->sub_department_id)); ?></td>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">
                                            ...
                                            <b>   <p><?php echo e(strtoupper(optional($row)->verified_by)); ?></p></b>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">
