                                                    ...
                                                    <div class="row justify-content-end text-right">
                                                        <div class="col-md-2 mb-3">
                                                            ...
                                                            <select name="principle_group" class="form-control select2">
                                                                ...
                                                                <?php $__currentLoopData = $principl_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $principle_group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($principle_group->id); ?>"><?php echo e($principle_group->products_principal_group); ?></option>
                                                        ...
                                                        <div class="col-md-2 mb-3">
                                                            ...
                                                            <select name="product_trend_id[]" multiple class="form-control select2">
                                                                ...
                                                                <?php $__currentLoopData = $product_trends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<form id="exportForm" method="GET" action="<?php echo e(route('export.subitems')); ?>" target="_blank" style="display:none;"></form>
            ...
            <script>
                $(document).ready(function() {
                    filterationCommonGlobal('<?php echo e(route('viewSubItemListAjax')); ?>');
                });
            </script>
