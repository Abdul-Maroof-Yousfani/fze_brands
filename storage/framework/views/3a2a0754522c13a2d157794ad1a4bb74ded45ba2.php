                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <select name="territory_id" id="territory_id"
                                                                            ...
                                                                            <?php $__currentLoopData = $Territory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <select name="sale_person" id="sale_person" class="form-control">
                                                                            <option selected value="">Select Option</option>
                                                                            <?php $__currentLoopData = $SubDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($person->id); ?>"><?php echo e($person->sub_department_name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <select onChange="getCustomerType(this)" name="customer_type"
                                                                            ...
                                                                            <option selected value="">Select Option</option>
                                                                            <!-- <?php $__currentLoopData = $CustomerType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option data-type="<?php echo e(strtolower($data->name)); ?>" value="<?php echo e($data->id); ?>"><?php echo e($data->name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <select name="employee_id" id="employee_id" class="form-control select2">
                                                                            <option value="">Select Option</option>
                                                                            <?php $__currentLoopData = App\Helpers\SalesHelper::get_all_unregistered_employees(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($row->id); ?>" data-email="<?php echo e($row->email); ?>" data-name="<?php echo e($row->name); ?>">
