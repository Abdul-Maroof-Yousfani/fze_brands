                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="hidden" id="url" value="<?php echo e(url('sales/viewCreditCustomerList?m=1')); ?>">
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <label>Name :</label>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="text" name="phone_1" id="phone_1"
                                                                                value="<?php echo e($Cusomter->phone_1); ?>"
                                                                                class="form-control " />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="text" name="phone_2" id="phone_2"
                                                                                value="<?php echo e($Cusomter->phone_2); ?>"
                                                                                class="form-control" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <label>Country :</label>
                                                                            ...
                                                                            <select name="country" id="country"
                                                                                ...
                                                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select name="state" id="state" class="form-control ">
                                                                                <?php $__currentLoopData = $States; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($y->id); ?>"
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select name="city" id="city" class="form-control ">
                                                                                <?php $__currentLoopData = $Cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($y->id); ?>"
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="number" name="zip" id="zip"
                                                                                value="<?php echo e(isset($Cusomter->zip) ? $Cusomter->zip : ''); ?>"
                                                                                class="form-control" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <label>Title :</label>
                                                                            ...
                                                                            <input type="text" name="title" id="title"
                                                                                value="<?php echo e(isset($Cusomter->title) ? $Cusomter->title : ''); ?>"
                                                                                class="form-control" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="text" name="contact_person"
                                                                                id="contact_person"
                                                                                value="<?php echo e(isset($Cusomter->contact_person) ? $Cusomter->contact_person : ''); ?>"
                                                                                class="form-control" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="text" name="contact_person_email"
                                                                                ...
                                                                                value="<?php echo e(isset($Cusomter->contact_person_email) ? $Cusomter->contact_person_email : ''); ?>"
                                                                                class="form-control" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="radio" id="same_as_company_address"
                                                                                ...
                                                                                <?php echo e($Cusomter->company_shipping_type == "same as company address" ? 'checked' : ''); ?> />
                                                                            <label for="contactChoice1">Same As Company
                                                                                Address</label>
                                                                            </br>
                                                                            <input type="radio"
                                                                                <?php echo e($Cusomter->company_shipping_type == "others" ? 'checked' : ''); ?>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input type="text" name="shipping_city"
                                                                                ...
                                                                                value="<?php echo e($Cusomter->shipping_city); ?>" />
                                                                        </div>
                                                                        <div
                                                                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 shippingfield">
                                                                            ...
                                                                            <input type="text" name="shipping_state"
                                                                                ...
                                                                                value="<?php echo e($Cusomter->shipping_state); ?>" />
                                                                        </div>
                                                                        <div
                                                                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 shippingfield">
                                                                            ...
                                                                            <input type="text" name="shipping_country"
                                                                                ...
                                                                                value="<?php echo e($Cusomter->shipping_country); ?>" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="number" name="opening_balance"
                                                                                ...
                                                                                value="<?php echo e($Cusomter->opening_balance); ?>" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="date" name="opening_balance_date"
                                                                                ...
                                                                                value="<?php echo e($Cusomter->opening_balance_date); ?>"
                                                                                class="form-control" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select onChange="taxFiler(this)" name="tax_filer"
                                                                                ...
                                                                                <option value="yes"
                                                                                    <?php echo e($Cusomter->regd_in_income_tax == "Yes" ? 'selected' : ''); ?>>
                                                                                    Yes</option>
                                                                                <option value="no"
                                                                                    <?php echo e($Cusomter->regd_in_income_tax == "no" ? 'selected' : ''); ?>>
                                                                                    No</option>
                                                                            </select>
                                                                        </div>
                                                                        <div
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input type="text" name="strn_term" id="strn_term"
                                                                                class="form-control"
                                                                                value="<?php echo e($Cusomter->strn_term); ?>" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                                            ...
                                                                            <select name="display_note_invoice"
                                                                                ...
                                                                                class="form-control ">
                                                                                <option value="yes"
                                                                                    <?php echo e($Cusomter->display_note_invoice == "yes" ? 'selected' : ''); ?>>
                                                                                    yes</option>
                                                                                <option value="no"
                                                                                    <?php echo e($Cusomter->display_note_invoice == "no" ? 'selected' : ''); ?>>
                                                                                    no</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                                            ...
                                                                            <input type="number" name="wh_tax" id="wh_tax"
                                                                                class="form-control"
                                                                                value="<?php echo e($Cusomter->wh_tax); ?>" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                                            <label>Adv Tax :</label>
                                                                            <span class="rflabelsteric"></span>
                                                                            <input type="number" name="adv_tax" id="adv_tax"
                                                                                class="form-control"
                                                                                value="<?php echo e($Cusomter->adv_tax ?? 0); ?>" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="text" name="credit_amount"
                                                                                id="credit_amount"
                                                                                class="form-control "
                                                                                value="<?php echo e($Cusomter->creditLimit); ?>" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select name="locality" id="locality"
                                                                                class="form-control">
                                                                                <option value="1"
                                                                                    <?php echo e($Cusomter->locality == 1 ? 'selected' :''); ?>>
                                                                                    local</option>
                                                                                <option value="2"
                                                                                    <?php echo e($Cusomter->locality == 2 ? 'selected' :''); ?>>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select name="store_category" id="store_category"
                                                                                ...
                                                                                <?php $__currentLoopData = $StoresCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($category->id); ?>" <?php echo e($Cusomter->store_category == $category->id ? 'selected' :''); ?>><?php echo e($category->name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select name="territory_id" id="territory_id"
                                                                                ...
                                                                                <option value="<?php echo e($territory->id); ?>" <?php echo e($Cusomter->territory_id == $territory->id ? 'selected' :''); ?>><?php echo e($territory->name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </div>
                                                                        <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <input type="text" name="sale_person" id="sale_person"
                                                                                class="form-control"
                                                                                value="<?php echo e($Cusomter->SaleRep); ?>" />
                                                                        </div> -->
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                <label>Sales Person :</label>
                                                                                <span class="rflabelsteric"></span>
                                                                                <select name="sale_person" id="sale_person" class="form-control">
                                                                                    ...
                                                                                    <?php $__currentLoopData = $salesPersons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option value="<?php echo e($person->id); ?>" 
                                                                                            <?php echo e($Cusomter->SaleRep == $person->id ? 'selected' : ''); ?>>
                                                                                            <?php echo e($person->sub_department_name); ?>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input type="text" name="account_no" id="account_no"
                                                                                class="form-control"
                                                                                value="<?php echo e(isset($Bank->account_no) ? $Bank->account_no : ''); ?>" />
                                                                        </div>
                                                                        <div
                                                                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bankDetailField">
                                                                            ...
                                                                            <input type="text" name="account_title"
                                                                                ...
                                                                                value="<?php echo e(isset($Bank->account_title) ? $Bank->account_title : ''); ?>" />
                                                                        </div>
                                                                        <div
                                                                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bankDetailField">
                                                                            <label>Bank :</label>
                                                                            ...
                                                                            <input type="text" name="bank"
                                                                                value="<?php echo e(isset($Bank->bank_name) ? $Bank->bank_name : ''); ?>"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input type="text" name="branch_code" id="branch_code"
                                                                                class="form-control"
                                                                                value="<?php echo e(isset($Bank->swift_code) ? $Bank->swift_code : ''); ?>" />
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select onChange="getCustomerType(this)"
                                                                                ...
                                                                                class="form-control " > 
                                                                                 ...
                                                                                 <option selected value="">Select Option</option> 
                                                                            <option data-type="general" value="1" <?php echo e($Cusomter->CustomerType == 1 ? 'selected' :''); ?>>General</option>
                                                                            <option data-type="employee" value="2" <?php echo e($Cusomter->CustomerType == 2 ? 'selected' :''); ?>>Employee</option>
                                                                            <option data-type="reseller" value="3" <?php echo e($Cusomter->CustomerType == 3 ? 'selected' :''); ?>>Reseller/ Distributor
                                                                            </option>
                                                                            </select>
                                                                        </div>
                                                                        <div
                                                                            ...
                                                                            <select name="ba_mapping" id="ba_mapping"
                                                                                ...
                                                                                <option value="">Select Option</option>
                                                                                <option value="1"
                                                                                    <?php echo e($Cusomter->ba_mapping == 1? 'selected' :''); ?>>
                                                                                    Yes</option>
                                                                                <option value="0"
                                                                                    <?php echo e($Cusomter->ba_mapping == 0? 'selected' :''); ?>>
                                                                                    No</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select name="employee_id" id="employee_id"
                                                                                class="form-control">
                                                                                <option value="">Select Option</option>
                                                                                <?php $__currentLoopData = \App\Helpers\SalesHelper::get_all_unregistered_employees(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($employee->id); ?>"
                                                                                        <?php echo e($Cusomter->employee_id == $employee->id ? 'selected' :''); ?>>
                                                                                        <?php echo e($employee->name); ?> -- <?php echo e($employee->id); ?></option>
                                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                    </select>
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <select name="special_price_mapped"
                                                                                ...
                                                                                <option value="">Select Option</option>
                                                                                <option value="1"
                                                                                    <?php echo e($Cusomter->special_price_mapped == 1? 'selected' :''); ?>>
                                                                                    Yes</option>
                                                                                <option value="0"
                                                                                    <?php echo e($Cusomter->special_price_mapped == 0? 'selected' :''); ?>>
                                                                                    No</option>
                                                                            </select>
                                                                        </div>
                                                                        <?php
                                                                        ...
                                                                        <select name="warehouse_from[]" id="warehouse_from"
                                                                            ...
                                                                            <option value="all" <?php echo e(in_array("all", $warehouse_from) ? 'selected' : ''); ?>>All</option>
                                                                            ...
                                                                            <option value="<?php echo e($row->id); ?>" <?php echo e(in_array($row->id, $warehouse_from) ? 'selected' : ''); ?>><?php echo e($row->name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <select name="warehouse_to" id="warehouse_to"
                                                                                ...
                                                                                <option value="<?php echo e($row->id); ?>"
                                                                                    <?php echo e($Cusomter->warehouse_to == $row->id ? 'selected' : ''); ?>>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="importProducts___BV_modal_body_" class="modal-body">
                <form action="<?php echo e(url('sales/uploadCreditCustomer')); ?>" method="post"
                    ...
                    <div class="row">
                        <div class="mb-3 col-sm-12 col-md-12">
                            <fieldset class="form-group" id="__BVID__194">
                                <div>
                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                    <input type="hidden" name="company_id" id="company_id" value="<?php echo e($m); ?>" />
