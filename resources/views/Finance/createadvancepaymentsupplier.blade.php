...
@section('content')
        ...
        <div class="dp_sdw">
            <div class="panel">
                <div class="panel-body">
                    <div class="headquid">
                        <h2 class="subHeadingLabelClass">Create Advance Payment Supplier</h2>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row">
                                        <?php echo Form::open(array('url' => 'finance/insertadvancepaymentsupplier?m=' . $m . '', 'id' => 'chartofaccountForm'));?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select class="form-control select2 requiredField" name="supplier_id"
                                                    id="supplier_id">
                                                    <option value="">Select Supplier</option>
                                                    @foreach(CommonHelper::get_supplier() as $key => $y)
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidee">
                                                <label> Banks </label>
                                                <!-- @php
                                                    $bank = CommonHelper::get_accounts_by_parent_code('1-2-7');
                                                @endphp -->
                                                 @php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidee">
                                                ...
                                                <!-- <select style="width: 100%" class="form-control" name="cheque[]" id="cheque"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 rc_amount">
                                                <label for="acc_name">Received Account </label>
                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                <select class="form-control select2" name="account_recieve_id"
    ...
    <script>
        ...
        function calculateTotalAmount() {
            ...
            $('#amount').val(total).trigger('keyup');
        }
        ...
        function hide_unhide() {
            ...
            if (pay_mode == '2' || pay_mode == '3') {
                ...
                if (pay_mode == '2') {
                    $('#account_recieve_id').val('1235').trigger('change');
                } else if (pay_mode == '3') {
                    $('#account_recieve_id').val('').trigger('change');
                }
            } else {
