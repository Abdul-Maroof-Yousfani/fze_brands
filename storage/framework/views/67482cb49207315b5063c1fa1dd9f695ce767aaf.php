...
<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(asset('assets\js\dataTables\jquery.dataTables.js')); ?>"></script>
    <script src="<?php echo e(asset('assets\js\dataTables\dataTables.bootstrap.js')); ?>"></script>
    <script type="text/javascript">
        $(function(){
            ...
            $('#tableData').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(url('finance/bank')); ?>",
                columns: [                
