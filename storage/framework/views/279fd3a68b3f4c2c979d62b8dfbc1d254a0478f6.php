...
if((!empty($Invoice))):
?>
<table class="table table-bordered sf-table-list AutoCounter table<?php echo e($main_count); ?>" id="export_table_to_excel_<?php echo $main_count?>">
    <thead>
    ...
    <?php $__currentLoopData = $Invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr  <?php if($rema==0): ?> style="background-color: #bdefbd" <?php endif; ?> title="<?php echo e($row->id); ?>" id="<?php echo e($row->id); ?>">
            ...
            <td title="<?php echo e($row->id); ?>" class="text-center"><?php echo e('`'.CommonHelper::changeDateFormat($row->due_date)); ?></td>

            <?php

            $inv=$data->total+$get_freight; ?>

            <td class="text-right"><?php echo e(number_format($inv,2)); ?></td>
            <td class="text-right"><?php echo e(number_format($return_amount,2)); ?> <?php $total_return+=$return_amount; ?></td>
            <?php
            $rema=$data->total+$get_freight-$return_amount-$rece;?>
            <td class="text-right"><?php echo e(number_format($rece,2)); ?></td>
            <td class="text-right"><?php echo e(number_format($rema,2)); ?></td>
    ...
    <tr>
        ...
        <td class="text-right" colspan="1" style="font-size: 20px;color: white"><?php echo e(number_format($total,2)); ?><?php $totalEnd+=$total;?></td>
        <td class="text-right" colspan="1" style="font-size: 20px;color: white"><?php echo e(number_format($total_return,2)); ?><?php $total_return_end+=$total_return;?></td>
        <td class="text-right" colspan="1" style="font-size: 20px;"><?php echo e(number_format($received,2)); ?><?php $receivedEnd+=$received;?></td>
        <td class="text-right <?php if ($remaining==0): ?>  hidee<?php echo e($main_count); ?><?php endif ?>" colspan="2" style="font-size: 20px;"><?php echo e(number_format($remaining,2)); ?><?php $remainingEnd+=$remaining;?></td>

        <input type="hidden" value="<?php echo e($remaining); ?>" class="val" id="<?php echo e($main_count); ?>"/>
    </tr>
    <tr>
        <td colspan="10">
...
<table class="table table-bordered sf-table-list GrandTotal" id="export_table_to_excel_<?php echo $main_count?>">
    ...
    <tbody>
        <tr>
            ...
            <td class="text-right" colspan="1" style="font-size: 20px;color: white"><?php echo e(number_format($totalEnd,2)); ?></td>
            <td class="text-right" colspan="1" style="font-size: 20px;"><?php echo e(number_format($total_return_end,2)); ?></td>
            <td class="text-right" colspan="1" style="font-size: 20px;"><?php echo e(number_format($receivedEnd,2)); ?></td>
            <td class="text-right" colspan="2" style="font-size: 20px;"><?php echo e(number_format($remainingEnd,2)); ?></td>
        </tr>
    </tbody>
</table>
<?php //Form::close(); ?>
