                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  account_id">
                                        ...
                                        <select  class="form-control select2" name="parent_cost_center" id="parent_cost_center">
                                            ...
                                            <?php $__currentLoopData = $cost_center; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($y->code); ?>"><?php echo e($y->code .' ---- '. $y->name); ?></option>
