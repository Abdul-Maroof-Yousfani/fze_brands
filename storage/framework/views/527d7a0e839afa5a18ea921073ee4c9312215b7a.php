                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <?php
                                                    $id = request()->id;
                                                ?>
                                                <form action="<?php echo e(url('purchase/editSubItemForm/' . $id . '?m='.$m.'')); ?>" method="POST" id="editSubitemForm">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" autofocus name="CategoryId" id="CategoryId"
                                                                ...
                                                                <?php $__currentLoopData = CommonHelper::get_category()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($y->id); ?>" <?php echo e($y->id == $subitem->main_ic_id ? "selected" : ""); ?>><?php echo e($y->main_ic); ?></option>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" autofocus name="principal_group" id="principal_group"
                                                                ...
                                                                <?php $__currentLoopData = App\Helpers\CommonHelper::get_all_principal_groups(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $principal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                                    <option value="<?php echo e($principal->id); ?>" <?php echo e($principal->id == $subitem->principal_group_id ? "selected" : ""); ?>><?php echo e($principal->products_principal_group); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" autofocus name="brand" id="brand"
                                                                ...
                                                                <option value="<?php echo e($row->id); ?>" <?php echo e($row->id == $subitem->brand_id ? "selected" : ""); ?>><?php echo e($row->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input style="width:100% !important;" type="text" name="sys_code" id="sys_code"
                                                                value="<?php echo e($sys_code); ?>" class="form-control" readonly />
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <span class="rflabelsteric"></span>
                                                            <input style="width:100% !important;" type="text" name="sku" id="sku" value="<?php echo e($subitem->sku_code); ?>"
                                                                class="form-control" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input  style="width:100% !important;" type="text" name="product_name" id="product_name"
                                                                value="<?php echo e($subitem->product_name); ?>" class="form-control" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Product Description :</label>
                                                            <span class="rflabelsteric"></span>
                                                            <input style="width:100% !important;" type="text" name="product_description"
                                                                id="product_description" value="<?php echo e($subitem->product_description); ?>" class="form-control" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="uom_id" id="uom_id"
                                                                ...
                                                                <?php $__currentLoopData = $uom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($i->id); ?>" <?php echo e($i->id == $subitem->uom ? "selected" : ""); ?>><?php echo e($i->uom_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">  
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Packing :</label>
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->packing); ?>" class="form-control text-right requiredField"
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input style="width:100% !important;" type="text" name="product_barcode" id="product_barcode"
                                                                class="form-control" value="<?php echo e($subitem->product_barcode); ?>" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hide">
                                                            ...
                                                            <select style="width: 100%" name="maintain" id="maintain"
                                                                ...
                                                                <?php $__currentLoopData = CommonHelper::get_all_demand_type(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($row->id); ?>" ><?php echo e(ucwords($row->name)); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="group_id" id="group_id"
                                                                ...
                                                                <?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($i->id); ?>" <?php echo e($i->id == $subitem->group_id ? "selected" : ""); ?>><?php echo e($i->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="product_classification_id"
                                                                ...
                                                                <?php $__currentLoopData = $product_classification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($i->id); ?>" <?php echo e($i->id == $subitem->product_classification_id ? "selected" : ""); ?>><?php echo e($i->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select  style="width:100% !important;" name="product_type_id" id="product_type_id"
                                                                ...
                                                                <?php $__currentLoopData = $product_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($i->product_type_id); ?>" <?php echo e($i->product_type_id == $subitem->product_type_id ? "selected" : ""); ?>><?php echo e($i->type); ?>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="product_trend_id" id="product_trend_id"
                                                                ...
                                                                <?php $__currentLoopData = $product_trend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($i->id); ?>" <?php echo e($i->id == $subitem->product_trend_id ? "selected" : ""); ?>><?php echo e($i->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input style="width:100% !important;" type="text" name="purchase_price" id="purchase_price"
                                                                value="<?php echo e($subitem->purchase_price); ?>" class="form-control" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Sale Price :</label>
                                                            <span class="rflabelsteric"></span>
                                                            <input style="width:100% !important;" type="text" name="sale_price" id="sale_price" value="<?php echo e($subitem->sale_price); ?>"
                                                                class="form-control" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>MRP Price :</label>
                                                            <span class="rflabelsteric"></span>
                                                            <input style="width:100% !important;" type="text" name="mrp_price" id="mrp_price" value="<?php echo e($subitem->mrp_price); ?>"
                                                                class="form-control" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Tax Applied :</label><br>
                                                            <span class="rflabelsteric"></span>
                                                            <input  type="checkbox" id="tax_applied" <?php echo e($subitem->is_tax_apply == 1 ? "checked" : ""); ?> name="tax_applied"value="1">

                                                            <label for="tax_applied"> Yes </label>
                                                            <input type="checkbox" id="tax_applied" <?php echo e($subitem->is_tax_apply == 0 ? "checked" : ""); ?> name="tax_applied"value="0">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="tax_type_id" id="tax_type_id"
                                                                ...
                                                                <?php $__currentLoopData = $tax_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($i->id); ?>" <?php echo e($i->id == $subitem->tax_type_id ? "selected" : ""); ?>><?php echo e($i->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input style="width:100% !important;" type="text" name="tax_applied_on" id="tax_applied_on"
                                                                class="form-control" value="<?php echo e($subitem->tax_applied_on); ?>" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Tax Policy :</label>
                                                            <span class="rflabelsteric"></span>
                                                            <input style="width:100% !important;" type="text" name="tax_policy" id="tax_policy" value="<?php echo e($subitem->tax_policy); ?>"
                                                                class="form-control" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Tax :</label>
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->tax); ?>" class="form-control text-right requiredField"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <!-- <span class="rflabelsteric"><strong>*</strong></span> -->
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->flat_discount); ?>" class="form-control text-right" type="number"
                                                                name="discount" id="discount">
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Min Qty :</label>
                                                            <!-- <span class="rflabelsteric"><strong>*</strong></span> -->
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->min_qty); ?>" class="form-control text-right" type="number"
                                                                name="min_qty" id="min_qty">
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Max Qty :</label>
                                                            <!-- <span class="rflabelsteric"><strong>*</strong></span> -->
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->max_qty); ?>" class="form-control text-right" type="number"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <!-- <span class="rflabelsteric"><strong>*</strong></span> -->
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->locality); ?>" class="form-control text-right" type="text"
                                                                name="locality" id="locality">
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Origin :</label>
                                                            <!-- <span class="rflabelsteric"><strong>*</strong></span> -->
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->origin); ?>" class="form-control text-right" type="text" name="origin"
                                                                id="origin">
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Color :</label>
                                                            <!-- <span class="rflabelsteric"><strong>*</strong></span> -->
                                                            <input style="width:100% !important;" value="<?php echo e($subitem->color); ?>" class="form-control text-right" type="text" name="color"
                                                                id="color">
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input 
                                                                ...
                                                                id="hs_code_id" 
                                                                class="form-control" 
                                                                value="<?php echo e($subitem->hs_code); ?>" 
                                                                placeholder="Enter HS Code">

                                                            <!-- <select style="width:100% !important;" name="hs_code_id" id="hs_code_id"
                                                                class="form-control select2">
                                                                                                                     >
                                                                <option value="<?php echo e($subitem->hs_code); ?>"><?php echo e($subitem->hs_code); ?></option> -->

                                                                <!-- <?php $__currentLoopData = ImportHelper::getAllHsCode(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($i->id); ?>" <?php echo e($i->id == $subitem->hs_code_id ? "selected" : ""); ?>><?php echo e($i->hs_code); ?></option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="product_status" class="form-control text-right">
                                                                ...
                                                                <option value="active" <?php echo e($subitem->status == 1 ? "selected" : ""); ?>>Active</option>
                                                                <option value="inactive" <?php echo e($subitem->status == 0 ? "selected" : ""); ?>>Inactive</option>
                                                            </select>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="is_expiry_required" class="form-control">
                                                                <option value="1" <?php echo e($subitem->is_expiry_required == 1 ? "selected" : ""); ?>>Yes</option>
                                                                <option <?php echo e($subitem->is_expiry_required == 0 ? "selected" : ""); ?> value="0">No</option>
                                                            </select>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="is_barcode_scanning" class="form-control">
                                                                <option value="1" <?php echo e($subitem->is_barcode_scanning == 1 ? "selected" : ""); ?>>Yes</option>
                                                                <option <?php echo e($subitem->is_barcode_scanning == 0 ? "selected" : ""); ?> value="0">No</option>
                                                            </select>
                                                        ...
                                                        <tbody id="append_bundle">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input step="any" type="number"
                                                                        ...
                                                                        name="closing_stock[]"
                                                                        id="closing_stock<?php echo e($counter); ?>" /> </td>
                                                                <td><input step="any" type="number"
                                                                        class="form-control requiredField" value="0"
                                                                        name="closing_val[]" id="closing_val<?php echo e($counter); ?>" />
                                                                </td>
                                                            </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    if (category) {
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#SubCategoryId').val('<?php echo e($subitem->sub_category_id); ?>').trigger('change');
            }
        });
    }
