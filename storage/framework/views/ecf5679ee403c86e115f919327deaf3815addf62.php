...
<table class="table table-bordered sf-table-list" >
    ...
    <tr class="text-center">
        ...
        <td><?php echo e($row->gi_no); ?></td>
        <td><?php echo e(CommonHelper::changeDateFormat($row->gi_date)); ?></td>
        <?php    $total_return=0;  $si_no=$row->gi_no;?>
        <td><?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <?php $dn_nos[]=$row->gd_no ?>  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
        <td><?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e(CommonHelper::changeDateFormat($row->gd_date)); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
        <td>
            <?php
        ...
        <td <?php if($on_si!=$on_dn): ?> style="background-color: red" <?php endif; ?>><?php echo e(number_format($on_si,2)); ?></td>
        ...
        <td> <?php echo e(number_format($pl_amount,2)); ?></td>
        <td><?php echo e(number_format($balance,2)); ?></td>
        <?php $status= $on_dn - $total_return - $on_si  ?>
        <td><?php if($status!=0): ?> wrong <?php echo e($status); ?> <?php endif; ?></td>


        <td><?php if($status!=0): ?> <button id="<?php echo e($si_no); ?>" onclick="update('<?php echo e($si_no); ?>' , <?php echo e($dn_actual); ?>)" type="button" class="btn btn-success">Update</button> <?php endif; ?></td>
    ...
    <tr style="font-weight: bold" class="text-center">
        ...
        <td><?php echo e(number_format($total_on_dn,2)); ?></td>
        <td><?php echo e(number_format($return_total,2)); ?></td>
        <td><?php echo e(number_format($total_on_si,2)); ?></td>
        <td><?php echo e(number_format($total_gross,2)); ?></td>
        <td><?php echo e(number_format($total_cogs,2)); ?></td>
    </tr>
    </tbody>
    </table>
...
<script>
    function  update(si_no,value)
    {
        ...
        $.ajax({
            url: '<?php echo e(url('sdc/update_cost')); ?>',
            type: "GET",
