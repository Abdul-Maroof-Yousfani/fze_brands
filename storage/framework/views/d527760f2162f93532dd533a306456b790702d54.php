            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="display: none;">
                        <?php echo $__env->make('Finance.'.$accType.'financeMenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <select class="form-control requiredField" name="account_id" id="account_id" onchange="">
                                                        ...
                                                        <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($y->id.','.$y->type); ?>" <?php if($AccId == $y->id):echo "selected";endif;?>><?php echo e($y->code .' ---- '. $y->name); ?></option>
