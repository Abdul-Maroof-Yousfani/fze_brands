                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <select onchange="get_nature_type()" name="account_head"
                                                        ...
                                                        <option <?php if($y->code=='2-2-1'): ?> selected <?php endif; ?>
                                                            value="<?php echo e($y->code); ?>"><?php echo e($y->code .' ---- '. $y->name); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <select name="country" id="country"
                                                                        ...
                                                                        <option value="<?php echo e($y->id); ?>"><?php echo e($y->name); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select name="category[]" id="category"
                                                                ...
                                                                <option value="<?php echo e($val->id); ?>"><?php echo e($val->main_ic); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div id="importProducts___BV_modal_body_" class="modal-body">
                    <form action="<?php echo e(url('pad/uploadSupplier')); ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
