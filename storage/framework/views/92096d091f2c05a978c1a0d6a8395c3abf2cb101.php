                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <?php
                            ...
                            $counter2 = 1;
                                ...
                                {?>
                                    <option <?php if(Request::segment(3) == $value2->department_id): echo 'selected'; endif; ?> value="<?php echo e($value2->department_id); ?>">
                                        <?php echo e(HrHelper::getMasterTableValueById($value->id,'department','department_name',$value2->department_id)); ?>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="job-list">
                                                <div class="thumb">
                                                    <a href="<?php echo e(url('visitor/ViewandApplyDetail/'.$row1->id."/".$row3->id)); ?>">
                                                        <img height="100" width="100"src="<?php echo e(URL::asset('assets/img/zamzamalogo.png ')); ?>" alt="Company">
                                                    </a>
                                                </div>
                                                <div class="job-list-content">
                                                    <h4><a href="<?php echo e(url('visitor/ViewandApplyDetail/'.$row1->id."/".$row3->id)); ?>" style="color:black;"><?= $row3->job_title ?></a>
                                                    ...
                                                    <div class="job-tag">
                                                        ...
                                                        <div class="pull-right">
                                                            <a href="<?php echo e(url('visitor/ViewandApplyDetail/'.$row1->id."/".$row3->id)); ?>"  class="btn btn-primary btn-sm">More Detail</a>
