...
@section('content')
                        ...
                        <div class="panel">
                            ...
                            <div class="row" style="margin-top:10px ;display:none">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" style="margin: 5px 0px 0px px;" onclick="LcAndLgAgainstPo();">Submit</button>
                                    </div>
                                </div>
                            </div>
                        <div class="panel">
    ...
    $(document).ready(function(){
         ...
         function LcAndLgAgainstPo()
        {
            ...
            $.ajax({
                url: '<?php echo url('/')?>/import/LcAndLgAgainstPo/',
                type: 'Get',
                data: {
                        rate_date:rate_date,
                        to_date:to_date
