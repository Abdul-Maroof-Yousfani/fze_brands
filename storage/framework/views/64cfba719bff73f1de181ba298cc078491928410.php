...
<div id="mySidenav" class="sidenavnr">
    <div class="logo_wrp">
        <a href="<?php echo e(route('dClient')); ?>">
          <img class="logo_m" src="<?php echo e(url('/logoo.png')); ?>">
        </a>
       </div>
<?php if(Session::get('run_company') != null): ?>
    ...
    $count = 1;
?>
       <?php $__currentLoopData = $main_modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(in_array($row,$main_modules)): ?>
                    <?php
        ...
        <div class="headerwrap">
           <div class="nav navbar-nav hide">
              <ul class=" tmenu-list d">
                 ...
                 <!-- <li>
                     <a class="btn btn-primary" href="<?php echo e(route('dClient')); ?>">
                     Dashboard
                 </a>
                 </li>
                 <li>
                     <a class="btn btn-primary" href="<?php echo e(route('production_dashboard')); ?>">
           ...
           <div class="nav navbar-nav">
                <ul class=" tmenu-list d">
                    ...
                    <li>
                        <a class="btn btn-primary" href="<?php echo e(route('fClient')); ?>">
            ...
            <select style="margin-left: 30px; margin-right: 30px;" class="form-control select2" onchange="if(this.value) window.location.href='<?php echo e(url('set_user_db_id')); ?>?company=' + this.value">
    <option value="">Select Company</option>
    <?php $__currentLoopData = \App\Helpers\CommonHelper::get_users_companies(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($company->id); ?>" <?php echo e(\App\Helpers\CommonHelper::get_current_company_id() == $company->id ? 'selected' : ''); ?>>
           ...
           <ul class='ctn-list'>
              ...
              <li>
                 <div class="tim d">
                    ...
                    <h3 id="live-time"><?php echo e(date('h:i:s')); ?><span><?php echo e(date('A')); ?></span></h3>
                 </div>
              </li>
              ...
              <li class="dropdown user-name-drop">
                 ...
                 <div class="account-information dropdown-menu">
                    ...
                    <div class="account-footer">
                       <a href="<?php echo e(url('/users/editUserProfile')); ?>" class="btn  contact_support btn btn-primary">
                      Edit</a>
                          <form action="<?php echo e(route('logout')); ?>" method="POST" style="display: inline-block; float: right; margin-right: 15px;">
