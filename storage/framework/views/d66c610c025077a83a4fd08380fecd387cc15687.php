                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="item_id">
                                ...
                                <?php $__currentLoopData = \App\Helpers\CommonHelper::get_all_items(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subitem->id); ?>">(<?php echo e($subitem->sku_code); ?>) <?php echo e($subitem->product_name); ?></option>
    ...
    <script !src="">
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('Inventory Sheet Report <?php echo date('d-m-Y'); ?>.' + (type || 'xlsx')));
        }
    </script>
    <script>
        $(".select2").select2();
