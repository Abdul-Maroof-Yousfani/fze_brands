...
?>
<tr <?php if($operational==0): ?> style="background-color: lightcoral" <?php endif; ?> class="tr<?php echo $row1->id ?>" id="tr<?php echo $row1->id ?>" title="<?php echo $row1->id ?>" id="1row<?php echo $counter ?>">
    ...
    <td class="text-center"><?php echo e(number_format($received_data->net_amount,2)); ?></td>
    <td class="text-center"><?php echo e(number_format($received_data->tax_amount,2)); ?></td>
    ...
    <td class="text-center hidden-print">
        ...
        <?php endif;?>
            ...
            <?php endif;?>
            <a onclick="change_colour('<?php echo e($row1->id); ?>')" target="_blank" href="<?php echo url('sdc/viewReceiptVoucherPrint?id='.$row1->id.'&&m='.$m)?>" class="btn btn-xs btn-success">Print</a>
    </td>
</tr>
<?php
}
