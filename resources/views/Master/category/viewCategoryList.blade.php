    ...
    <table class="userlittab table table-bordered table-hover tableFixHead" id="exportList">
        ...
        @foreach ($data as $key => $value)
            <tr>
                ...
                <td>{{ $value->category_abbreviation }}</td>
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li onclick="showMasterEditModal('editCategoryForm','{{ $value->id }}','Edit Category Form','')">
                                <a class="edit-modal">Edit</a>
                            </li>
                            <li onclick="deleteTableRecord('{{ $value->id }}','assets_category')">
