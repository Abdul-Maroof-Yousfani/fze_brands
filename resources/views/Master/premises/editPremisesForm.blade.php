<form id="submit2" action="{{ route('edit-premises') }}" method="post">
    <div class="mt">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <input type="text" class="form-control" name="premises_name" id="premises_name" value="{{ $data->premises_name }}" required />
            </div>
        </div>
    </div>
    <div class="row">&nbsp;</div>
