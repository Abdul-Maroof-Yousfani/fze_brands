                                        ...
                                        <div class="row">
                                            ...
                                            <tbody id="data">
                                                <?php
                                                   $i =1; 
                                                ?>
                                                <?php $__currentLoopData = $company_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($i); ?></td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="<?php echo e(route('editCompanyGroup',$location->id)); ?>"  class="btn btn-sm btn-warning "><i class="fa fa-pencil" aria-hidden="true"></i>  Edit</a>
