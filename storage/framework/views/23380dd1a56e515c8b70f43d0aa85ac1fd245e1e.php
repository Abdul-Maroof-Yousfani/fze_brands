                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <div class="row">
                                                <form action="<?php echo e(url('pad/addSubItemDetail?m='.$m.'')); ?>" method="POST" id="addSubItemDetail">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" autofocus name="CategoryId" id="CategoryId"
                                                                ...
                                                                <option value="<?php echo e($y->id); ?>"><?php echo e($y->main_ic); ?></option>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" autofocus name="principal_group" id="principal_group"
                                                                ...
                                                                <?php $__currentLoopData = App\Helpers\CommonHelper::get_all_principal_groups(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $principal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                                    <option value="<?php echo e($principal->id); ?>"><?php echo e($principal->products_principal_group); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="uom_id" id="uom_id"
                                                                ...
                                                                <option value="<?php echo e($i->id); ?>"><?php echo e($i->uom_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select  style="width:100% !important;" name="product_type_id" id="product_type_id"
                                                                ...
                                                                <option value="<?php echo e($i->product_type_id); ?>"><?php echo e($i->type); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <select style="width:100% !important;" name="hs_code_id" id="hs_code_id"
                                                                ...
                                                                <option value="<?php echo e($i->id); ?>"><?php echo e($i->hs_code); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="importProducts___BV_modal_body_" class="modal-body">
                <form action="<?php echo e(url('sales/uploadProduct')); ?>" method="post" id="csv" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                                ...
                                <!-- <a class="btn btn-info btn-sm btn-block" href="<?php echo e(asset("product_uploader_example.xlsx")); ?>">Download example</a> -->
<a href="<?php echo e(asset('product_uploader_example.csv')); ?>" download>Download</a>
    ...
    if (category) {
        $.ajax({
            // url: '/pdc/get_sub_category_by_id',
              url: "<?php echo e(route('get_sub_category_by_id')); ?>",
            type: 'Get',
            data: {
                category: category
            },
