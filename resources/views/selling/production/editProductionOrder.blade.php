    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp; view Production Order</h3>
                </li>
            </ul>
        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel">
                           ...
                           <h2 class="subHeadingLabelClass">edit Production Order</h2>
                                ...
                                <form action="{{route('updateProductionOrder')}}" method="post">
                                            ...
                                            <div class="col-md-12 padt">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        ...
                                                        <select onchange="work_change(this)" name="sales_order_id" id="sales_order_id" class="form-control">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" step="any" name="pipe_outer" class="form-control" id="pipe_outer" style="" value="{{$ProductionPlane->pipe_outer}}">
                                                       
                                                    </div> 
                                                    <div class="col-md-12">
                                                        <label for="">Printing on pipe</label><br>
                                                        <textarea name="printing_on_pipe" class="form-control" id="printing_on_pipe" style="">{{$ProductionPlane->printing_on_pipe}}</textarea>
                                                       
                                                    </div> 
                                                    <div class="col-md-12">
                                                        <label for="">Special Instructions</label><br>
                                                        <textarea name="special_instructions" class="form-control" id="special_instructions" style="">{{$ProductionPlane->special_instructions}}</textarea>
