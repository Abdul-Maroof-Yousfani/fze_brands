...
<table id="EmpExitInterviewList" class="table table-bordered table-responsive">
    ...
    <thead>
        <th colspan="12" class="text-center"><h4>From : <?php echo e(CommonHelper::changeDateFormat($from).' TO: '.CommonHelper::changeDateFormat($to)); ?></h4></th>
    </thead>
    <thead>
    ...
    <tbody id="">
       ...
       $remianig_amount=$open_amount+$in_amount-$out_amount;
        ...
        ?>
        <tr title="<?php echo e($row->sub_item_id); ?>">
            <td><?php echo e($count++); ?></td>
            <td><small><?php echo e($row->product_name); ?></small></td>
            <td><small><?php echo e(number_format($open_qty,2)); ?></small></td>
            <td><small><?php echo e(number_format($open_amount,2)); ?></small></td>
            <td><small><?php echo e(number_format($in_qty,2)); ?></small></td>
            <td><small><?php echo e(number_format($in_amount,2)); ?></small></td>
            <td><small><?php echo e(number_format($out_qty,2)); ?></small></td>
            <td><small><?php echo e(number_format($out_amount,2)); ?></small></td>
        ...
        $incomplete_val=0;
            ...
            <td><?php if(!empty($incomplete_dn)): ?> <?php echo e(number_format($incomplete_dn,2)); ?>  <?php $total_incomplete_dn+=$incomplete_dn; ?> <?php endif; ?></td>
            ...
            <td style="font-weight: bold"><small><?php echo e(number_format($remianig_qty,2)); ?></small></td>
            <td title="" <?php if($remianig_amount<0): ?> style="color: red" <?php endif; ?> style="font-weight: bold"><small><?php echo e(number_format($remianig_amount,2)); ?></small></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="1"><?php echo e(number_format($total_open_qty,2)); ?></td>
            <td colspan="1"><?php echo e(number_format($total_open_amount,2)); ?></td>
            <td colspan="1"><?php echo e(number_format($total_in_qty,2)); ?></td>
            <td colspan="1"><?php echo e(number_format($total_in_amount,2)); ?></td>

            <td colspan="1"><?php echo e(number_format($tot_out_qty,2)); ?></td>
            <td colspan="1"><?php echo e(number_format($tot_out_amount,2)); ?></td>
            <td colspan="1"><?php echo e(number_format($total_incomplete_dn,2)); ?></td>
            <td colspan="1"><?php echo e(number_format($total_purchase_side,2)); ?></td>

            <td colspan="1"><?php echo e(number_format($cl_qty,2)); ?></td>
            <td colspan="1"><?php echo e(number_format($cl_amount+$total_incomplete_dn-$total_purchase_side,2)); ?></td>
        </tr>
    </tbody>
</table>


<p>Purchase: <?php echo e(ReuseableCode::stock_type_amount($from,$to,1)); ?></p>
<p>Purchase Return: <?php echo e(ReuseableCode::stock_type_amount($from,$to,2)); ?></p>
<p>Sales Return: <?php echo e(ReuseableCode::stock_type_amount($from,$to,6)); ?></p>
