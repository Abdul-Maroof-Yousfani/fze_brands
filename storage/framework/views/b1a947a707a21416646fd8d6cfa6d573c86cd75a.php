        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
            ...
            <?php if($row->pv_status==1): ?>
                <?php if($approved == true || $approvedC == true):?>
                    <button onclick="approve_voucher('new_pv','new_pv_data','pv_status','pv_date','pv_no','2','<?php echo e($row->pv_no); ?>', 'Bank Payment Voucher')" type="button" class="btn btn-primary btn-xs">Approve</button>
                <?php endif;?>
            <?php endif; ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="printBankPaymentVoucherDetail">
            <div class="well" >
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div>
                                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                                        <tbody>
                                        <tr>
                                            <td  style="width:40%;background:#f9f9f9 !important;">     <?php if($row->payment_type==1): ?>BPV No. <?php else: ?> CPV No. <?php endif; ?></td>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h3 style="text-align: center; font-weight:bold !important;"><?php if($row->payment_type==1): ?> Bank Payment Voucher <?php else: ?> Cash Payment Voucher <?php endif; ?></h3>
                            </div>
                        </div>
                                ...
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background:#f9f9f9 !important;"><?php  echo  $acc_code.'---'.$acc_name
                                            ...
                                            ?></td>
                                        <td style="background:#f9f9f9 !important;" class="hide"><?php echo e(CommonHelper::get_sub_dept_name($row2->sub_department_id)); ?></td>
                                ...
                                <div class="container-fluid">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">
                                            ...
                                            <b>   <p><?php echo e(strtoupper(optional($row)->verified_by)); ?></b>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">
