                            ...
                            <div id="printDemandVoucherList">
                                <div class="row">
                                                        ...
                                                        <div class="table-responsive" >
                                                            <table class="table table-bordered sf-table-list" id="issuanceVoucherList">
                                                                ...
                                                                <tr class="text-center" id="RemoveTr<?php echo $row->id?>">
                                                                    ...
                                                                    <td class="<?php echo e($row->id); ?>"><?php if($row->tr_status==1): ?> Unaccept <?php else: ?> Accept <?php endif; ?></td>
                                                                    <td>
                                                                        <?php if($view==true): ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
                                        <img src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')->size(200)->generate('View Purchase Demand Voucher List')); ?> ">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            if (confirm('Are You Sure ? You want to delete this recored...!')) {
                ...
                $.ajax({
                  //  url: '/pdc/deleteStockTransfer',
                      url: "<?php echo e(route('pdc.deleteStockTransfer')); ?>",
                    type: 'Get',
