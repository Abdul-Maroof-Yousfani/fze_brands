...
<div class="row" id="printReport">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="contr">
                                ...
                                <p style="margin-top:-12px;">
                                    ...
                                    Pakistan<br>
                                    <?php echo e($customer_data->phone_1); ?>

                                    N.T.N #: <?php echo e(isset($customer_data->cnic_ntn) ? $customer_data->cnic_ntn :'-'); ?><br>
                                    S.T #: <?php echo e(isset($customer_data->strn) ? $customer_data->strn :'-'); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div class="term">
                                          ...
                                          <p>Branch: <?php echo e(CommonHelper::getWarehouseName($delivery_note->id)); ?></p>
                            ...
                            <div id="actual">
                                    <div class="table-responsive">
                                        <table class="table sale_older_tab userlittab table table-bordered sf-table-list sale-list">
                                            ...
                                            <tbody id="data">
                                                <?php $count=1; ?>
                                                <?php $__currentLoopData = $delivery_note_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale_order_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $saleOrderDetail = CommonHelper::get_item_detials($sale_order_item->so_data_id);
                                                ...
                                                ?>
                                                <tr>
                                                    <td  style="text-align: center !important;"><?php echo e($count++); ?></td>
                                                    <td><strong><?php echo e(CommonHelper::get_product_sku($sale_order_item->item_id)); ?>-<?php echo e(CommonHelper::get_product_name($sale_order_item->item_id)); ?></strong></td>
                                                    <!-- <td  style="text-align: center !important;" class="wsale2"><?php echo e(CommonHelper::get_uom($sale_order_item->item_id)); ?></td> -->
                                                    <td  style="text-align: center !important;" class="wsale2"><p><?php echo e(number_format($sale_order_item->qty)); ?></p></td>
                                                    <td  style="text-align: center !important;" class="wsale2"><p><?php echo e($productbarcode ?? "--"); ?></p></td>
                                                    ...
                                                    <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->sub_total,0)); ?></td>
                                                    <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->discount_percent_1,0)); ?>%</td>
                                                    <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->discount_amount_1,0)); ?></td>
                                                    <td  style="text-align: center !important;"><?php echo e(number_format($sale_order_item->tax)); ?></td>
                                                    <td  style="text-align: center !important;"><?php echo e(number_format($sale_order_item->tax_amount,0)); ?></td>
                                                    <td style="text-align: center !important;"><?php echo e(number_format($saleOrderDetail->amount,0)); ?></td>
                                                </tr>
                                                ...
                                                <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format( round($total_gross_amount),0)); ?></p></th>
                                                <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"></th>
                                                <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format(round($total_discount_amount), 0)); ?></p></th>
                                                    <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"></th>
                                                    <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format(round($total_tax),0)); ?></p></th>
                                                    <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;" id="total-fac"><?php echo e(number_format(round($total_amount_after_tax),0)); ?></p></th>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="totals3">
                                        <div class="psds">
                                            ...
                                            <p id="sale_taxes_amount_rate" style="margin:0 !important;padding:0 !important;font-size:13px !important;"><?php echo e(number_format(round($sale_order->sale_taxes_amount_rate),0)); ?></p>
                                        </div>
                                        <div class="totlas">
                                            <p><strong>Total</strong></p>
                                            <p><strong><?php echo e(number_format((float)$total_amount_after_tax + (float)$sale_order->sale_taxes_amount_rate, 2)); ?></strong></p>
                                        </div>
                                    </div>
    ...
    <div class="sgnature2">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <br>
            <div class="vomp">
               <p><strong> Creation Time:<?php echo e(\Carbon\Carbon::parse($delivery_note->timestamp)->format('d-M-Y h:i A')); ?></strong></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
        <div class="padt">
            ...
            <ul class="sale-l sale-l2">
                <li>Total Qty</li>
                <li class="text-left">
                    <input name="total_qty" class="form-control form-control2" id="total_qty" value="<?php echo e($total_qty); ?>"  type="text" readonly>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
        <div class="padt">
            <ul class="sale-l sale-l2">
                <li>Gross Amount</li>
                <li class="text-left">
                <input name="total_gross_amount" id="total_gross_amount" class="form-control form-control2" value="<?php echo e($total_before_tax); ?>" type="text"readonly></li>
            </ul>
                <!-- <ul class="sale-l sale-l2">
                    <li>Total Qty</li>
            ...
            <ul class="sale-l sale-l2">
                <li>Tax Amount</li>
                <li class="text-left">
                    <input name="total_sales_tax" id="total_sales_tax" class="form-control form-control2" value="<?php echo e($total_tax); ?>" type="text"readonly>
                </li>
            </ul>
            <ul class="sale-l sale-l2">
                <li>Net Amount</li>
                <li class="text-left">
                    <input name="total_amount_after_sale_tax" id="total_amount_after_sale_tax"class="form-control form-control2"value="<?php echo e($total_after_tax); ?>"type="text"readonly>
                </li>
            </ul>
        </div>
    </div>
