...
$view = true; // Temporary bypass for demonstration, should use proper rights
$edit = true;
$export = true;
                ...
                <div class="dp_sdw">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="headquid">
                           <h2 class="subHeadingLabelClass">Vendor Debit List</h2>
                        </div>
                               
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
                              <div class="headquid">
                                  <?php echo CommonHelper::displayPrintButtonInBlade('PrintVendorDebitList', '', '1'); ?>
                                <?php if ($export == true) : ?>
                    ...
                    <div class="panel">
                        <div class="panel-body" id="PrintVendorDebitList">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="table-responsive">
                                        <table class="userlittab table table-bordered sf-table-list" id="VendorDebitListTable">
                                            <thead>
...
<script>
    ...
    function approve(el, id) {
        ...
        if(is_confirmed) {
            $.ajax({
                url: `{{ url('vendorDebitNote') }}/${id}/approve`, 
                type: "get",
                success: function(response) {
...
<script !src="">
    function ExportToExcel(type, fn, dl) {
        var elt = document.getElementById('VendorDebitListTable');
        ...
        return dl ?
            ...
            XLSX.writeFile(wb, fn || ('Vendor Debit List <?php echo date('d-m-Y') ?>.' + (type || 'xlsx')));
    }
</script>
