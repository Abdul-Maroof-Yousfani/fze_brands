                                         ...
                                         <div class="table-responsive">
                                            <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                                ...
                                                <tbody id="data">
                                                    ...
                                                    <?php $__currentLoopData = $sales_tax_invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <tr <?php if($status == 'Open'): ?>
                                                    <?php elseif($status == 'partial'): ?> style="background-color: #c9d6ec" <?php endif; ?>
                                                            title="<?php echo e($row->id); ?>" id="<?php echo e($row->id); ?>">
                                                            <td class="text-center"><?php echo e($counter++); ?></td>
                                                            <td title="<?php echo e($row->id); ?>" class="text-center">
                                                                <?php if(!empty($row->so_no)): ?>
                                                            ...
                                                            <td title="<?php echo e($row->id); ?>" class="text-center">
                                                                <?php echo e(strtoupper($row->gi_no)); ?></td>
                                                            <!-- <td>
                                                            ...
                                                            <td class="text-center"><?php echo e($row['model_terms_of_payment']); ?>
                                                            ...
                                                            <td class="text-right">
                                                                <!-- <?php echo e(number_format($data->amount + $row->sales_tax + $row->sales_tax_further + $fright, 2)); ?> -->
                                                                <?php echo e($row->total == '0.000' ? number_format($data->amount + $row->sales_tax + $row->sales_tax_further + $fright, 0) : number_format($row->total, 0)); ?>

                                                            </td>
                                                            <td><?php echo e($status); ?></td>
                                                            <td id="stat<?php echo e($row->id); ?>" class="text-center">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                                ...
                                                                                <?php if($row->si_status != 3 && (!empty($row->so_no) || empty($row->approve_user_1))): ?>
                                                                                ...
                                                                                href="<?php echo url('/'); ?>/sales/EditSalesTaxInvoice?id=<?php echo $row->id; ?>?m=<?php echo $m; ?>">Edit</a> -->
                                                                                    <a target="_blank" class="btn btn-xs btn-primary"
                                                                                        href="<?php echo e(route('edit.sales.tax.invoice', ['id' => $row->id, 'm' => $row->id])); ?>">Edit</a>
                                                                                <?php endif; ?>
