                                        ...
                                        <div class="row qout-h">
                                            ...
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                      <input type="text" class="form-control" name="store" value="{{ $credit->store }}" placeholder="Office Staff()">                                                    
                                                    </div>
                                                    </div>  
                                                </div>
                                            </div>
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                      <input type="text" class="form-control" name="delivery_man" placeholder="Jahangir Ahmed">                                                    
                                                    </div>
                                                    </div>  
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                        <select class="form-control select2" name="credit">
                                                            ...
                                                            <option value="select2">Select Credit</option>
                                                        </select>
                                                    </div>
                                                    </div>  
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                        <select class="form-control select2" name="voucher_type">
                                                            ...
                                                            <option value="select1">Allied Marketing</option>
                                                        </select>
                                                    </div>
                                                    </div>  
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-sm-8" style="padding-left: 0px;">
                                                        <select class="form-control select2" name="branch">
                                                            ...
                                                            <option value="select1">Karachi</option>
                                                        </select>
                                                    </div>
                                                    </div>  
                                                </div>
