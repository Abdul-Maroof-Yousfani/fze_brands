...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        ...
        <?php if($sales_tax_invoice->si_status == 1): ?>
            <button id="appro" class="btn btn-sm btn-success" onclick="approve('<?php echo e($sales_tax_invoice->id); ?>')"
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        <a target="_blank" href="<?php echo e(url('/sales/undertaking?id=' . $sales_tax_invoice->id)); ?>">UnderTaking A</a>
    </div>
</div>
...
<div class="row printPurchaseRequestVoucherDetail" id="printPurchaseRequestVoucherDetail">
        ...
        <div class="row">
                ...
                <div class="table-responsive" style="width:50%; float:left; ">
                    <table class="sale-list userlittab table table-bordered sf-table-list" style="border:1px solid #000;">
                        <tbody>
                            ...
                            <!-- <?php if($sales_tax_invoice->so_id != 0): ?>: -->
                            <!-- <tr>
                            ...
                            <tr>
                                <th style="border:1px solid black;" class="text-left" style="border: solid 1px;">
                                    BUYER'S NTN</th>
                                <td style="border:1px solid black;font-size: xx-small" class="text-left">
                                    <?php echo e(isset($customer_data->cnic_ntn) && $customer_data->cnic_ntn != '' ? ucwords($customer_data->cnic_ntn) : '-'); ?>
                    ...
                    <table class="sale-list userlittab table table-bordered sf-table-list sales_Tax_Invoice_data" style="border: 1px solid #000;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php echo e(\Carbon\Carbon::parse($sales_tax_invoice->gi_date)->format("d-M-Y")); ?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="border:1px solid black;" class="text-left" style="width:50%;">
                                    ...
                                    ?> -->
                                    <?php echo e(strtoupper($sales_tax_invoice->so_no)); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="contr">
                            ...
                            <p style="margin-top:-12px;">
                                ...
                                Pakistan<br> -->
                                <?php echo e($customer_data->phone_1); ?><br>
                                N.T.N #: <?php echo e($customer_data->cnic_ntn); ?><br>
                                S.T #: <?php echo e($customer_data->strn); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6  text-right">
                        <div class="contr2">
                            <h2 class="subHeadingLabelClass">Sale Invoice</h2>
                                <br>
                            <p>Document # <?php echo e($sales_tax_invoice->gi_no); ?></p>
                            <!-- <p>Doc #: 27903</p> -->
                            <p style="margin-bottom: -23px !important;">Date: <?php echo e(\Carbon\Carbon::parse($sales_tax_invoice->gi_date )->format('d-M-Y')); ?></p>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <div class="term">
                                        <p>SO Date: <?php echo e(\Carbon\Carbon::parse($sales_tax_invoice->so_date)->format("d-M-Y")); ?></p>
                                        <!-- <p>Warehouse: </p> -->
                                        
                                        <p>Payment Terms: <?php echo e($sales_order->model_terms_of_payment); ?></p>
                                        <!-- <p>Sales Rep Mobile #: 1</p> -->
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="term">
                                        <p>SO #: <?php echo e($sales_order->so_no); ?></p>
                                        <p>GDN #: <?php echo e($dn_detail->gd_no); ?></p>
                                        <p>Branch: <?php echo e($sales_order->branch); ?></p>
                                        <p>Sales Rep: <?php echo e($customer_data->SaleRep); ?> </p>
                                        <?php if(strtoupper($customer_data->display_note_invoice) == 'YES'): ?>
                                            <p>Note: <?php echo e($customer_data->strn_term); ?> </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table sale_older_tab userlittab table table-bordered sf-table-list sale-list">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $sales_tax_invoice_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><strong><?php echo e(CommonHelper::get_product_sku($row->item_id)); ?>-<?php echo e(CommonHelper::get_product_name($row->item_id)); ?></strong></td>
                                                <!-- <td style="text-align: center !important;" class="wsale2"><?php echo e(CommonHelper::get_uom($row->item_id)); ?></td> -->
                                                <td style="text-align: center !important;" class="wsale2"><p><strong><?php echo e($productbarcode ?? '--'); ?></strong></p></td>
                                                <td style="text-align: center !important;" class="wsale2"><p><?php echo e(number_format($row->qty)); ?></p></td>
                                                <td style="text-align: center !important;"><?php echo e(CommonHelper::get_product_mrp_price($row->item_id)); ?></td>
                                                <td style="text-align: center !important;"><?php echo e(number_format($row->rate, 2)); ?></td>
                                                ...
                                                <td style="text-align: center !important;"><?php echo e(number_format($row->tax, 2)); ?>%</td>
                                                <td style="text-align: center !important;"><?php echo e(number_format($row->tax_amount, 2)); ?></td>
                                        ...
                                        <?php if($AddionalExpense->count() > 0): ?>
                                            <?php $ExpCounter=1; ?>
                                            <?php $__currentLoopData = $AddionalExpense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Fil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="text-center">
                                                    <td style="text-align: center !important;" colspan="8">
                                                        ...
                                                        ?>
                                                        <strong><?php echo e(strtoupper($Accounts->name)); ?></strong>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                        <tr>
                                            ...
                                            <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"><?php echo e(number_format($total_qty, 0)); ?></th>
                                            ...
                                            <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"><p style="text-align: center !important;"><?php echo e(number_format($total_before_tax, 2)); ?></p> </th>
                                            <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"></th>
                                            <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"><?php echo e(number_format( round($total_discount_amount),0)); ?></th>
                                            <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;"> </th>
                                            <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"> <p style="text-align: center !important;"><?php echo e(number_format(round($total_tax),0)); ?></p></th>
                                            <th style="background: transparent; border-bottom: 1px solid #000 !important; padding:0px 5px !important; margin:0 !important;text-align: center !important;"> <p style="text-align: center !important;"><?php echo e(number_format( round($total_amount_after_tax),0)); ?></p> </th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fo">
                ...
                <div class="row">
                    ...
                    ?>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input type="hidden" id="total" value="<?php echo e($AmountInWordsMain); ?>">
    ...
    <div class="sgnature2">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <br>
            <div class="vomp">
                <p><strong>Creation Time :<?php echo e(\Carbon\Carbon::parse($sale_order->timestamp)->format('d-M-Y h:i A')); ?></strong></p>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        toWords(1);
        var tax = '<?php echo e($total_tax_amount); ?>';
        if (tax == 0) {
    ...
    function approve(id) {
        ...
        $.ajax({
            url: "<?php echo e(url('sales/si_approve')); ?>",
            type: 'Get',
            data: {
                id: id
            },
