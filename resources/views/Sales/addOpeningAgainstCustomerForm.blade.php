    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well_N">
                    ...
                    <div class="alert alert-danger">
                        <ul>
                            @foreach(Session::get('submit_errors') as $errorTwo)
                                <li>Customer Name => {{ $errorTwo['customer_name'] }}, Opening Amount => {{ $errorTwo['amount'] }}</li>
                            @endforeach
                        </ul>
                    </div>
                @endif
                ...
                @endif
                <form method="post" enctype="multipart/form-data" action="{{ url('/sad/import_customer_opening') }}">
                    {{ csrf_field() }}
