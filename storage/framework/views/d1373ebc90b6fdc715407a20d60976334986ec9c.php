...
<table id="data" class="table table-bordered table-responsive">
            <h4><?php echo e($category_heading); ?></h4>
            <h4><?php echo e($item_heading); ?></h4>
            <h4><?php echo e($location_heading); ?></h4>
            <h4><?php echo e($sub_item_heading); ?></h4>
            <h4><?php echo e($sub_item_des_heading); ?></h4>
...
<input type="checkbox" id="CheckUnCheck" onclick="ShowHideDetail()">
            ...
            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td class="text-center">
                    <a class="" href="<?php echo url('/') ?>/store/fullstockReportView?pageType=&&parentCode=97&&m=<?php echo $_GET['m'] ?>&&sub_item_id=<?php echo $data->sub_item_id ?>&&warehouse_id=<?php echo $data->warehouse_id ?>#SFR" target="_blank">
                        <?php echo e(CommonHelper::get_item_name($data->sub_item_id)); ?></a>
                </td>
                ...
                <td class="text-center"><?php echo e(CommonHelper::get_uom_name($uom)); ?></td>
                <td class="text-center"><?php echo e($data->pack_size); ?></td>
                <td class="text-center"><?php echo e(($data->uom2) ? CommonHelper::get_uom_name($data->uom2) : ''); ?></td>
                <td class="text-center"><?php echo e(number_format( ( $in_stock / ($data->pack_size ?? 1) ) ,2)); ?></td>
                <td class="text-center"><?php echo e(CommonHelper::get_name_warehouse($data->warehouse_id)); ?> <?php  ?></td>
                <td class="text-center ShowHideTd" style="display: none;"><?php echo e(number_format($average,2)); ?></td>
                <td class="text-center ShowHideTd" style="display: none;"><?php echo e(number_format($purchase_amount,2)); ?></td>
                <td class="text-center ShowHideTd" style="display: none;"><?php echo e(number_format($produce_qty,2)); ?></td>
        ...
        <?php echo $__env->make('Store.AjaxPages.quarintine_stock', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<script !src="">
