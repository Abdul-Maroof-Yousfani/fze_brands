                        ...
                        <div class="form-group">
                            <label class="control-label">Regions</label>
                                <select class="form-control select2" id="region_id">
                                    ...
                                    <?php $__currentLoopData = \App\Helpers\CommonHelper::get_all_territories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
