    ...
    <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
        <div class="table-responsive">
            <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                ...
                <?php $__currentLoopData = $PurchaseInvoice->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <tr <?php if($t_amount!=$net_amount): ?> <?php elseif($net_amount!=$net_amount_grn): ?> style="background-color: cornflowerblue" <?php endif; ?> id="<?php echo e($row->id); ?>">
                        ...
                        <td title="<?php echo e($row->id); ?>" class="text-center"><?php echo e(strtoupper($row->grn_no)); ?></td>
                        ...
                        <td class="text-center <?php echo e($row->id); ?>"><?php if($row->pv_status==1): ?>PENDING <?php else: ?> Approve <?php endif; ?></td>
                        <td class="text-right"><?php echo e(number_format($net_amount,2)); ?></td>
                        <td class="text-right"><?php echo e(number_format($net_amount_grn,2)); ?></td>
                ...
                <tr>
                    ...
                    <td colspan="1"><?php echo e(number_format($total,2)); ?></td>
                </tr>
                </tbody>
            </table>
        </div>
