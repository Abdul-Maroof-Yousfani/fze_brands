                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px"><select class="form-control string" id="bundle_unit" name="bundle_unit">
                                            ...
                                            <?php foreach(CommonHelper::get_all_uom() as $row): ?>
                                                <option value="<?php echo e($row->id); ?>"><?php echo e($row->uom_name); ?></option>
                                            <?php endforeach ?>
                                        </select></td>
...
<?php echo $__env->make('items_search_for_bundles', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
// onmodal
    $('#budles_dataa').on('shown.bs.modal', function (e) {
        ...
        //    $("#bundle_table").css("display", "none");
            ...
            $.ajax({
                url:'<?php echo e(url("sdc/get_bundels_data?param=")); ?>'+product_id+'&&m='+m,
