                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
									<label>JV No.</label>
									<input type="text" placeholder="Type here JV NO." name="jv_no" id="jv_no"  class="form-control" />
								</div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="userlittab table table-bordered sf-table-list" id="journalVoucherList1">
                                                                ...
                                                                onclick="checkUncheck('1chk<?php echo $counter ?>','1row<?php echo $counter ?>')"<?php endif;?>>
                                                                    ...
                                                                    <td class="text-center"><?php echo e(CommonHelper::get_credit_amount('new_jv_data', $row1->id)); ?></td>
                                                                    <td class="text-center"><?php echo FinanceHelper::changeDateFormat($row1->jv_date);?></td>
                                                                    <td class="text-center">
                                                                        <?php echo e(CommonHelper::get_branch_by_id($row1->warehouse_id)); ?>

                                                                    </td>
                                                                    <td class="text-center hide"><?php echo $Account = CommonHelper::debit_credit_amount('new_jv_data',$row1->id);?></td>
                                                                    
                                                                    <?php //die();?>
                                                                    <td class="text-center hide"><?php echo e($row1->verified_by != null ? 'Yes' : 'No'); ?></td>
                                                                    <td class="text-center status<?php echo e($row1->jv_no); ?>"><?php if($row1->jv_status == 2){echo "<span style='color:green;'>Approved</span>";} else{echo "<span style='color:red;'>Pending</span>";}?></td>
                                                                            ...
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu">
                                                                                        <li>
                                                                                            ...
                                                                                            <?php if($delete == true):?>
                                                                                            <input style="width:100%; text-align:left;" class="btn btn-xs btn-danger BtnHide<?php echo $row1->jv_no?>" type="button"
