                ...
                <div class="table-responsive">
                    <table class="userlittab table table-bordered sf-table-list" id="data-table">
                        ...
                        <tr title="<?php echo e($row->id); ?>" id="<?php echo e($row->id); ?>">
                            ...
                            <td class="text-right"><?php echo e(number_format(round($data->qty),0)); ?></td>
                            <td class="text-right"><?php echo e(number_format(round($data->amount+$row->sales_tax_amount +  $sale_taxes_amount_rate),0)); ?></td>
                            <td class="text-center">
                                  <div class="dropdown">
                        ...
                        <tr>
                            ...
                            <td class="text-right" colspan="1" style="font-size: 13px;color: #333"><strong><?php echo e(number_format($total,2)); ?></strong></td>
