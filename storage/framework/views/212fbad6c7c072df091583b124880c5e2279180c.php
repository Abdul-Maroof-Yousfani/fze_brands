...
<?php
                            ...
                            <table style="width: 100%" class="table-bordered sf-table-list AutoCounter table<?php echo e($main_count); ?>" id="export_table_to_excel_<?php echo $main_count; ?>">
                                <thead>
                                ...
                                <thead>
                                <th colspan="7" class="text-center"><h3 class="table<?php echo e($main_count); ?>"><?php echo e($row->name); ?></h3></th>
                                </thead>
                                <thead>
                              ...
                              //  whereBetween('pv_date', [$from, $to])->get();
                                ...
                                <?php $__currentLoopData = $data1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <?php if($remaining_data>0): ?>
                                        <tr title="grn_id=<?php echo e($row1->grn_id); ?>">

                                            <td class="text-center"><?php echo e($counter++); ?></td>
                                            <td class="text-center"><?php echo e($row1->pv_no); ?></td>
                                            <td class="text-center"><?php echo e(CommonHelper::changeDateFormat($row1->pv_date)); ?></td>
                                            <td class="text-right"><?php echo e(number_format($purchase_amount,2)); ?></td>
                                            <td class="text-right"><?php echo e(number_format($rerun_amount,2)); ?></td>
                                            <td class="text-right"><?php echo e(number_format($paid_amount,2)); ?></td>
                                            <td class="text-right"><?php echo e(number_format($remaining_data,2)); ?></td>
                                            <?php
                                    ...
                                    <tr style="font-size: large;font-weight: bold">
                                        ...
                                        <td class="text-right" colspan="1"><?php echo e(number_format($total_pi_amount,2)); ?> <?php $total_pi_amountEnd+=$total_pi_amount;?></td>
                                        <td class="text-right" colspan="1"><?php echo e(number_format($total_return_amount,2)); ?><?php $total_return_amountEnd+=$total_return_amount;?></td>
                                        <td class="text-right" colspan="1"><?php echo e(number_format($total_paid_amount,2)); ?><?php $total_paid_amountEnd+=$total_paid_amount;?></td>
                                        <td class="text-right <?php if ($total_remainig==0): ?>  hidee<?php echo e($main_count); ?><?php endif ?>" colspan="1"><?php echo e(number_format($total_remainig,2)); ?><?php $total_remainigEnd+=$total_remainig?></td>

                                        <input type="hidden" value="<?php echo e($total_remainig); ?>" class="val" id="<?php echo e($main_count); ?>"/>
                                    </tr>
                            ...
                            <table style="width: 100%" class="table-bordered sf-table-list GrandTotal" id="export_table_to_excel_<?php echo $main_count; ?>">
                                ...
                                <tr style="font-size: large;font-weight: bold">
                                    <td colspan="3">Total</td>
                                    <td class="text-right" colspan="1"><?php echo e(number_format($total_pi_amountEnd,2)); ?></td>
                                    <td class="text-right" colspan="1"><?php echo e(number_format($total_return_amountEnd,2)); ?></td>
                                    <td class="text-right" colspan="1"><?php echo e(number_format($total_paid_amountEnd,2)); ?></td>
                                    <td class="text-right" colspan="1"><?php echo e(number_format($total_remainigEnd,2)); ?></td>
                                </tr>
                            </table>
