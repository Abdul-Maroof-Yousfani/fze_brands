...
@section('content')
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        $so_id=$sales->so_no;
                                                                         ...
                                                                         $return_qty=SalesHelper::return_qty($credit_note->type,$invoice_data->so_data_id,$invoice_data->gd_no);
                                                                                ...
                                                                                $return_qty=SalesHelper::return_qty($credit_note->type,$row->voucher_no, $row->voucher_data_id);                                                                                                                                                             
                                                                            endif;
   ...
   <input type="hidden" id="mrp_price{{$counter}}" name="mrp_price{{$counter}}" value="{{$mrp_price}}"/>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input value="{{ $row->qty }}" onkeyup="calc('<?php echo $counter ?>');check_qty(this.id,'{{$counter}}')"  onblur="calc('<?php echo $counter ?>');check_qty(this.id,'{{$counter}})" type="text" class="form-control number zerovalidate quantityy" name="qty{{$counter}}" id="qty{{$counter}}"/> </td>
                                                                        <td><input readonly type="text" value="{{ $row->rate }}" class="form-control number" name="rate{{$counter}}" value="{{$invoice_data->rate}}" id="rate{{$counter}}"/> </td>
                                                                        <td><input readonly type="text" value="{{ $row->qty * $row->rate }}" class="form-control number amount" name="amount{{$counter}}" id="amount{{$counter}}"/> </td>
                                                                        ...
                                                                        <td><input readonly type="text" value="{{ $row->discount_amount }}" class="form-control number amount" name="discount_amount{{$counter}}" id="discount_amount{{$counter}}"/></td>
                                                                        <td><input readonly type="text" value="{{$row->actual_discount_percent}}" class="form-control number amount" id="actual_discount_percent{{$counter}}"/></td>
                                                                        <td><input readonly type="text" value="{{ $row->actual_discount_amount }}" class="form-control number amount discount_amount{{$counter}}" id="actual_discount_amount{{$counter}}"/></td>
                                                                        <td><input readonly type="text" value="{{ $row->net_amount }}" class="form-control number net_amount zerovalidate requiredField" name="net_amount{{$counter}}" id="net_amount{{$counter}}"/></td>
                                                                    </tr>
                                                                         </tbody>
                                                                    </table>
                                        ...
                                        $sales_tax=CommonHelper::generic('sales_order',array('id'=>$so_id),'sales_tax_rate')->first();
                                        $sales_tax=$sales_tax->sales_tax_rate;
