                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list view_purchase_tab" id="EmpExitInterviewList">
                                            ...
                                            <?php $__currentLoopData = $purchase_voucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               ...
                                               $net_amount= DB::Connection('mysql2')->table('new_purchase_voucher_data')->where('master_id',$row->id)->sum('net_amount');
                                                ...
                                                <tr <?php if($t_amount!=$net_amount): ?> <?php elseif($net_amount!=$net_amount_grn): ?> style="background-color: cornflowerblue" <?php endif; ?> id="<?php echo e($row->id); ?>">
                                                    ...
                                                    <td style="text-align:center;" title="<?php echo e($row->id); ?>" class="text-center"><?php echo e(strtoupper($row->grn_no)); ?>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <?php if($row->pv_status == 1):?>
                                                            ...
                                                            <?php if($edit==true ): ?>
                                                                <?php if($row->grn_no == '0'): ?>
                                                                    <a href="<?php echo e(URL::asset('finance/editDirectPurchaseVoucherForm/'.$row->id.'?m='.$m)); ?>" class="btn btn-success btn-xs">Edit </a>
                                                                <?php else: ?>
                                                                    <a href="<?php echo e(URL::asset('finance/editPurchaseVoucherFormNew/'.$row->id.'?m='.$m)); ?>" class="btn btn-success btn-xs">Edit </a>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right" colspan="1"><?php echo e(number_format($total,2)); ?></td>
                                            </tr>
<!--
                                            <tr>
