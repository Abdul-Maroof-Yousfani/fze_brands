                ...
                <div class="panel panel-default">
                      ...
                      <div class="panel-heading clearfix">
                            ...
                            <div class="pull-right">
                                <button type="button" onclick="exportBtn('Closing_Stock_Report_<?php echo e(date('Y-m-d')); ?>')" class="btn btn-success btn-sm">
                    ...
                    <div class="panel-body">
                        <form method="get" action="<?php echo e(route('stock_report.view')); ?>" id="list_data" class="form-horizontal">
                            <?php csrf_token()?>
                            <div class="row">
                                <div class="col-md-4">
...
<div class="col-md-2">
    <div class="form-group">
        ...
        <select name="territory_id" id="territory_id" class="form-control select2" onchange="getWarehousesByTerritory()">
            ...
            <?php $__currentLoopData = $territories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $territory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($territory->id); ?>" <?php echo e(request('territory_id') == $territory->id ? 'selected' : ''); ?>>
    ...
    <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($warehouse->id); ?>"
            <?php echo e(collect(request('warehouse_id'))->contains($warehouse->id) ? 'selected' : ''); ?>>
...
<div class="col-md-3">
    ...
    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($brand->id); ?>"
            <?php echo e(collect(request('brand_id'))->contains($brand->id) ? 'selected' : ''); ?>>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Product</label>
                                            ...
                                            <?php if(request('product_id')): ?>
                                                <option value="<?php echo e(request('product_id')); ?>" selected>
                                                    <?php echo e(\App\Models\Subitem::find(request('product_id'))->product_name ?? 'Selected Product'); ?>
...
<select name="product_id" id="product_id" class="form-control select2-ajax" style="width: 100%">
    ...
    <?php $__currentLoopData = $defaultProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(request('product_id') && !$defaultProducts->contains('id', request('product_id'))): ?>
        <option value="<?php echo e(request('product_id')); ?>" selected>
            <?php echo e(\App\Models\Subitem::find(request('product_id'))->product_name ?? 'Selected Product'); ?>
...
function fetchProducts(keyword) {
    $.ajax({
        url: "<?php echo e(route('ajax.search.product')); ?>",
        type: "GET",
        data: { q: keyword },
        dataType: 'json',
        success: function (response) {
...
function getWarehousesByTerritory() {
    ...
    $.ajax({
        url: '<?php echo e(route("ajax.get.warehouses")); ?>',
        type: 'GET',
...
//     $.ajax({
//         url: '<?php echo e(route("ajax.get.brands")); ?>',
//         type: 'GET',
