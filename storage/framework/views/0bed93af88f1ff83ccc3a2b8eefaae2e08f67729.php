...
<div class="row">
    ...
    <?php if($approve): ?>
      <?php if($row->tr_status==1): ?>
                <button onclick="approve(<?php echo e($row->id); ?>)" type="button" id="approve" class="btn btn-success btn-xs">Accept</button>
          <?php endif; ?>
        <?php endif; ?>
...
<div class="row" id="printDemandVoucherVoucherDetail">
                    ...
                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                        ...
                        <tr>
                            <td class="text-center">
                             ...
                             <td class="text-center">
                                <?php echo CommonHelper::get_product_sku($row1->item_id);?>
                        </td>
                            <td  id="<?php echo e($row1->id); ?>" title="<?php echo e($row1->item_id); ?>">
                            ...
                            <td class="text-center">
                                <?php echo CommonHelper::product_barcode($row1->item_id);?>
                            <td>
                            ...
                            <td style="white-space: pre-wrap;"><?php echo e($row1->desc ?? 'N/A'); ?></td>
    ...
    <td class="text-center"><?php echo e(number_format($totalQty, 2)); ?></td>
    <td colspan="4"></td>
</tr>
                        </tbody>
                    </table>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:40px;">
                    <div class="container-fluid">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center">
                                <h6 class="signature_bor">Accept By:</h6>
                                <b>  <p></p></b>
                            </div>
...
//     $.ajax({
//         url : '<?php echo e(url('/stdc/approve_transfer')); ?>',
//         type: "GET",
//         data : {id:id},
//         success: function(data) {
//             if (data.status === 'success') {
//                 alert(data.message); // "Stock transfer approved successfully"
