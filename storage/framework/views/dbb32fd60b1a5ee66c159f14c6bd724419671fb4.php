    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
            <?php if($row->pv_status==1): ?>
                ...
                <button onclick="approve_voucher('new_pv','new_pv_data','pv_status','pv_date','pv_no','2','<?php echo e($row->pv_no); ?>')" type="button" class="btn btn-primary btn-xs">Approve</button>
                <?php endif;?>
            <?php endif; ?>
        </div>
