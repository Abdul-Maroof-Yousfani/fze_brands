...
.dataTables_wrapper .dataTables_paginate .paginate_button.current,.dataTables_wrapper .dataTables_paginate .paginate_button.current:hover{color:#333 !important;border:1px solid #428bca!important;background-color:white;background:-webkit-gradient(linear,left top,left bottom,color-stop(0%,#fff),color-stop(100%,#dcdcdc));background:-webkit-linear-gradient(top,#fff 0%,#dcdcdc 100%);background:-moz-linear-gradient(top,#fff 0%,#dcdcdc 100%);background:-ms-linear-gradient(top,#fff 0%,#dcdcdc 100%);background:-o-linear-gradient(top,#fff 0%,#dcdcdc 100%);background:#428bca !important;width:25px !important;height:30px!important;line-height:15px;color:#fff !important;}
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        ...
                                        <table class="userlittab table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            <?php $__currentLoopData = $delivery_note; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              ...
                                              //  $data1=SalesHelper::get_total_amount_for_dn_by_id($row->id);
                                                ...
                                                <tr <?php if($status=='Open'): ?> style="background-color: #fdc8c8" <?php elseif($status=='partial'): ?> style="background-color: #c9d6ec"  <?php endif; ?> title="<?php echo e($row->id); ?>" id="<?php echo e($row->id); ?>">
                                                    <td style="text-align:center;" class="text-center"><?php echo e($counter++); ?></td>
                                                    <td class="text-center"><?php echo  strtoupper($row->so_no) ?></td>
                                                    <td title="<?php echo e($row->id); ?>" class="text-center"><?php echo e(strtoupper($row->gd_no)); ?></td>
                                                    ...
                                                    ?>
                                                    <!-- <td class="text-center"><?php echo e($row->so_no); ?></td> -->
                                                ...
                                                <?php echo $sales_order->timestamp ? \Carbon\Carbon::parse($sales_order->timestamp)->format("h:i:s A") : "";?> 
                                                    ...
                                                    <td style="text-align:left;" class="text-center"><strong><?php echo e($customer->name); ?></strong></td>
                                                    <td style="text-align: center !important;" class="text-center"><?php echo e(number_format($data->qty,0)); ?></td>
                                                  
                                                    <td   style="text-align: center !important;" class="text-center"><?php echo e(number_format($data->amount + $row->sales_tax_amount + $sale_taxes_amount_rate, 0)); ?></td>
                                                    <!-- <td><?php echo e($status); ?></td> -->
                                                    <td><?php echo e($approvalStatus); ?></td>
                                                    <!-- <td class="text-center"><?php echo $row->username?></td> -->
                                                     <td  style="text-align:left;"  class="text-center">
                                                        <?php echo e(!empty($sales_order->remark) ? $sales_order->remark : '-'); ?>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    ...
                                                                    <?php if($checkifbarcodescanningproduct > 0): ?>
                                                                    <a style="display: block" href="<?php echo e(route('stockBarcode.show',$row->gd_no).'?type=gdn'); ?>" type="button" class="btn btn-warning btn-xs" target="_blank">Stock Barcodes</a>
                                                                    <?php endif; ?>
    ...
    <script>
        ...
        function viewRangeWiseDataFilterOld() // This function is Old not using anywhere.
        {
            ...
            $.ajax({
                url: '<?php echo e(url('/sdc/getDeliveryNoteFilterWise')); ?>',
                type: 'Get',
        ...
        function viewRangeWiseDataFilter() // This function is not using anywhere.
        {
            ...
            $('#data').html('<tr><td colspan="13"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="loader"></div></div></div></td><tr>');
            $.ajax({
                url: '<?php echo e(url('/sdc/getDeliveryNoteFilterWiseAjax')); ?>',
                type: 'Get',
                data: {
                    username:username, 
                    from: from,
                    ...
                    gdn_no:gdn_no,
                    so_no:so_no,
                    territory_id: "<?php echo e(auth()->user()->territory_id); ?>"
                },
