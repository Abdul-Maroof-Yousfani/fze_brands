...
<tbody id="row_of_data" class="row_of_data receipe_main recipe_details">
  ...
  <tr>
    ...
    <td>
      <input type="date"  value="{{$prodtion_data->start_date}}" name="start_date[]" class="form-control" />
    </td>
    <td>
      <input type="date"  value="{{$prodtion_data->delivery_date}}" name="delivery_date[]" class="form-control" />
    </td>
  </tr>
