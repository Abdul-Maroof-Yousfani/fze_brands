            ...
            <table class="table table-bordered sf-table-list">
                ...
                <tr>
                    ...
                    <!-- <td class=""><input readonly class="form-control requiredField" type="text"
                                name="batch_code<?php echo e($row->id); ?>" value="<?php echo e($batch_code); ?>" required /> </td> -->
                    <td>


                        <input type="date" <?php echo e($expiry); ?> id="expiry_datees<?php echo e($row->id); ?>" class="form-control <?php echo e($expiry); ?>"
                    ...
                    <td><input onkeyup="calculation('<?php echo $row->id; ?>');ShowAmount('<?php echo $row->id?>')"
                     ...
                     requiredFieldrequiredField rec_qty_<?php echo $counter ?> loop" type="text"
                               value="<?php echo e($remaining_qty,2); ?>" /> </td>
                ...
                <input type="hidden" id="amount_<?php echo $row->id ?>" value="<?php echo e($row->net_amount); ?>" />
                <input type="hidden" name="exchange_rate" id="exchange_rate" value="<?php echo e($currency_rate); ?>">
