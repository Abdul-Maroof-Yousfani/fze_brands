                ...
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input  readonly type="text" class="form-control requiredField" placeholder="Slip No"
                                                name="" id="" value="<?php echo e(strtoupper($brv_no)); ?>" />
                                    </div>
                                            ...
                                            <table id="buildyourform" class="userlittab table table-bordered sf-table-list">
                                                ...
                                                <tr class="AutoNo">
                                                    ...
                                                    <td class="hide">
                                                        ...
                                                        <select class="form-control select2" name="paid_to[]" id="paid_to<?php echo e($j); ?>">
                                                    ...
                                                    <td>
                                                        <select class="form-control requiredField select2" name="account_id[]" id="account_id<?php echo e($j); ?>">
                                                            ...
                                                            <?php $__currentLoopData = CommonHelper::get_all_account_operat(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($y->id.',0'); ?>"><?php echo e($y->code .' ---- '. $y->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input onfocus="mainDisable('c_amount_1_<?php echo $j ?>','d_amount_1_<?php echo $j ?>');" placeholder="Debit" class="form-control d_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="d_amount[]" id="d_amount_1_<?php echo e($j); ?>" onkeyup="sum('1')" value="" required="required"/>
                                                    </td>
                                                    <td>
                                                        <input onfocus="mainDisable('d_amount_1_<?php echo $j ?>','c_amount_1_<?php echo $j ?>');" placeholder="Credit" class="form-control c_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="c_amount[]" id="c_amount_1_<?php echo e($j); ?>" onkeyup="sum('1')" value="" required="required"/>
                                                    </td>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <div class="headquid"> <?php echo e(Form::submit('Submit', ['class' => 'btn btn-success'])); ?></div>
