    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp; Company Location List</h3>
                </li>
            </ul>
        </div>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="{{route('editCompanyLocation',$location->id)}}"  class="btn btn-sm btn-warning "><i class="fa fa-pencil" aria-hidden="true"></i>  Edit</a>
