                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li onclick="showMasterEditModal('editUseFulLifeForm','{{ $value->id }}','Edit UseFull Life Form','')">
                                <a class="edit-modal">Edit</a>
                            </li>
                            <li onclick="deleteTableRecord('{{ $value->id }}','assets_designed_life')">
