                        ...
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <input  checked  type="hidden" value="<?php echo e($NewJv->jv_no); ?>" name="jv_no" />
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input  readonly type="text" class="form-control requiredField" placeholder="Slip No"
                                                name="" id="" value="<?php echo e(strtoupper($NewJv->jv_no)); ?>" />
                                    </div>
                                     ...
                                     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <select name="warehouse_id" id="warehouse_id" class="form-control requiredField select2">
                                            ...
                                            <?php $__currentLoopData = CommonHelper::get_all_branch(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($branch->id); ?>" <?php echo e($branch->id == $NewJv->warehouse_id ? "selected" : ""); ?>><?php echo e($branch->branch_name); ?></option>
                                        ...
                                        <div class="table-responsive">
                                            <table id="buildyourform" class="table table-bordered">
                                                ...
                                                <tr id="tr<?php echo $j?>" class="AutoNo">
                                                    ...
                                                    <td class="hide">
                                                        <select class="form-control select2 sub_department_id" name="sub_department_id[]" id="sub_department_id_<?php echo e($j); ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <select style="width: 100%" class="form-control requiredField select2" name="account_id[]" id="account_id<?php echo e($j); ?>" onchange="AppendBrand('<?php echo $j?>');Datavalidate(this)">
                                                            <option value="0,0">Select Account</option>
                                                            <option value="<?php echo e($Acc->id.','.$Acc->type.','.$Acc->code); ?>"  selected  ><?php echo e($Acc->code .' ---- '. $Acc->name); ?></option>
                                                        </select>
                                                            <br>
                                                            <br>
